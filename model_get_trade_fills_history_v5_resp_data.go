...
// checks if the GetTradeFillsHistoryV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeFillsHistoryV5RespData{}

// GetTradeFillsHistoryV5RespData struct for GetTradeFillsHistoryV5RespData
type GetTradeFillsHistoryV5RespData struct {
	// Bill ID
...
func NewGetTradeFillsHistoryV5RespData() *GetTradeFillsHistoryV5RespData {
	this := GetTradeFillsHistoryV5RespData{}
	var billId string = ""
	this.BillId = &billId
	var clOrdId string = ""
...
func (o GetTradeFillsHistoryV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradeFillsHistoryV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeFillsHistoryV5RespData struct {
	value *GetTradeFillsHistoryV5RespData
	isSet bool
}

func (v NullableGetTradeFillsHistoryV5RespData) Get() *GetTradeFillsHistoryV5RespData {
	return v.value
}

func (v *NullableGetTradeFillsHistoryV5RespData) Set(val *GetTradeFillsHistoryV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeFillsHistoryV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeFillsHistoryV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeFillsHistoryV5RespData(val *GetTradeFillsHistoryV5RespData) *NullableGetTradeFillsHistoryV5RespData {
	return &NullableGetTradeFillsHistoryV5RespData{value: val, isSet: true}
}

func (v NullableGetTradeFillsHistoryV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeFillsHistoryV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
