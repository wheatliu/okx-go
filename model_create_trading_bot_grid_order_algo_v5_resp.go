...
// checks if the CreateTradingBotGridOrderAlgoV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotGridOrderAlgoV5Resp{}

// CreateTradingBotGridOrderAlgoV5Resp struct for CreateTradingBotGridOrderAlgoV5Resp
type CreateTradingBotGridOrderAlgoV5Resp struct {
...
func NewCreateTradingBotGridOrderAlgoV5Resp() *CreateTradingBotGridOrderAlgoV5Resp {
	this := CreateTradingBotGridOrderAlgoV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateTradingBotGridOrderAlgoV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotGridOrderAlgoV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotGridOrderAlgoV5Resp struct {
	value *CreateTradingBotGridOrderAlgoV5Resp
	isSet bool
}

func (v NullableCreateTradingBotGridOrderAlgoV5Resp) Get() *CreateTradingBotGridOrderAlgoV5Resp {
	return v.value
}

func (v *NullableCreateTradingBotGridOrderAlgoV5Resp) Set(val *CreateTradingBotGridOrderAlgoV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotGridOrderAlgoV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotGridOrderAlgoV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotGridOrderAlgoV5Resp(val *CreateTradingBotGridOrderAlgoV5Resp) *NullableCreateTradingBotGridOrderAlgoV5Resp {
	return &NullableCreateTradingBotGridOrderAlgoV5Resp{value: val, isSet: true}
}

func (v NullableCreateTradingBotGridOrderAlgoV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotGridOrderAlgoV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
