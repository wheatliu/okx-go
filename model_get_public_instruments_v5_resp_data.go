...
// checks if the GetPublicInstrumentsV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicInstrumentsV5RespData{}

// GetPublicInstrumentsV5RespData struct for GetPublicInstrumentsV5RespData
type GetPublicInstrumentsV5RespData struct {
...
func NewGetPublicInstrumentsV5RespData() *GetPublicInstrumentsV5RespData {
	this := GetPublicInstrumentsV5RespData{}
	var alias string = ""
	this.Alias = &alias
...
func (o GetPublicInstrumentsV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetPublicInstrumentsV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicInstrumentsV5RespData struct {
	value *GetPublicInstrumentsV5RespData
	isSet bool
}

func (v NullableGetPublicInstrumentsV5RespData) Get() *GetPublicInstrumentsV5RespData {
	return v.value
}

func (v *NullableGetPublicInstrumentsV5RespData) Set(val *GetPublicInstrumentsV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicInstrumentsV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicInstrumentsV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicInstrumentsV5RespData(val *GetPublicInstrumentsV5RespData) *NullableGetPublicInstrumentsV5RespData {
	return &NullableGetPublicInstrumentsV5RespData{value: val, isSet: true}
}

func (v NullableGetPublicInstrumentsV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicInstrumentsV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
