...
// checks if the GetFiatDepositOrderHistoryV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFiatDepositOrderHistoryV5RespDataInner{}

// GetFiatDepositOrderHistoryV5RespDataInner struct for GetFiatDepositOrderHistoryV5RespDataInner
type GetFiatDepositOrderHistoryV5RespDataInner struct {
	...
	// State of the transaction  `completed`  `failed`  `pending`  `canceled`  `inqueue`
...
func NewGetFiatDepositOrderHistoryV5RespDataInner() *GetFiatDepositOrderHistoryV5RespDataInner {
	this := GetFiatDepositOrderHistoryV5RespDataInner{}
	var amt string = ""
	this.Amt = &amt
	var cTime string = ""
	this.CTime = &cTime
...
func (o GetFiatDepositOrderHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetFiatDepositOrderHistoryV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetFiatDepositOrderHistoryV5RespDataInner struct {
	value *GetFiatDepositOrderHistoryV5RespDataInner
	isSet bool
}

func (v NullableGetFiatDepositOrderHistoryV5RespDataInner) Get() *GetFiatDepositOrderHistoryV5RespDataInner {
	return v.value
}

func (v *NullableGetFiatDepositOrderHistoryV5RespDataInner) Set(val *GetFiatDepositOrderHistoryV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFiatDepositOrderHistoryV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFiatDepositOrderHistoryV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFiatDepositOrderHistoryV5RespDataInner(val *GetFiatDepositOrderHistoryV5RespDataInner) *NullableGetFiatDepositOrderHistoryV5RespDataInner {
	return &NullableGetFiatDepositOrderHistoryV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetFiatDepositOrderHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFiatDepositOrderHistoryV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
