...
// checks if the CreateAccountPositionMarginBalanceV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAccountPositionMarginBalanceV5Resp{}
...
func NewCreateAccountPositionMarginBalanceV5Resp() *CreateAccountPositionMarginBalanceV5Resp {
	this := CreateAccountPositionMarginBalanceV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateAccountPositionMarginBalanceV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateAccountPositionMarginBalanceV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAccountPositionMarginBalanceV5Resp struct {
	value *CreateAccountPositionMarginBalanceV5Resp
	isSet bool
}

func (v NullableCreateAccountPositionMarginBalanceV5Resp) Get() *CreateAccountPositionMarginBalanceV5Resp {
	return v.value
}

func (v *NullableCreateAccountPositionMarginBalanceV5Resp) Set(val *CreateAccountPositionMarginBalanceV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAccountPositionMarginBalanceV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAccountPositionMarginBalanceV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAccountPositionMarginBalanceV5Resp(val *CreateAccountPositionMarginBalanceV5Resp) *NullableCreateAccountPositionMarginBalanceV5Resp {
	return &NullableCreateAccountPositionMarginBalanceV5Resp{value: val, isSet: true}
}

func (v NullableCreateAccountPositionMarginBalanceV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAccountPositionMarginBalanceV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
