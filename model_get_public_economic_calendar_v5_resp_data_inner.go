...
// checks if the GetPublicEconomicCalendarV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicEconomicCalendarV5RespDataInner{}

// GetPublicEconomicCalendarV5RespDataInner struct for GetPublicEconomicCalendarV5RespDataInner
type GetPublicEconomicCalendarV5RespDataInner struct {
...
func NewGetPublicEconomicCalendarV5RespDataInner() *GetPublicEconomicCalendarV5RespDataInner {
	this := GetPublicEconomicCalendarV5RespDataInner{}
	var actual string = ""
	this.Actual = &actual
...
func (o GetPublicEconomicCalendarV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetPublicEconomicCalendarV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicEconomicCalendarV5RespDataInner struct {
	value *GetPublicEconomicCalendarV5RespDataInner
	isSet bool
}

func (v NullableGetPublicEconomicCalendarV5RespDataInner) Get() *GetPublicEconomicCalendarV5RespDataInner {
	return v.value
}

func (v *NullableGetPublicEconomicCalendarV5RespDataInner) Set(val *GetPublicEconomicCalendarV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicEconomicCalendarV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicEconomicCalendarV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicEconomicCalendarV5RespDataInner(val *GetPublicEconomicCalendarV5RespDataInner) *NullableGetPublicEconomicCalendarV5RespDataInner {
	return &NullableGetPublicEconomicCalendarV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetPublicEconomicCalendarV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicEconomicCalendarV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
