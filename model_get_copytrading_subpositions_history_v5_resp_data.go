...
// checks if the GetCopytradingSubpositionsHistoryV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCopytradingSubpositionsHistoryV5RespData{}

// GetCopytradingSubpositionsHistoryV5RespData struct for GetCopytradingSubpositionsHistoryV5RespData
type GetCopytradingSubpositionsHistoryV5RespData struct {
	// Currency
...
func NewGetCopytradingSubpositionsHistoryV5RespData() *GetCopytradingSubpositionsHistoryV5RespData {
	this := GetCopytradingSubpositionsHistoryV5RespData{}
	var ccy string = ""
	this.Ccy = &ccy
...
func (o GetCopytradingSubpositionsHistoryV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetCopytradingSubpositionsHistoryV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetCopytradingSubpositionsHistoryV5RespData struct {
	value *GetCopytradingSubpositionsHistoryV5RespData
	isSet bool
}

func (v NullableGetCopytradingSubpositionsHistoryV5RespData) Get() *GetCopytradingSubpositionsHistoryV5RespData {
	return v.value
}

func (v *NullableGetCopytradingSubpositionsHistoryV5RespData) Set(val *GetCopytradingSubpositionsHistoryV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCopytradingSubpositionsHistoryV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCopytradingSubpositionsHistoryV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCopytradingSubpositionsHistoryV5RespData(val *GetCopytradingSubpositionsHistoryV5RespData) *NullableGetCopytradingSubpositionsHistoryV5RespData {
	return &NullableGetCopytradingSubpositionsHistoryV5RespData{value: val, isSet: true}
}

func (v NullableGetCopytradingSubpositionsHistoryV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCopytradingSubpositionsHistoryV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
