...
// checks if the GetTradeOrderV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrderV5RespData{}

// GetTradeOrderV5RespData struct for GetTradeOrderV5RespData
type GetTradeOrderV5RespData struct {
...
func (o GetTradeOrderV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrderV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrderV5RespData struct {
	value *GetTradeOrderV5RespData
	isSet bool
}

func (v NullableGetTradeOrderV5RespData) Get() *GetTradeOrderV5RespData {
	return v.value
}

func (v *NullableGetTradeOrderV5RespData) Set(val *GetTradeOrderV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrderV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrderV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrderV5RespData(val *GetTradeOrderV5RespData) *NullableGetTradeOrderV5RespData {
	return &NullableGetTradeOrderV5RespData{value: val, isSet: true}
}

func (v NullableGetTradeOrderV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrderV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
