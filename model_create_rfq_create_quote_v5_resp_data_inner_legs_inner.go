...
// checks if the CreateRfqCreateQuoteV5RespDataInnerLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqCreateQuoteV5RespDataInnerLegsInner{}

// CreateRfqCreateQuoteV5RespDataInnerLegsInner struct for CreateRfqCreateQuoteV5RespDataInnerLegsInner
type CreateRfqCreateQuoteV5RespDataInnerLegsInner struct {
...
func NewCreateRfqCreateQuoteV5RespDataInnerLegsInner() *CreateRfqCreateQuoteV5RespDataInnerLegsInner {
	this := CreateRfqCreateQuoteV5RespDataInnerLegsInner{}
	var ccy string = ""
	this.Ccy = &ccy
	var instId string = ""
	this.InstId = &instId
...
func (o CreateRfqCreateQuoteV5RespDataInnerLegsInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqCreateQuoteV5RespDataInnerLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqCreateQuoteV5RespDataInnerLegsInner struct {
	value *CreateRfqCreateQuoteV5RespDataInnerLegsInner
	isSet bool
}

func (v NullableCreateRfqCreateQuoteV5RespDataInnerLegsInner) Get() *CreateRfqCreateQuoteV5RespDataInnerLegsInner {
	return v.value
}

func (v *NullableCreateRfqCreateQuoteV5RespDataInnerLegsInner) Set(val *CreateRfqCreateQuoteV5RespDataInnerLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqCreateQuoteV5RespDataInnerLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqCreateQuoteV5RespDataInnerLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqCreateQuoteV5RespDataInnerLegsInner(val *CreateRfqCreateQuoteV5RespDataInnerLegsInner) *NullableCreateRfqCreateQuoteV5RespDataInnerLegsInner {
	return &NullableCreateRfqCreateQuoteV5RespDataInnerLegsInner{value: val, isSet: true}
}

func (v NullableCreateRfqCreateQuoteV5RespDataInnerLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqCreateQuoteV5RespDataInnerLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
