...
// checks if the GetCopytradingCurrentSubpositionsV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCopytradingCurrentSubpositionsV5Resp{}
...
func NewGetCopytradingCurrentSubpositionsV5Resp() *GetCopytradingCurrentSubpositionsV5Resp {
	this := GetCopytradingCurrentSubpositionsV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetCopytradingCurrentSubpositionsV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetCopytradingCurrentSubpositionsV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetCopytradingCurrentSubpositionsV5Resp struct {
	value *GetCopytradingCurrentSubpositionsV5Resp
	isSet bool
}

func (v NullableGetCopytradingCurrentSubpositionsV5Resp) Get() *GetCopytradingCurrentSubpositionsV5Resp {
	return v.value
}

func (v *NullableGetCopytradingCurrentSubpositionsV5Resp) Set(val *GetCopytradingCurrentSubpositionsV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCopytradingCurrentSubpositionsV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCopytradingCurrentSubpositionsV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCopytradingCurrentSubpositionsV5Resp(val *GetCopytradingCurrentSubpositionsV5Resp) *NullableGetCopytradingCurrentSubpositionsV5Resp {
	return &NullableGetCopytradingCurrentSubpositionsV5Resp{value: val, isSet: true}
}

func (v NullableGetCopytradingCurrentSubpositionsV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCopytradingCurrentSubpositionsV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
