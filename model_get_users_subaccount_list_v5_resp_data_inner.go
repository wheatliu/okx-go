...
// checks if the GetUsersSubaccountListV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUsersSubaccountListV5RespDataInner{}

// GetUsersSubaccountListV5RespDataInner struct for GetUsersSubaccountListV5RespDataInner
type GetUsersSubaccountListV5RespDataInner struct {
...
func NewGetUsersSubaccountListV5RespDataInner() *GetUsersSubaccountListV5RespDataInner {
	this := GetUsersSubaccountListV5RespDataInner{}
...
func (o GetUsersSubaccountListV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetUsersSubaccountListV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetUsersSubaccountListV5RespDataInner struct {
	value *GetUsersSubaccountListV5RespDataInner
	isSet bool
}

func (v NullableGetUsersSubaccountListV5RespDataInner) Get() *GetUsersSubaccountListV5RespDataInner {
	return v.value
}

func (v *NullableGetUsersSubaccountListV5RespDataInner) Set(val *GetUsersSubaccountListV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUsersSubaccountListV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUsersSubaccountListV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUsersSubaccountListV5RespDataInner(val *GetUsersSubaccountListV5RespDataInner) *NullableGetUsersSubaccountListV5RespDataInner {
	return &NullableGetUsersSubaccountListV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetUsersSubaccountListV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUsersSubaccountListV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
