...
// checks if the GetCopytradingProfitSharingDetailsV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCopytradingProfitSharingDetailsV5Resp{}
...
func NewGetCopytradingProfitSharingDetailsV5Resp() *GetCopytradingProfitSharingDetailsV5Resp {
	this := GetCopytradingProfitSharingDetailsV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetCopytradingProfitSharingDetailsV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetCopytradingProfitSharingDetailsV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetCopytradingProfitSharingDetailsV5Resp struct {
	value *GetCopytradingProfitSharingDetailsV5Resp
	isSet bool
}

func (v NullableGetCopytradingProfitSharingDetailsV5Resp) Get() *GetCopytradingProfitSharingDetailsV5Resp {
	return v.value
}

func (v *NullableGetCopytradingProfitSharingDetailsV5Resp) Set(val *GetCopytradingProfitSharingDetailsV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCopytradingProfitSharingDetailsV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCopytradingProfitSharingDetailsV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCopytradingProfitSharingDetailsV5Resp(val *GetCopytradingProfitSharingDetailsV5Resp) *NullableGetCopytradingProfitSharingDetailsV5Resp {
	return &NullableGetCopytradingProfitSharingDetailsV5Resp{value: val, isSet: true}
}

func (v NullableGetCopytradingProfitSharingDetailsV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCopytradingProfitSharingDetailsV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
