...
// checks if the GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner{}

// GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner struct for GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner
type GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner struct {
	...
	// Recurring buy info
	RecurringList []GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInnerRecurringListInner `json:"recurringList,omitempty"`
...
func NewGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner() *GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner {
	this := GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner{}
...
func (o *GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) GetRecurringList() []GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInnerRecurringListInner {
	if o == nil || IsNil(o.RecurringList) {
		var ret []GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInnerRecurringListInner
		return ret
	}
...
// SetRecurringList gets a reference to the given []GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInnerRecurringListInner and assigns it to the RecurringList field.
...
func (o GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner struct {
	value *GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner
	isSet bool
}

func (v NullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) Get() *GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner {
	return v.value
}

func (v *NullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) Set(val *GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner(val *GetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) *NullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner {
	return &NullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotRecurringOrdersAlgoDetailsV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
