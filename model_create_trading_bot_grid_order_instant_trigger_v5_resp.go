...
// checks if the CreateTradingBotGridOrderInstantTriggerV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotGridOrderInstantTriggerV5Resp{}
...
func NewCreateTradingBotGridOrderInstantTriggerV5Resp() *CreateTradingBotGridOrderInstantTriggerV5Resp {
	this := CreateTradingBotGridOrderInstantTriggerV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateTradingBotGridOrderInstantTriggerV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotGridOrderInstantTriggerV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotGridOrderInstantTriggerV5Resp struct {
	value *CreateTradingBotGridOrderInstantTriggerV5Resp
	isSet bool
}

func (v NullableCreateTradingBotGridOrderInstantTriggerV5Resp) Get() *CreateTradingBotGridOrderInstantTriggerV5Resp {
	return v.value
}

func (v *NullableCreateTradingBotGridOrderInstantTriggerV5Resp) Set(val *CreateTradingBotGridOrderInstantTriggerV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotGridOrderInstantTriggerV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotGridOrderInstantTriggerV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotGridOrderInstantTriggerV5Resp(val *CreateTradingBotGridOrderInstantTriggerV5Resp) *NullableCreateTradingBotGridOrderInstantTriggerV5Resp {
	return &NullableCreateTradingBotGridOrderInstantTriggerV5Resp{value: val, isSet: true}
}

func (v NullableCreateTradingBotGridOrderInstantTriggerV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotGridOrderInstantTriggerV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
