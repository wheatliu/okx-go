...
// checks if the GetRfqTradesV5RespDataDataInnerLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRfqTradesV5RespDataDataInnerLegsInner{}

// GetRfqTradesV5RespDataDataInnerLegsInner struct for GetRfqTradesV5RespDataDataInnerLegsInner
type GetRfqTradesV5RespDataDataInnerLegsInner struct {
...
func NewGetRfqTradesV5RespDataDataInnerLegsInner() *GetRfqTradesV5RespDataDataInnerLegsInner {
	this := GetRfqTradesV5RespDataDataInnerLegsInner{}
	var fee string = ""
	this.Fee = &fee
	var feeCcy string = ""
	this.FeeCcy = &feeCcy
...
func (o GetRfqTradesV5RespDataDataInnerLegsInner) MarshalJSON() ([]byte, error) {
...
func (o GetRfqTradesV5RespDataDataInnerLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRfqTradesV5RespDataDataInnerLegsInner struct {
	value *GetRfqTradesV5RespDataDataInnerLegsInner
	isSet bool
}

func (v NullableGetRfqTradesV5RespDataDataInnerLegsInner) Get() *GetRfqTradesV5RespDataDataInnerLegsInner {
	return v.value
}

func (v *NullableGetRfqTradesV5RespDataDataInnerLegsInner) Set(val *GetRfqTradesV5RespDataDataInnerLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRfqTradesV5RespDataDataInnerLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRfqTradesV5RespDataDataInnerLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRfqTradesV5RespDataDataInnerLegsInner(val *GetRfqTradesV5RespDataDataInnerLegsInner) *NullableGetRfqTradesV5RespDataDataInnerLegsInner {
	return &NullableGetRfqTradesV5RespDataDataInnerLegsInner{value: val, isSet: true}
}

func (v NullableGetRfqTradesV5RespDataDataInnerLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRfqTradesV5RespDataDataInnerLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
