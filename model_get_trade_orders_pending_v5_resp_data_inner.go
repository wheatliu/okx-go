...
// checks if the GetTradeOrdersPendingV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrdersPendingV5RespDataInner{}

// GetTradeOrdersPendingV5RespDataInner struct for GetTradeOrdersPendingV5RespDataInner
type GetTradeOrdersPendingV5RespDataInner struct {
...
func NewGetTradeOrdersPendingV5RespDataInner() *GetTradeOrdersPendingV5RespDataInner {
	this := GetTradeOrdersPendingV5RespDataInner{}
...
func (o GetTradeOrdersPendingV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrdersPendingV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrdersPendingV5RespDataInner struct {
	value *GetTradeOrdersPendingV5RespDataInner
	isSet bool
}

func (v NullableGetTradeOrdersPendingV5RespDataInner) Get() *GetTradeOrdersPendingV5RespDataInner {
	return v.value
}

func (v *NullableGetTradeOrdersPendingV5RespDataInner) Set(val *GetTradeOrdersPendingV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrdersPendingV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrdersPendingV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrdersPendingV5RespDataInner(val *GetTradeOrdersPendingV5RespDataInner) *NullableGetTradeOrdersPendingV5RespDataInner {
	return &NullableGetTradeOrdersPendingV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradeOrdersPendingV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrdersPendingV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
