...
// checks if the GetPublicPremiumHistoryV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicPremiumHistoryV5Resp{}
...
func NewGetPublicPremiumHistoryV5Resp() *GetPublicPremiumHistoryV5Resp {
	this := GetPublicPremiumHistoryV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetPublicPremiumHistoryV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetPublicPremiumHistoryV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicPremiumHistoryV5Resp struct {
	value *GetPublicPremiumHistoryV5Resp
	isSet bool
}

func (v NullableGetPublicPremiumHistoryV5Resp) Get() *GetPublicPremiumHistoryV5Resp {
	return v.value
}

func (v *NullableGetPublicPremiumHistoryV5Resp) Set(val *GetPublicPremiumHistoryV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicPremiumHistoryV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicPremiumHistoryV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicPremiumHistoryV5Resp(val *GetPublicPremiumHistoryV5Resp) *NullableGetPublicPremiumHistoryV5Resp {
	return &NullableGetPublicPremiumHistoryV5Resp{value: val, isSet: true}
}

func (v NullableGetPublicPremiumHistoryV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicPremiumHistoryV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
