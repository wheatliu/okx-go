...
// checks if the GetTradeOrdersAlgoHistoryV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrdersAlgoHistoryV5RespDataInner{}

// GetTradeOrdersAlgoHistoryV5RespDataInner struct for GetTradeOrdersAlgoHistoryV5RespDataInner
type GetTradeOrdersAlgoHistoryV5RespDataInner struct {
...
func NewGetTradeOrdersAlgoHistoryV5RespDataInner() *GetTradeOrdersAlgoHistoryV5RespDataInner {
	this := GetTradeOrdersAlgoHistoryV5RespDataInner{}
	var activePx string = ""
...
func (o GetTradeOrdersAlgoHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrdersAlgoHistoryV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrdersAlgoHistoryV5RespDataInner struct {
	value *GetTradeOrdersAlgoHistoryV5RespDataInner
	isSet bool
}

func (v NullableGetTradeOrdersAlgoHistoryV5RespDataInner) Get() *GetTradeOrdersAlgoHistoryV5RespDataInner {
	return v.value
}

func (v *NullableGetTradeOrdersAlgoHistoryV5RespDataInner) Set(val *GetTradeOrdersAlgoHistoryV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrdersAlgoHistoryV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrdersAlgoHistoryV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrdersAlgoHistoryV5RespDataInner(val *GetTradeOrdersAlgoHistoryV5RespDataInner) *NullableGetTradeOrdersAlgoHistoryV5RespDataInner {
	return &NullableGetTradeOrdersAlgoHistoryV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradeOrdersAlgoHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrdersAlgoHistoryV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
