...
// checks if the GetRubikStatOptionOpenInterestVolumeV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRubikStatOptionOpenInterestVolumeV5RespDataInner{}

// GetRubikStatOptionOpenInterestVolumeV5RespDataInner struct for GetRubikStatOptionOpenInterestVolumeV5RespDataInner
type GetRubikStatOptionOpenInterestVolumeV5RespDataInner struct {
...
func NewGetRubikStatOptionOpenInterestVolumeV5RespDataInner() *GetRubikStatOptionOpenInterestVolumeV5RespDataInner {
	this := GetRubikStatOptionOpenInterestVolumeV5RespDataInner{}
	var oi string = ""
	this.Oi = &oi
	var ts string = ""
	this.Ts = &ts
...
func (o GetRubikStatOptionOpenInterestVolumeV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetRubikStatOptionOpenInterestVolumeV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner struct {
	value *GetRubikStatOptionOpenInterestVolumeV5RespDataInner
	isSet bool
}

func (v NullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner) Get() *GetRubikStatOptionOpenInterestVolumeV5RespDataInner {
	return v.value
}

func (v *NullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner) Set(val *GetRubikStatOptionOpenInterestVolumeV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner(val *GetRubikStatOptionOpenInterestVolumeV5RespDataInner) *NullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner {
	return &NullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRubikStatOptionOpenInterestVolumeV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
