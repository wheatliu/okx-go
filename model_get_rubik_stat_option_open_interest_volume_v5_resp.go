...
// checks if the GetRubikStatOptionOpenInterestVolumeV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRubikStatOptionOpenInterestVolumeV5Resp{}
...
func NewGetRubikStatOptionOpenInterestVolumeV5Resp() *GetRubikStatOptionOpenInterestVolumeV5Resp {
	this := GetRubikStatOptionOpenInterestVolumeV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetRubikStatOptionOpenInterestVolumeV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetRubikStatOptionOpenInterestVolumeV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetRubikStatOptionOpenInterestVolumeV5Resp struct {
	value *GetRubikStatOptionOpenInterestVolumeV5Resp
	isSet bool
}

func (v NullableGetRubikStatOptionOpenInterestVolumeV5Resp) Get() *GetRubikStatOptionOpenInterestVolumeV5Resp {
	return v.value
}

func (v *NullableGetRubikStatOptionOpenInterestVolumeV5Resp) Set(val *GetRubikStatOptionOpenInterestVolumeV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRubikStatOptionOpenInterestVolumeV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRubikStatOptionOpenInterestVolumeV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRubikStatOptionOpenInterestVolumeV5Resp(val *GetRubikStatOptionOpenInterestVolumeV5Resp) *NullableGetRubikStatOptionOpenInterestVolumeV5Resp {
	return &NullableGetRubikStatOptionOpenInterestVolumeV5Resp{value: val, isSet: true}
}

func (v NullableGetRubikStatOptionOpenInterestVolumeV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRubikStatOptionOpenInterestVolumeV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
