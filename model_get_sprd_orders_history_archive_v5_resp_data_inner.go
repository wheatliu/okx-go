...
// checks if the GetSprdOrdersHistoryArchiveV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSprdOrdersHistoryArchiveV5RespDataInner{}

// GetSprdOrdersHistoryArchiveV5RespDataInner struct for GetSprdOrdersHistoryArchiveV5RespDataInner
type GetSprdOrdersHistoryArchiveV5RespDataInner struct {
...
func NewGetSprdOrdersHistoryArchiveV5RespDataInner() *GetSprdOrdersHistoryArchiveV5RespDataInner {
	this := GetSprdOrdersHistoryArchiveV5RespDataInner{}
...
func (o GetSprdOrdersHistoryArchiveV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetSprdOrdersHistoryArchiveV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetSprdOrdersHistoryArchiveV5RespDataInner struct {
	value *GetSprdOrdersHistoryArchiveV5RespDataInner
	isSet bool
}

func (v NullableGetSprdOrdersHistoryArchiveV5RespDataInner) Get() *GetSprdOrdersHistoryArchiveV5RespDataInner {
	return v.value
}

func (v *NullableGetSprdOrdersHistoryArchiveV5RespDataInner) Set(val *GetSprdOrdersHistoryArchiveV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSprdOrdersHistoryArchiveV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSprdOrdersHistoryArchiveV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSprdOrdersHistoryArchiveV5RespDataInner(val *GetSprdOrdersHistoryArchiveV5RespDataInner) *NullableGetSprdOrdersHistoryArchiveV5RespDataInner {
	return &NullableGetSprdOrdersHistoryArchiveV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetSprdOrdersHistoryArchiveV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSprdOrdersHistoryArchiveV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
