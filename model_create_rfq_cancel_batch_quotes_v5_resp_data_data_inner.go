...
// checks if the CreateRfqCancelBatchQuotesV5RespDataDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqCancelBatchQuotesV5RespDataDataInner{}

// CreateRfqCancelBatchQuotesV5RespDataDataInner struct for CreateRfqCancelBatchQuotesV5RespDataDataInner
type CreateRfqCancelBatchQuotesV5RespDataDataInner struct {
...
func NewCreateRfqCancelBatchQuotesV5RespDataDataInner() *CreateRfqCancelBatchQuotesV5RespDataDataInner {
	this := CreateRfqCancelBatchQuotesV5RespDataDataInner{}
...
func (o CreateRfqCancelBatchQuotesV5RespDataDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqCancelBatchQuotesV5RespDataDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqCancelBatchQuotesV5RespDataDataInner struct {
	value *CreateRfqCancelBatchQuotesV5RespDataDataInner
	isSet bool
}

func (v NullableCreateRfqCancelBatchQuotesV5RespDataDataInner) Get() *CreateRfqCancelBatchQuotesV5RespDataDataInner {
	return v.value
}

func (v *NullableCreateRfqCancelBatchQuotesV5RespDataDataInner) Set(val *CreateRfqCancelBatchQuotesV5RespDataDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqCancelBatchQuotesV5RespDataDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqCancelBatchQuotesV5RespDataDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqCancelBatchQuotesV5RespDataDataInner(val *CreateRfqCancelBatchQuotesV5RespDataDataInner) *NullableCreateRfqCancelBatchQuotesV5RespDataDataInner {
	return &NullableCreateRfqCancelBatchQuotesV5RespDataDataInner{value: val, isSet: true}
}

func (v NullableCreateRfqCancelBatchQuotesV5RespDataDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqCancelBatchQuotesV5RespDataDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
