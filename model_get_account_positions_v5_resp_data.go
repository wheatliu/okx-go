...
// checks if the GetAccountPositionsV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountPositionsV5RespData{}

// GetAccountPositionsV5RespData struct for GetAccountPositionsV5RespData
type GetAccountPositionsV5RespData struct {
	...
	CloseOrderAlgo []GetAccountPositionsV5RespDataCloseOrderAlgoInner `json:"closeOrderAlgo,omitempty"`
...
func NewGetAccountPositionsV5RespData() *GetAccountPositionsV5RespData {
	this := GetAccountPositionsV5RespData{}
	var adl string = ""
	this.Adl = &adl
	var availPos string = ""
...
func (o *GetAccountPositionsV5RespData) GetCloseOrderAlgo() []GetAccountPositionsV5RespDataCloseOrderAlgoInner {
	if o == nil || IsNil(o.CloseOrderAlgo) {
		var ret []GetAccountPositionsV5RespDataCloseOrderAlgoInner
		return ret
	}
...
// SetCloseOrderAlgo gets a reference to the given []GetAccountPositionsV5RespDataCloseOrderAlgoInner and assigns it to the CloseOrderAlgo field.
...
func (o GetAccountPositionsV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetAccountPositionsV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountPositionsV5RespData struct {
	value *GetAccountPositionsV5RespData
	isSet bool
}

func (v NullableGetAccountPositionsV5RespData) Get() *GetAccountPositionsV5RespData {
	return v.value
}

func (v *NullableGetAccountPositionsV5RespData) Set(val *GetAccountPositionsV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountPositionsV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountPositionsV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountPositionsV5RespData(val *GetAccountPositionsV5RespData) *NullableGetAccountPositionsV5RespData {
	return &NullableGetAccountPositionsV5RespData{value: val, isSet: true}
}

func (v NullableGetAccountPositionsV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountPositionsV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
