...
// checks if the GetMarketMarkPriceCandlesV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarketMarkPriceCandlesV5Resp{}
...
func NewGetMarketMarkPriceCandlesV5Resp() *GetMarketMarkPriceCandlesV5Resp {
	this := GetMarketMarkPriceCandlesV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetMarketMarkPriceCandlesV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetMarketMarkPriceCandlesV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarketMarkPriceCandlesV5Resp struct {
	value *GetMarketMarkPriceCandlesV5Resp
	isSet bool
}

func (v NullableGetMarketMarkPriceCandlesV5Resp) Get() *GetMarketMarkPriceCandlesV5Resp {
	return v.value
}

func (v *NullableGetMarketMarkPriceCandlesV5Resp) Set(val *GetMarketMarkPriceCandlesV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarketMarkPriceCandlesV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarketMarkPriceCandlesV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarketMarkPriceCandlesV5Resp(val *GetMarketMarkPriceCandlesV5Resp) *NullableGetMarketMarkPriceCandlesV5Resp {
	return &NullableGetMarketMarkPriceCandlesV5Resp{value: val, isSet: true}
}

func (v NullableGetMarketMarkPriceCandlesV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarketMarkPriceCandlesV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
