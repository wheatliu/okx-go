...
// checks if the CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner{}

// CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner struct for CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner
type CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner struct {
...
func NewCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner() *CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner {
	this := CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner{}
...
func (o CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) MarshalJSON() ([]byte, error) {
...
func (o CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner struct {
	value *CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner
	isSet bool
}

func (v NullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) Get() *CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner {
	return v.value
}

func (v *NullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) Set(val *CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner(val *CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) *NullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner {
	return &NullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner{value: val, isSet: true}
}

func (v NullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
