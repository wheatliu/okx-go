...
// checks if the CreateTradingBotGridClosePositionV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotGridClosePositionV5Resp{}
...
func NewCreateTradingBotGridClosePositionV5Resp() *CreateTradingBotGridClosePositionV5Resp {
	this := CreateTradingBotGridClosePositionV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateTradingBotGridClosePositionV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotGridClosePositionV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotGridClosePositionV5Resp struct {
	value *CreateTradingBotGridClosePositionV5Resp
	isSet bool
}

func (v NullableCreateTradingBotGridClosePositionV5Resp) Get() *CreateTradingBotGridClosePositionV5Resp {
	return v.value
}

func (v *NullableCreateTradingBotGridClosePositionV5Resp) Set(val *CreateTradingBotGridClosePositionV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotGridClosePositionV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotGridClosePositionV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotGridClosePositionV5Resp(val *CreateTradingBotGridClosePositionV5Resp) *NullableCreateTradingBotGridClosePositionV5Resp {
	return &NullableCreateTradingBotGridClosePositionV5Resp{value: val, isSet: true}
}

func (v NullableCreateTradingBotGridClosePositionV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotGridClosePositionV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
