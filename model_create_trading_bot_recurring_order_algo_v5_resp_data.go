...
// checks if the CreateTradingBotRecurringOrderAlgoV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotRecurringOrderAlgoV5RespData{}

// CreateTradingBotRecurringOrderAlgoV5RespData struct for CreateTradingBotRecurringOrderAlgoV5RespData
type CreateTradingBotRecurringOrderAlgoV5RespData struct {
...
func NewCreateTradingBotRecurringOrderAlgoV5RespData() *CreateTradingBotRecurringOrderAlgoV5RespData {
	this := CreateTradingBotRecurringOrderAlgoV5RespData{}
...
func (o CreateTradingBotRecurringOrderAlgoV5RespData) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotRecurringOrderAlgoV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotRecurringOrderAlgoV5RespData struct {
	value *CreateTradingBotRecurringOrderAlgoV5RespData
	isSet bool
}

func (v NullableCreateTradingBotRecurringOrderAlgoV5RespData) Get() *CreateTradingBotRecurringOrderAlgoV5RespData {
	return v.value
}

func (v *NullableCreateTradingBotRecurringOrderAlgoV5RespData) Set(val *CreateTradingBotRecurringOrderAlgoV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotRecurringOrderAlgoV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotRecurringOrderAlgoV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotRecurringOrderAlgoV5RespData(val *CreateTradingBotRecurringOrderAlgoV5RespData) *NullableCreateTradingBotRecurringOrderAlgoV5RespData {
	return &NullableCreateTradingBotRecurringOrderAlgoV5RespData{value: val, isSet: true}
}

func (v NullableCreateTradingBotRecurringOrderAlgoV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotRecurringOrderAlgoV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
