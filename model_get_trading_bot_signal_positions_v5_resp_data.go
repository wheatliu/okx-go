...
// checks if the GetTradingBotSignalPositionsV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotSignalPositionsV5RespData{}

// GetTradingBotSignalPositionsV5RespData struct for GetTradingBotSignalPositionsV5RespData
type GetTradingBotSignalPositionsV5RespData struct {
...
func NewGetTradingBotSignalPositionsV5RespData() *GetTradingBotSignalPositionsV5RespData {
	this := GetTradingBotSignalPositionsV5RespData{}
	var adl string = ""
	this.Adl = &adl
...
func (o GetTradingBotSignalPositionsV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotSignalPositionsV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotSignalPositionsV5RespData struct {
	value *GetTradingBotSignalPositionsV5RespData
	isSet bool
}

func (v NullableGetTradingBotSignalPositionsV5RespData) Get() *GetTradingBotSignalPositionsV5RespData {
	return v.value
}

func (v *NullableGetTradingBotSignalPositionsV5RespData) Set(val *GetTradingBotSignalPositionsV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotSignalPositionsV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotSignalPositionsV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotSignalPositionsV5RespData(val *GetTradingBotSignalPositionsV5RespData) *NullableGetTradingBotSignalPositionsV5RespData {
	return &NullableGetTradingBotSignalPositionsV5RespData{value: val, isSet: true}
}

func (v NullableGetTradingBotSignalPositionsV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotSignalPositionsV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
