...
// checks if the GetTradeOrdersHistoryArchiveV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrdersHistoryArchiveV5RespDataInner{}

// GetTradeOrdersHistoryArchiveV5RespDataInner struct for GetTradeOrdersHistoryArchiveV5RespDataInner
type GetTradeOrdersHistoryArchiveV5RespDataInner struct {
...
func NewGetTradeOrdersHistoryArchiveV5RespDataInner() *GetTradeOrdersHistoryArchiveV5RespDataInner {
	this := GetTradeOrdersHistoryArchiveV5RespDataInner{}
...
func (o GetTradeOrdersHistoryArchiveV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrdersHistoryArchiveV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrdersHistoryArchiveV5RespDataInner struct {
	value *GetTradeOrdersHistoryArchiveV5RespDataInner
	isSet bool
}

func (v NullableGetTradeOrdersHistoryArchiveV5RespDataInner) Get() *GetTradeOrdersHistoryArchiveV5RespDataInner {
	return v.value
}

func (v *NullableGetTradeOrdersHistoryArchiveV5RespDataInner) Set(val *GetTradeOrdersHistoryArchiveV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrdersHistoryArchiveV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrdersHistoryArchiveV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrdersHistoryArchiveV5RespDataInner(val *GetTradeOrdersHistoryArchiveV5RespDataInner) *NullableGetTradeOrdersHistoryArchiveV5RespDataInner {
	return &NullableGetTradeOrdersHistoryArchiveV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradeOrdersHistoryArchiveV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrdersHistoryArchiveV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
