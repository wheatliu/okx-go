...
// checks if the CreateTradeBatchOrdersV5Req type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradeBatchOrdersV5Req{}

// CreateTradeBatchOrdersV5Req struct for CreateTradeBatchOrdersV5Req
type CreateTradeBatchOrdersV5Req struct {
	// TP/SL information attached when placing order
	AttachAlgoOrds []CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner `json:"attachAlgoOrds,omitempty"`
...
type _CreateTradeBatchOrdersV5Req CreateTradeBatchOrdersV5Req
...
func NewCreateTradeBatchOrdersV5Req(instId string, ordType string, side string, sz string, tdMode string) *CreateTradeBatchOrdersV5Req {
	this := CreateTradeBatchOrdersV5Req{}
	var ccy string = ""
	this.Ccy = &ccy
	var clOrdId string = ""
...
func (o *CreateTradeBatchOrdersV5Req) GetAttachAlgoOrds() []CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner {
	if o == nil || IsNil(o.AttachAlgoOrds) {
		var ret []CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner
		return ret
	}
...
// SetAttachAlgoOrds gets a reference to the given []CreateTradeBatchOrdersV5ReqAttachAlgoOrdsInner and assigns it to the AttachAlgoOrds field.
...
func (o CreateTradeBatchOrdersV5Req) MarshalJSON() ([]byte, error) {
...
func (o CreateTradeBatchOrdersV5Req) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTradeBatchOrdersV5Req) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTradeBatchOrdersV5Req := _CreateTradeBatchOrdersV5Req{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTradeBatchOrdersV5Req)

	if err != nil {
		return err
	}

	*o = CreateTradeBatchOrdersV5Req(varCreateTradeBatchOrdersV5Req)

	return err
}

type NullableCreateTradeBatchOrdersV5Req struct {
	value *CreateTradeBatchOrdersV5Req
	isSet bool
}

func (v NullableCreateTradeBatchOrdersV5Req) Get() *CreateTradeBatchOrdersV5Req {
	return v.value
}

func (v *NullableCreateTradeBatchOrdersV5Req) Set(val *CreateTradeBatchOrdersV5Req) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradeBatchOrdersV5Req) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradeBatchOrdersV5Req) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradeBatchOrdersV5Req(val *CreateTradeBatchOrdersV5Req) *NullableCreateTradeBatchOrdersV5Req {
	return &NullableCreateTradeBatchOrdersV5Req{value: val, isSet: true}
}

func (v NullableCreateTradeBatchOrdersV5Req) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradeBatchOrdersV5Req) UnmarshalJSON(src []byte) error {
	v.isSet = true
