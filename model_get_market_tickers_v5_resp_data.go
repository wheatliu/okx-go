...
// checks if the GetMarketTickersV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarketTickersV5RespData{}

// GetMarketTickersV5RespData struct for GetMarketTickersV5RespData
type GetMarketTickersV5RespData struct {
	// Best ask price
...
func NewGetMarketTickersV5RespData() *GetMarketTickersV5RespData {
	this := GetMarketTickersV5RespData{}
	var askPx string = ""
	this.AskPx = &askPx
	var askSz string = ""
	this.AskSz = &askSz
...
func (o GetMarketTickersV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetMarketTickersV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarketTickersV5RespData struct {
	value *GetMarketTickersV5RespData
	isSet bool
}

func (v NullableGetMarketTickersV5RespData) Get() *GetMarketTickersV5RespData {
	return v.value
}

func (v *NullableGetMarketTickersV5RespData) Set(val *GetMarketTickersV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarketTickersV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarketTickersV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarketTickersV5RespData(val *GetMarketTickersV5RespData) *NullableGetMarketTickersV5RespData {
	return &NullableGetMarketTickersV5RespData{value: val, isSet: true}
}

func (v NullableGetMarketTickersV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarketTickersV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
