...
// checks if the GetPublicOptionTradesV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicOptionTradesV5RespData{}

// GetPublicOptionTradesV5RespData struct for GetPublicOptionTradesV5RespData
type GetPublicOptionTradesV5RespData struct {
...
func NewGetPublicOptionTradesV5RespData() *GetPublicOptionTradesV5RespData {
	this := GetPublicOptionTradesV5RespData{}
	var fillVol string = ""
...
func (o GetPublicOptionTradesV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetPublicOptionTradesV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicOptionTradesV5RespData struct {
	value *GetPublicOptionTradesV5RespData
	isSet bool
}

func (v NullableGetPublicOptionTradesV5RespData) Get() *GetPublicOptionTradesV5RespData {
	return v.value
}

func (v *NullableGetPublicOptionTradesV5RespData) Set(val *GetPublicOptionTradesV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicOptionTradesV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicOptionTradesV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicOptionTradesV5RespData(val *GetPublicOptionTradesV5RespData) *NullableGetPublicOptionTradesV5RespData {
	return &NullableGetPublicOptionTradesV5RespData{value: val, isSet: true}
}

func (v NullableGetPublicOptionTradesV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicOptionTradesV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
