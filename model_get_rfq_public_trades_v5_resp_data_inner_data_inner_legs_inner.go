...
// checks if the GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner{}

// GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner struct for GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner
type GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner struct {
...
func NewGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner() *GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner {
	this := GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner{}
	var instId string = ""
	this.InstId = &instId
	var px string = ""
	this.Px = &px
...
func (o GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
...
func (o GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner struct {
	value *GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner
	isSet bool
}

func (v NullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) Get() *GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner {
	return v.value
}

func (v *NullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) Set(val *GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner(val *GetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) *NullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner {
	return &NullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner{value: val, isSet: true}
}

func (v NullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRfqPublicTradesV5RespDataInnerDataInnerLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
