...
// checks if the GetRfqRfqsV5RespDataInnerDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRfqRfqsV5RespDataInnerDataInner{}

// GetRfqRfqsV5RespDataInnerDataInner struct for GetRfqRfqsV5RespDataInnerDataInner
type GetRfqRfqsV5RespDataInnerDataInner struct {
	...
	// Legs of RFQ
	Legs []GetRfqRfqsV5RespDataInnerDataInnerLegsInner `json:"legs,omitempty"`
...
func NewGetRfqRfqsV5RespDataInnerDataInner() *GetRfqRfqsV5RespDataInnerDataInner {
	this := GetRfqRfqsV5RespDataInnerDataInner{}
	var cTime string = ""
	this.CTime = &cTime
	var ccy string = ""
	this.Ccy = &ccy
...
func (o *GetRfqRfqsV5RespDataInnerDataInner) GetLegs() []GetRfqRfqsV5RespDataInnerDataInnerLegsInner {
	if o == nil || IsNil(o.Legs) {
		var ret []GetRfqRfqsV5RespDataInnerDataInnerLegsInner
		return ret
	}
	return o.Legs
}
...
// SetLegs gets a reference to the given []GetRfqRfqsV5RespDataInnerDataInnerLegsInner and assigns it to the Legs field.
...
func (o GetRfqRfqsV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetRfqRfqsV5RespDataInnerDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRfqRfqsV5RespDataInnerDataInner struct {
	value *GetRfqRfqsV5RespDataInnerDataInner
	isSet bool
}

func (v NullableGetRfqRfqsV5RespDataInnerDataInner) Get() *GetRfqRfqsV5RespDataInnerDataInner {
	return v.value
}

func (v *NullableGetRfqRfqsV5RespDataInnerDataInner) Set(val *GetRfqRfqsV5RespDataInnerDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRfqRfqsV5RespDataInnerDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRfqRfqsV5RespDataInnerDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRfqRfqsV5RespDataInnerDataInner(val *GetRfqRfqsV5RespDataInnerDataInner) *NullableGetRfqRfqsV5RespDataInnerDataInner {
	return &NullableGetRfqRfqsV5RespDataInnerDataInner{value: val, isSet: true}
}

func (v NullableGetRfqRfqsV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRfqRfqsV5RespDataInnerDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
