...
// checks if the GetCopytradingUnrealizedProfitSharingDetailsV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCopytradingUnrealizedProfitSharingDetailsV5RespData{}

// GetCopytradingUnrealizedProfitSharingDetailsV5RespData struct for GetCopytradingUnrealizedProfitSharingDetailsV5RespData
type GetCopytradingUnrealizedProfitSharingDetailsV5RespData struct {
...
func NewGetCopytradingUnrealizedProfitSharingDetailsV5RespData() *GetCopytradingUnrealizedProfitSharingDetailsV5RespData {
	this := GetCopytradingUnrealizedProfitSharingDetailsV5RespData{}
	var ccy string = ""
	this.Ccy = &ccy
	var instType string = ""
...
func (o GetCopytradingUnrealizedProfitSharingDetailsV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetCopytradingUnrealizedProfitSharingDetailsV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData struct {
	value *GetCopytradingUnrealizedProfitSharingDetailsV5RespData
	isSet bool
}

func (v NullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData) Get() *GetCopytradingUnrealizedProfitSharingDetailsV5RespData {
	return v.value
}

func (v *NullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData) Set(val *GetCopytradingUnrealizedProfitSharingDetailsV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData(val *GetCopytradingUnrealizedProfitSharingDetailsV5RespData) *NullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData {
	return &NullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData{value: val, isSet: true}
}

func (v NullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCopytradingUnrealizedProfitSharingDetailsV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
