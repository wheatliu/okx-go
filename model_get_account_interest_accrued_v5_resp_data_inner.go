...
// checks if the GetAccountInterestAccruedV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountInterestAccruedV5RespDataInner{}

// GetAccountInterestAccruedV5RespDataInner struct for GetAccountInterestAccruedV5RespDataInner
type GetAccountInterestAccruedV5RespDataInner struct {
...
func NewGetAccountInterestAccruedV5RespDataInner() *GetAccountInterestAccruedV5RespDataInner {
	this := GetAccountInterestAccruedV5RespDataInner{}
	var ccy string = ""
	this.Ccy = &ccy
	var instId string = ""
	this.InstId = &instId
...
func (o GetAccountInterestAccruedV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetAccountInterestAccruedV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountInterestAccruedV5RespDataInner struct {
	value *GetAccountInterestAccruedV5RespDataInner
	isSet bool
}

func (v NullableGetAccountInterestAccruedV5RespDataInner) Get() *GetAccountInterestAccruedV5RespDataInner {
	return v.value
}

func (v *NullableGetAccountInterestAccruedV5RespDataInner) Set(val *GetAccountInterestAccruedV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountInterestAccruedV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountInterestAccruedV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountInterestAccruedV5RespDataInner(val *GetAccountInterestAccruedV5RespDataInner) *NullableGetAccountInterestAccruedV5RespDataInner {
	return &NullableGetAccountInterestAccruedV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetAccountInterestAccruedV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountInterestAccruedV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
