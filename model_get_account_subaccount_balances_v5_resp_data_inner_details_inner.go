...
// checks if the GetAccountSubaccountBalancesV5RespDataInnerDetailsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountSubaccountBalancesV5RespDataInnerDetailsInner{}

// GetAccountSubaccountBalancesV5RespDataInnerDetailsInner struct for GetAccountSubaccountBalancesV5RespDataInnerDetailsInner
type GetAccountSubaccountBalancesV5RespDataInnerDetailsInner struct {
...
func NewGetAccountSubaccountBalancesV5RespDataInnerDetailsInner() *GetAccountSubaccountBalancesV5RespDataInnerDetailsInner {
	this := GetAccountSubaccountBalancesV5RespDataInnerDetailsInner{}
	var accAvgPx string = ""
...
func (o GetAccountSubaccountBalancesV5RespDataInnerDetailsInner) MarshalJSON() ([]byte, error) {
...
func (o GetAccountSubaccountBalancesV5RespDataInnerDetailsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner struct {
	value *GetAccountSubaccountBalancesV5RespDataInnerDetailsInner
	isSet bool
}

func (v NullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner) Get() *GetAccountSubaccountBalancesV5RespDataInnerDetailsInner {
	return v.value
}

func (v *NullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner) Set(val *GetAccountSubaccountBalancesV5RespDataInnerDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner(val *GetAccountSubaccountBalancesV5RespDataInnerDetailsInner) *NullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner {
	return &NullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner{value: val, isSet: true}
}

func (v NullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountSubaccountBalancesV5RespDataInnerDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
