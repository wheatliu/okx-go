...
// checks if the GetAccountBalanceV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountBalanceV5RespData{}

// GetAccountBalanceV5RespData struct for GetAccountBalanceV5RespData
type GetAccountBalanceV5RespData struct {
	...
	Details []GetAccountBalanceV5RespDataDetailsInner `json:"details,omitempty"`
...
func NewGetAccountBalanceV5RespData() *GetAccountBalanceV5RespData {
	this := GetAccountBalanceV5RespData{}
	var adjEq string = ""
	this.AdjEq = &adjEq
...
func (o *GetAccountBalanceV5RespData) GetDetails() []GetAccountBalanceV5RespDataDetailsInner {
	if o == nil || IsNil(o.Details) {
		var ret []GetAccountBalanceV5RespDataDetailsInner
		return ret
	}
	return o.Details
}
...
// SetDetails gets a reference to the given []GetAccountBalanceV5RespDataDetailsInner and assigns it to the Details field.
...
func (o GetAccountBalanceV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetAccountBalanceV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountBalanceV5RespData struct {
	value *GetAccountBalanceV5RespData
	isSet bool
}

func (v NullableGetAccountBalanceV5RespData) Get() *GetAccountBalanceV5RespData {
	return v.value
}

func (v *NullableGetAccountBalanceV5RespData) Set(val *GetAccountBalanceV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountBalanceV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountBalanceV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountBalanceV5RespData(val *GetAccountBalanceV5RespData) *NullableGetAccountBalanceV5RespData {
	return &NullableGetAccountBalanceV5RespData{value: val, isSet: true}
}

func (v NullableGetAccountBalanceV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountBalanceV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
