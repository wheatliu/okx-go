...
// checks if the GetPublicPositionTiersV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicPositionTiersV5Resp{}
...
func NewGetPublicPositionTiersV5Resp() *GetPublicPositionTiersV5Resp {
	this := GetPublicPositionTiersV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetPublicPositionTiersV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetPublicPositionTiersV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicPositionTiersV5Resp struct {
	value *GetPublicPositionTiersV5Resp
	isSet bool
}

func (v NullableGetPublicPositionTiersV5Resp) Get() *GetPublicPositionTiersV5Resp {
	return v.value
}

func (v *NullableGetPublicPositionTiersV5Resp) Set(val *GetPublicPositionTiersV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicPositionTiersV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicPositionTiersV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicPositionTiersV5Resp(val *GetPublicPositionTiersV5Resp) *NullableGetPublicPositionTiersV5Resp {
	return &NullableGetPublicPositionTiersV5Resp{value: val, isSet: true}
}

func (v NullableGetPublicPositionTiersV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicPositionTiersV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
