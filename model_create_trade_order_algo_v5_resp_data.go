...
// checks if the CreateTradeOrderAlgoV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradeOrderAlgoV5RespData{}

// CreateTradeOrderAlgoV5RespData struct for CreateTradeOrderAlgoV5RespData
type CreateTradeOrderAlgoV5RespData struct {
...
func NewCreateTradeOrderAlgoV5RespData() *CreateTradeOrderAlgoV5RespData {
	this := CreateTradeOrderAlgoV5RespData{}
...
func (o CreateTradeOrderAlgoV5RespData) MarshalJSON() ([]byte, error) {
...
func (o CreateTradeOrderAlgoV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradeOrderAlgoV5RespData struct {
	value *CreateTradeOrderAlgoV5RespData
	isSet bool
}

func (v NullableCreateTradeOrderAlgoV5RespData) Get() *CreateTradeOrderAlgoV5RespData {
	return v.value
}

func (v *NullableCreateTradeOrderAlgoV5RespData) Set(val *CreateTradeOrderAlgoV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradeOrderAlgoV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradeOrderAlgoV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradeOrderAlgoV5RespData(val *CreateTradeOrderAlgoV5RespData) *NullableCreateTradeOrderAlgoV5RespData {
	return &NullableCreateTradeOrderAlgoV5RespData{value: val, isSet: true}
}

func (v NullableCreateTradeOrderAlgoV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradeOrderAlgoV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
