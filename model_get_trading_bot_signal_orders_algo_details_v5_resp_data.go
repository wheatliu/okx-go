...
// checks if the GetTradingBotSignalOrdersAlgoDetailsV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotSignalOrdersAlgoDetailsV5RespData{}

// GetTradingBotSignalOrdersAlgoDetailsV5RespData struct for GetTradingBotSignalOrdersAlgoDetailsV5RespData
type GetTradingBotSignalOrdersAlgoDetailsV5RespData struct {
...
func NewGetTradingBotSignalOrdersAlgoDetailsV5RespData() *GetTradingBotSignalOrdersAlgoDetailsV5RespData {
	this := GetTradingBotSignalOrdersAlgoDetailsV5RespData{}
...
func (o GetTradingBotSignalOrdersAlgoDetailsV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotSignalOrdersAlgoDetailsV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotSignalOrdersAlgoDetailsV5RespData struct {
	value *GetTradingBotSignalOrdersAlgoDetailsV5RespData
	isSet bool
}

func (v NullableGetTradingBotSignalOrdersAlgoDetailsV5RespData) Get() *GetTradingBotSignalOrdersAlgoDetailsV5RespData {
	return v.value
}

func (v *NullableGetTradingBotSignalOrdersAlgoDetailsV5RespData) Set(val *GetTradingBotSignalOrdersAlgoDetailsV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotSignalOrdersAlgoDetailsV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotSignalOrdersAlgoDetailsV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotSignalOrdersAlgoDetailsV5RespData(val *GetTradingBotSignalOrdersAlgoDetailsV5RespData) *NullableGetTradingBotSignalOrdersAlgoDetailsV5RespData {
	return &NullableGetTradingBotSignalOrdersAlgoDetailsV5RespData{value: val, isSet: true}
}

func (v NullableGetTradingBotSignalOrdersAlgoDetailsV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotSignalOrdersAlgoDetailsV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
