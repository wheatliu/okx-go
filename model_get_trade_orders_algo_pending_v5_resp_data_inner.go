...
// checks if the GetTradeOrdersAlgoPendingV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrdersAlgoPendingV5RespDataInner{}

// GetTradeOrdersAlgoPendingV5RespDataInner struct for GetTradeOrdersAlgoPendingV5RespDataInner
type GetTradeOrdersAlgoPendingV5RespDataInner struct {
...
func NewGetTradeOrdersAlgoPendingV5RespDataInner() *GetTradeOrdersAlgoPendingV5RespDataInner {
	this := GetTradeOrdersAlgoPendingV5RespDataInner{}
	var activePx string = ""
...
func (o GetTradeOrdersAlgoPendingV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrdersAlgoPendingV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrdersAlgoPendingV5RespDataInner struct {
	value *GetTradeOrdersAlgoPendingV5RespDataInner
	isSet bool
}

func (v NullableGetTradeOrdersAlgoPendingV5RespDataInner) Get() *GetTradeOrdersAlgoPendingV5RespDataInner {
	return v.value
}

func (v *NullableGetTradeOrdersAlgoPendingV5RespDataInner) Set(val *GetTradeOrdersAlgoPendingV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrdersAlgoPendingV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrdersAlgoPendingV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrdersAlgoPendingV5RespDataInner(val *GetTradeOrdersAlgoPendingV5RespDataInner) *NullableGetTradeOrdersAlgoPendingV5RespDataInner {
	return &NullableGetTradeOrdersAlgoPendingV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradeOrdersAlgoPendingV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrdersAlgoPendingV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
