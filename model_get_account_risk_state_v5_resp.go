...
// checks if the GetAccountRiskStateV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountRiskStateV5Resp{}
...
func NewGetAccountRiskStateV5Resp() *GetAccountRiskStateV5Resp {
	this := GetAccountRiskStateV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetAccountRiskStateV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetAccountRiskStateV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountRiskStateV5Resp struct {
	value *GetAccountRiskStateV5Resp
	isSet bool
}

func (v NullableGetAccountRiskStateV5Resp) Get() *GetAccountRiskStateV5Resp {
	return v.value
}

func (v *NullableGetAccountRiskStateV5Resp) Set(val *GetAccountRiskStateV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountRiskStateV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountRiskStateV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountRiskStateV5Resp(val *GetAccountRiskStateV5Resp) *NullableGetAccountRiskStateV5Resp {
	return &NullableGetAccountRiskStateV5Resp{value: val, isSet: true}
}

func (v NullableGetAccountRiskStateV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountRiskStateV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
