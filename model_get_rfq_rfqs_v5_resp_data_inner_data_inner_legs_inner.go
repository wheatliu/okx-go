...
// checks if the GetRfqRfqsV5RespDataInnerDataInnerLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRfqRfqsV5RespDataInnerDataInnerLegsInner{}

// GetRfqRfqsV5RespDataInnerDataInnerLegsInner struct for GetRfqRfqsV5RespDataInnerDataInnerLegsInner
type GetRfqRfqsV5RespDataInnerDataInnerLegsInner struct {
...
func NewGetRfqRfqsV5RespDataInnerDataInnerLegsInner() *GetRfqRfqsV5RespDataInnerDataInnerLegsInner {
	this := GetRfqRfqsV5RespDataInnerDataInnerLegsInner{}
	var ccy string = ""
	this.Ccy = &ccy
	var instId string = ""
	this.InstId = &instId
...
func (o GetRfqRfqsV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
...
func (o GetRfqRfqsV5RespDataInnerDataInnerLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner struct {
	value *GetRfqRfqsV5RespDataInnerDataInnerLegsInner
	isSet bool
}

func (v NullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner) Get() *GetRfqRfqsV5RespDataInnerDataInnerLegsInner {
	return v.value
}

func (v *NullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner) Set(val *GetRfqRfqsV5RespDataInnerDataInnerLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner(val *GetRfqRfqsV5RespDataInnerDataInnerLegsInner) *NullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner {
	return &NullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner{value: val, isSet: true}
}

func (v NullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRfqRfqsV5RespDataInnerDataInnerLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
