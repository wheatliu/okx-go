...
// checks if the GetTradeOrdersAlgoHistoryV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrdersAlgoHistoryV5RespData{}

// GetTradeOrdersAlgoHistoryV5RespData struct for GetTradeOrdersAlgoHistoryV5RespData
type GetTradeOrdersAlgoHistoryV5RespData struct {
...
func NewGetTradeOrdersAlgoHistoryV5RespData() *GetTradeOrdersAlgoHistoryV5RespData {
	this := GetTradeOrdersAlgoHistoryV5RespData{}
	var activePx string = ""
...
func (o GetTradeOrdersAlgoHistoryV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrdersAlgoHistoryV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrdersAlgoHistoryV5RespData struct {
	value *GetTradeOrdersAlgoHistoryV5RespData
	isSet bool
}

func (v NullableGetTradeOrdersAlgoHistoryV5RespData) Get() *GetTradeOrdersAlgoHistoryV5RespData {
	return v.value
}

func (v *NullableGetTradeOrdersAlgoHistoryV5RespData) Set(val *GetTradeOrdersAlgoHistoryV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrdersAlgoHistoryV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrdersAlgoHistoryV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrdersAlgoHistoryV5RespData(val *GetTradeOrdersAlgoHistoryV5RespData) *NullableGetTradeOrdersAlgoHistoryV5RespData {
	return &NullableGetTradeOrdersAlgoHistoryV5RespData{value: val, isSet: true}
}

func (v NullableGetTradeOrdersAlgoHistoryV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrdersAlgoHistoryV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
