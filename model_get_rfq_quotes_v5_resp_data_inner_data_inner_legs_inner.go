...
// checks if the GetRfqQuotesV5RespDataInnerDataInnerLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRfqQuotesV5RespDataInnerDataInnerLegsInner{}

// GetRfqQuotesV5RespDataInnerDataInnerLegsInner struct for GetRfqQuotesV5RespDataInnerDataInnerLegsInner
type GetRfqQuotesV5RespDataInnerDataInnerLegsInner struct {
...
func NewGetRfqQuotesV5RespDataInnerDataInnerLegsInner() *GetRfqQuotesV5RespDataInnerDataInnerLegsInner {
	this := GetRfqQuotesV5RespDataInnerDataInnerLegsInner{}
	var ccy string = ""
	this.Ccy = &ccy
	var instId string = ""
	this.InstId = &instId
...
func (o GetRfqQuotesV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
...
func (o GetRfqQuotesV5RespDataInnerDataInnerLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner struct {
	value *GetRfqQuotesV5RespDataInnerDataInnerLegsInner
	isSet bool
}

func (v NullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner) Get() *GetRfqQuotesV5RespDataInnerDataInnerLegsInner {
	return v.value
}

func (v *NullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner) Set(val *GetRfqQuotesV5RespDataInnerDataInnerLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner(val *GetRfqQuotesV5RespDataInnerDataInnerLegsInner) *NullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner {
	return &NullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner{value: val, isSet: true}
}

func (v NullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRfqQuotesV5RespDataInnerDataInnerLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
