...
// checks if the GetPublicOpenInterestV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicOpenInterestV5RespDataInner{}

// GetPublicOpenInterestV5RespDataInner struct for GetPublicOpenInterestV5RespDataInner
type GetPublicOpenInterestV5RespDataInner struct {
	// Instrument ID
...
func NewGetPublicOpenInterestV5RespDataInner() *GetPublicOpenInterestV5RespDataInner {
	this := GetPublicOpenInterestV5RespDataInner{}
	var instId string = ""
	this.InstId = &instId
	var instType string = ""
...
func (o GetPublicOpenInterestV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetPublicOpenInterestV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicOpenInterestV5RespDataInner struct {
	value *GetPublicOpenInterestV5RespDataInner
	isSet bool
}

func (v NullableGetPublicOpenInterestV5RespDataInner) Get() *GetPublicOpenInterestV5RespDataInner {
	return v.value
}

func (v *NullableGetPublicOpenInterestV5RespDataInner) Set(val *GetPublicOpenInterestV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicOpenInterestV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicOpenInterestV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicOpenInterestV5RespDataInner(val *GetPublicOpenInterestV5RespDataInner) *NullableGetPublicOpenInterestV5RespDataInner {
	return &NullableGetPublicOpenInterestV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetPublicOpenInterestV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicOpenInterestV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
