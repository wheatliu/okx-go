...
// checks if the GetAssetBalancesV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAssetBalancesV5RespData{}

// GetAssetBalancesV5RespData struct for GetAssetBalancesV5RespData
type GetAssetBalancesV5RespData struct {
	// Available balance
...
func NewGetAssetBalancesV5RespData() *GetAssetBalancesV5RespData {
	this := GetAssetBalancesV5RespData{}
	var availBal string = ""
...
func (o GetAssetBalancesV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetAssetBalancesV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetAssetBalancesV5RespData struct {
	value *GetAssetBalancesV5RespData
	isSet bool
}

func (v NullableGetAssetBalancesV5RespData) Get() *GetAssetBalancesV5RespData {
	return v.value
}

func (v *NullableGetAssetBalancesV5RespData) Set(val *GetAssetBalancesV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetBalancesV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetBalancesV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetBalancesV5RespData(val *GetAssetBalancesV5RespData) *NullableGetAssetBalancesV5RespData {
	return &NullableGetAssetBalancesV5RespData{value: val, isSet: true}
}

func (v NullableGetAssetBalancesV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetBalancesV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
