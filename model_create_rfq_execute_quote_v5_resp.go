...
// checks if the CreateRfqExecuteQuoteV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqExecuteQuoteV5Resp{}
...
func NewCreateRfqExecuteQuoteV5Resp() *CreateRfqExecuteQuoteV5Resp {
	this := CreateRfqExecuteQuoteV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateRfqExecuteQuoteV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqExecuteQuoteV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqExecuteQuoteV5Resp struct {
	value *CreateRfqExecuteQuoteV5Resp
	isSet bool
}

func (v NullableCreateRfqExecuteQuoteV5Resp) Get() *CreateRfqExecuteQuoteV5Resp {
	return v.value
}

func (v *NullableCreateRfqExecuteQuoteV5Resp) Set(val *CreateRfqExecuteQuoteV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqExecuteQuoteV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqExecuteQuoteV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqExecuteQuoteV5Resp(val *CreateRfqExecuteQuoteV5Resp) *NullableCreateRfqExecuteQuoteV5Resp {
	return &NullableCreateRfqExecuteQuoteV5Resp{value: val, isSet: true}
}

func (v NullableCreateRfqExecuteQuoteV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqExecuteQuoteV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
