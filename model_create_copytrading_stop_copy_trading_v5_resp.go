...
// checks if the CreateCopytradingStopCopyTradingV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCopytradingStopCopyTradingV5Resp{}

// CreateCopytradingStopCopyTradingV5Resp struct for CreateCopytradingStopCopyTradingV5Resp
type CreateCopytradingStopCopyTradingV5Resp struct {
...
func NewCreateCopytradingStopCopyTradingV5Resp() *CreateCopytradingStopCopyTradingV5Resp {
	this := CreateCopytradingStopCopyTradingV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateCopytradingStopCopyTradingV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateCopytradingStopCopyTradingV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCopytradingStopCopyTradingV5Resp struct {
	value *CreateCopytradingStopCopyTradingV5Resp
	isSet bool
}

func (v NullableCreateCopytradingStopCopyTradingV5Resp) Get() *CreateCopytradingStopCopyTradingV5Resp {
	return v.value
}

func (v *NullableCreateCopytradingStopCopyTradingV5Resp) Set(val *CreateCopytradingStopCopyTradingV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCopytradingStopCopyTradingV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCopytradingStopCopyTradingV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCopytradingStopCopyTradingV5Resp(val *CreateCopytradingStopCopyTradingV5Resp) *NullableCreateCopytradingStopCopyTradingV5Resp {
	return &NullableCreateCopytradingStopCopyTradingV5Resp{value: val, isSet: true}
}

func (v NullableCreateCopytradingStopCopyTradingV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCopytradingStopCopyTradingV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
