...
// checks if the CreateTradeClosePositionV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradeClosePositionV5RespData{}

// CreateTradeClosePositionV5RespData struct for CreateTradeClosePositionV5RespData
type CreateTradeClosePositionV5RespData struct {
...
func NewCreateTradeClosePositionV5RespData() *CreateTradeClosePositionV5RespData {
	this := CreateTradeClosePositionV5RespData{}
	var clOrdId string = ""
...
func (o CreateTradeClosePositionV5RespData) MarshalJSON() ([]byte, error) {
...
func (o CreateTradeClosePositionV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradeClosePositionV5RespData struct {
	value *CreateTradeClosePositionV5RespData
	isSet bool
}

func (v NullableCreateTradeClosePositionV5RespData) Get() *CreateTradeClosePositionV5RespData {
	return v.value
}

func (v *NullableCreateTradeClosePositionV5RespData) Set(val *CreateTradeClosePositionV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradeClosePositionV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradeClosePositionV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradeClosePositionV5RespData(val *CreateTradeClosePositionV5RespData) *NullableCreateTradeClosePositionV5RespData {
	return &NullableCreateTradeClosePositionV5RespData{value: val, isSet: true}
}

func (v NullableCreateTradeClosePositionV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradeClosePositionV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
