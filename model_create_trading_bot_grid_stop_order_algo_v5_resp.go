...
// checks if the CreateTradingBotGridStopOrderAlgoV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotGridStopOrderAlgoV5Resp{}

// CreateTradingBotGridStopOrderAlgoV5Resp struct for CreateTradingBotGridStopOrderAlgoV5Resp
type CreateTradingBotGridStopOrderAlgoV5Resp struct {
...
func NewCreateTradingBotGridStopOrderAlgoV5Resp() *CreateTradingBotGridStopOrderAlgoV5Resp {
	this := CreateTradingBotGridStopOrderAlgoV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateTradingBotGridStopOrderAlgoV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotGridStopOrderAlgoV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotGridStopOrderAlgoV5Resp struct {
	value *CreateTradingBotGridStopOrderAlgoV5Resp
	isSet bool
}

func (v NullableCreateTradingBotGridStopOrderAlgoV5Resp) Get() *CreateTradingBotGridStopOrderAlgoV5Resp {
	return v.value
}

func (v *NullableCreateTradingBotGridStopOrderAlgoV5Resp) Set(val *CreateTradingBotGridStopOrderAlgoV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotGridStopOrderAlgoV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotGridStopOrderAlgoV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotGridStopOrderAlgoV5Resp(val *CreateTradingBotGridStopOrderAlgoV5Resp) *NullableCreateTradingBotGridStopOrderAlgoV5Resp {
	return &NullableCreateTradingBotGridStopOrderAlgoV5Resp{value: val, isSet: true}
}

func (v NullableCreateTradingBotGridStopOrderAlgoV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotGridStopOrderAlgoV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
