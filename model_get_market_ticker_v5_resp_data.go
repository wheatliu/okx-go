...
// checks if the GetMarketTickerV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarketTickerV5RespData{}

// GetMarketTickerV5RespData struct for GetMarketTickerV5RespData
type GetMarketTickerV5RespData struct {
	// Best ask price
...
func NewGetMarketTickerV5RespData() *GetMarketTickerV5RespData {
	this := GetMarketTickerV5RespData{}
	var askPx string = ""
	this.AskPx = &askPx
	var askSz string = ""
	this.AskSz = &askSz
...
func (o GetMarketTickerV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetMarketTickerV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarketTickerV5RespData struct {
	value *GetMarketTickerV5RespData
	isSet bool
}

func (v NullableGetMarketTickerV5RespData) Get() *GetMarketTickerV5RespData {
	return v.value
}

func (v *NullableGetMarketTickerV5RespData) Set(val *GetMarketTickerV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarketTickerV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarketTickerV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarketTickerV5RespData(val *GetMarketTickerV5RespData) *NullableGetMarketTickerV5RespData {
	return &NullableGetMarketTickerV5RespData{value: val, isSet: true}
}

func (v NullableGetMarketTickerV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarketTickerV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
