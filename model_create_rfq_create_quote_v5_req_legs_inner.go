...
// checks if the CreateRfqCreateQuoteV5ReqLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqCreateQuoteV5ReqLegsInner{}

// CreateRfqCreateQuoteV5ReqLegsInner struct for CreateRfqCreateQuoteV5ReqLegsInner
type CreateRfqCreateQuoteV5ReqLegsInner struct {
...
func NewCreateRfqCreateQuoteV5ReqLegsInner() *CreateRfqCreateQuoteV5ReqLegsInner {
	this := CreateRfqCreateQuoteV5ReqLegsInner{}
	var ccy string = ""
	this.Ccy = &ccy
	var instId string = ""
	this.InstId = &instId
...
func (o CreateRfqCreateQuoteV5ReqLegsInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqCreateQuoteV5ReqLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqCreateQuoteV5ReqLegsInner struct {
	value *CreateRfqCreateQuoteV5ReqLegsInner
	isSet bool
}

func (v NullableCreateRfqCreateQuoteV5ReqLegsInner) Get() *CreateRfqCreateQuoteV5ReqLegsInner {
	return v.value
}

func (v *NullableCreateRfqCreateQuoteV5ReqLegsInner) Set(val *CreateRfqCreateQuoteV5ReqLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqCreateQuoteV5ReqLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqCreateQuoteV5ReqLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqCreateQuoteV5ReqLegsInner(val *CreateRfqCreateQuoteV5ReqLegsInner) *NullableCreateRfqCreateQuoteV5ReqLegsInner {
	return &NullableCreateRfqCreateQuoteV5ReqLegsInner{value: val, isSet: true}
}

func (v NullableCreateRfqCreateQuoteV5ReqLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqCreateQuoteV5ReqLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
