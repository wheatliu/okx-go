...
// checks if the GetAssetConvertHistoryV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAssetConvertHistoryV5RespData{}

// GetAssetConvertHistoryV5RespData struct for GetAssetConvertHistoryV5RespData
type GetAssetConvertHistoryV5RespData struct {
...
func NewGetAssetConvertHistoryV5RespData() *GetAssetConvertHistoryV5RespData {
	this := GetAssetConvertHistoryV5RespData{}
	var baseCcy string = ""
...
func (o GetAssetConvertHistoryV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetAssetConvertHistoryV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetAssetConvertHistoryV5RespData struct {
	value *GetAssetConvertHistoryV5RespData
	isSet bool
}

func (v NullableGetAssetConvertHistoryV5RespData) Get() *GetAssetConvertHistoryV5RespData {
	return v.value
}

func (v *NullableGetAssetConvertHistoryV5RespData) Set(val *GetAssetConvertHistoryV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetConvertHistoryV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetConvertHistoryV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetConvertHistoryV5RespData(val *GetAssetConvertHistoryV5RespData) *NullableGetAssetConvertHistoryV5RespData {
	return &NullableGetAssetConvertHistoryV5RespData{value: val, isSet: true}
}

func (v NullableGetAssetConvertHistoryV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetConvertHistoryV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
