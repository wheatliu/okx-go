...
// checks if the GetMarketTickerV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarketTickerV5RespDataInner{}

// GetMarketTickerV5RespDataInner struct for GetMarketTickerV5RespDataInner
type GetMarketTickerV5RespDataInner struct {
	// Best ask price
...
func NewGetMarketTickerV5RespDataInner() *GetMarketTickerV5RespDataInner {
	this := GetMarketTickerV5RespDataInner{}
	var askPx string = ""
	this.AskPx = &askPx
	var askSz string = ""
	this.AskSz = &askSz
...
func (o GetMarketTickerV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetMarketTickerV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarketTickerV5RespDataInner struct {
	value *GetMarketTickerV5RespDataInner
	isSet bool
}

func (v NullableGetMarketTickerV5RespDataInner) Get() *GetMarketTickerV5RespDataInner {
	return v.value
}

func (v *NullableGetMarketTickerV5RespDataInner) Set(val *GetMarketTickerV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarketTickerV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarketTickerV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarketTickerV5RespDataInner(val *GetMarketTickerV5RespDataInner) *NullableGetMarketTickerV5RespDataInner {
	return &NullableGetMarketTickerV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetMarketTickerV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarketTickerV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
