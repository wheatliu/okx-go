...
// checks if the GetTradingBotGridOrdersAlgoPendingV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotGridOrdersAlgoPendingV5RespDataInner{}

// GetTradingBotGridOrdersAlgoPendingV5RespDataInner struct for GetTradingBotGridOrdersAlgoPendingV5RespDataInner
type GetTradingBotGridOrdersAlgoPendingV5RespDataInner struct {
	...
	// Algo order state  `starting`  `running`  `stopping`  `pending_signal`  `no_close_position`: stopped algo order but have not closed position yet
	State *string `json:"state,omitempty"`
	// Actual Stop type  Spot `1`: Sell base currency `2`: Keep base currency  Contract grid `1`: Market Close All positions `2`: Keep positions
...
func NewGetTradingBotGridOrdersAlgoPendingV5RespDataInner() *GetTradingBotGridOrdersAlgoPendingV5RespDataInner {
	this := GetTradingBotGridOrdersAlgoPendingV5RespDataInner{}
...
func (o GetTradingBotGridOrdersAlgoPendingV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotGridOrdersAlgoPendingV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner struct {
	value *GetTradingBotGridOrdersAlgoPendingV5RespDataInner
	isSet bool
}

func (v NullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner) Get() *GetTradingBotGridOrdersAlgoPendingV5RespDataInner {
	return v.value
}

func (v *NullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner) Set(val *GetTradingBotGridOrdersAlgoPendingV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner(val *GetTradingBotGridOrdersAlgoPendingV5RespDataInner) *NullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner {
	return &NullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotGridOrdersAlgoPendingV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
