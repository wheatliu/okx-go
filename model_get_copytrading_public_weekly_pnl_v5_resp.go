...
// checks if the GetCopytradingPublicWeeklyPnlV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCopytradingPublicWeeklyPnlV5Resp{}
...
func NewGetCopytradingPublicWeeklyPnlV5Resp() *GetCopytradingPublicWeeklyPnlV5Resp {
	this := GetCopytradingPublicWeeklyPnlV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetCopytradingPublicWeeklyPnlV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetCopytradingPublicWeeklyPnlV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetCopytradingPublicWeeklyPnlV5Resp struct {
	value *GetCopytradingPublicWeeklyPnlV5Resp
	isSet bool
}

func (v NullableGetCopytradingPublicWeeklyPnlV5Resp) Get() *GetCopytradingPublicWeeklyPnlV5Resp {
	return v.value
}

func (v *NullableGetCopytradingPublicWeeklyPnlV5Resp) Set(val *GetCopytradingPublicWeeklyPnlV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCopytradingPublicWeeklyPnlV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCopytradingPublicWeeklyPnlV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCopytradingPublicWeeklyPnlV5Resp(val *GetCopytradingPublicWeeklyPnlV5Resp) *NullableGetCopytradingPublicWeeklyPnlV5Resp {
	return &NullableGetCopytradingPublicWeeklyPnlV5Resp{value: val, isSet: true}
}

func (v NullableGetCopytradingPublicWeeklyPnlV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCopytradingPublicWeeklyPnlV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
