...
// checks if the CreateFinanceStakingDefiSolRedeemV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFinanceStakingDefiSolRedeemV5Resp{}
...
func NewCreateFinanceStakingDefiSolRedeemV5Resp() *CreateFinanceStakingDefiSolRedeemV5Resp {
	this := CreateFinanceStakingDefiSolRedeemV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateFinanceStakingDefiSolRedeemV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateFinanceStakingDefiSolRedeemV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateFinanceStakingDefiSolRedeemV5Resp struct {
	value *CreateFinanceStakingDefiSolRedeemV5Resp
	isSet bool
}

func (v NullableCreateFinanceStakingDefiSolRedeemV5Resp) Get() *CreateFinanceStakingDefiSolRedeemV5Resp {
	return v.value
}

func (v *NullableCreateFinanceStakingDefiSolRedeemV5Resp) Set(val *CreateFinanceStakingDefiSolRedeemV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFinanceStakingDefiSolRedeemV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFinanceStakingDefiSolRedeemV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFinanceStakingDefiSolRedeemV5Resp(val *CreateFinanceStakingDefiSolRedeemV5Resp) *NullableCreateFinanceStakingDefiSolRedeemV5Resp {
	return &NullableCreateFinanceStakingDefiSolRedeemV5Resp{value: val, isSet: true}
}

func (v NullableCreateFinanceStakingDefiSolRedeemV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFinanceStakingDefiSolRedeemV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
