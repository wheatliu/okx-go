...
// checks if the CreateTradingBotGridComputeMarginBalanceV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotGridComputeMarginBalanceV5Resp{}
...
func NewCreateTradingBotGridComputeMarginBalanceV5Resp() *CreateTradingBotGridComputeMarginBalanceV5Resp {
	this := CreateTradingBotGridComputeMarginBalanceV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateTradingBotGridComputeMarginBalanceV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotGridComputeMarginBalanceV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotGridComputeMarginBalanceV5Resp struct {
	value *CreateTradingBotGridComputeMarginBalanceV5Resp
	isSet bool
}

func (v NullableCreateTradingBotGridComputeMarginBalanceV5Resp) Get() *CreateTradingBotGridComputeMarginBalanceV5Resp {
	return v.value
}

func (v *NullableCreateTradingBotGridComputeMarginBalanceV5Resp) Set(val *CreateTradingBotGridComputeMarginBalanceV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotGridComputeMarginBalanceV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotGridComputeMarginBalanceV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotGridComputeMarginBalanceV5Resp(val *CreateTradingBotGridComputeMarginBalanceV5Resp) *NullableCreateTradingBotGridComputeMarginBalanceV5Resp {
	return &NullableCreateTradingBotGridComputeMarginBalanceV5Resp{value: val, isSet: true}
}

func (v NullableCreateTradingBotGridComputeMarginBalanceV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotGridComputeMarginBalanceV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
