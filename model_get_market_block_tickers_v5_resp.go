...
// checks if the GetMarketBlockTickersV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarketBlockTickersV5Resp{}

// GetMarketBlockTickersV5Resp struct for GetMarketBlockTickersV5Resp
type GetMarketBlockTickersV5Resp struct {
...
func NewGetMarketBlockTickersV5Resp() *GetMarketBlockTickersV5Resp {
	this := GetMarketBlockTickersV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetMarketBlockTickersV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetMarketBlockTickersV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarketBlockTickersV5Resp struct {
	value *GetMarketBlockTickersV5Resp
	isSet bool
}

func (v NullableGetMarketBlockTickersV5Resp) Get() *GetMarketBlockTickersV5Resp {
	return v.value
}

func (v *NullableGetMarketBlockTickersV5Resp) Set(val *GetMarketBlockTickersV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarketBlockTickersV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarketBlockTickersV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarketBlockTickersV5Resp(val *GetMarketBlockTickersV5Resp) *NullableGetMarketBlockTickersV5Resp {
	return &NullableGetMarketBlockTickersV5Resp{value: val, isSet: true}
}

func (v NullableGetMarketBlockTickersV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarketBlockTickersV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
