...
// checks if the GetAccountBalanceV5RespDataDetailsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountBalanceV5RespDataDetailsInner{}

// GetAccountBalanceV5RespDataDetailsInner struct for GetAccountBalanceV5RespDataDetailsInner
type GetAccountBalanceV5RespDataDetailsInner struct {
...
func NewGetAccountBalanceV5RespDataDetailsInner() *GetAccountBalanceV5RespDataDetailsInner {
	this := GetAccountBalanceV5RespDataDetailsInner{}
	var accAvgPx string = ""
...
func (o GetAccountBalanceV5RespDataDetailsInner) MarshalJSON() ([]byte, error) {
...
func (o GetAccountBalanceV5RespDataDetailsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountBalanceV5RespDataDetailsInner struct {
	value *GetAccountBalanceV5RespDataDetailsInner
	isSet bool
}

func (v NullableGetAccountBalanceV5RespDataDetailsInner) Get() *GetAccountBalanceV5RespDataDetailsInner {
	return v.value
}

func (v *NullableGetAccountBalanceV5RespDataDetailsInner) Set(val *GetAccountBalanceV5RespDataDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountBalanceV5RespDataDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountBalanceV5RespDataDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountBalanceV5RespDataDetailsInner(val *GetAccountBalanceV5RespDataDetailsInner) *NullableGetAccountBalanceV5RespDataDetailsInner {
	return &NullableGetAccountBalanceV5RespDataDetailsInner{value: val, isSet: true}
}

func (v NullableGetAccountBalanceV5RespDataDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountBalanceV5RespDataDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
