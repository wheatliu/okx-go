...
// checks if the GetTradingBotSignalSignalsV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotSignalSignalsV5Resp{}
...
func NewGetTradingBotSignalSignalsV5Resp() *GetTradingBotSignalSignalsV5Resp {
	this := GetTradingBotSignalSignalsV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetTradingBotSignalSignalsV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotSignalSignalsV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotSignalSignalsV5Resp struct {
	value *GetTradingBotSignalSignalsV5Resp
	isSet bool
}

func (v NullableGetTradingBotSignalSignalsV5Resp) Get() *GetTradingBotSignalSignalsV5Resp {
	return v.value
}

func (v *NullableGetTradingBotSignalSignalsV5Resp) Set(val *GetTradingBotSignalSignalsV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotSignalSignalsV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotSignalSignalsV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotSignalSignalsV5Resp(val *GetTradingBotSignalSignalsV5Resp) *NullableGetTradingBotSignalSignalsV5Resp {
	return &NullableGetTradingBotSignalSignalsV5Resp{value: val, isSet: true}
}

func (v NullableGetTradingBotSignalSignalsV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotSignalSignalsV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
