...
// checks if the GetTradeFillsHistoryV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeFillsHistoryV5RespDataInner{}

// GetTradeFillsHistoryV5RespDataInner struct for GetTradeFillsHistoryV5RespDataInner
type GetTradeFillsHistoryV5RespDataInner struct {
	// Bill ID
...
func NewGetTradeFillsHistoryV5RespDataInner() *GetTradeFillsHistoryV5RespDataInner {
	this := GetTradeFillsHistoryV5RespDataInner{}
	var billId string = ""
	this.BillId = &billId
	var clOrdId string = ""
...
func (o GetTradeFillsHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradeFillsHistoryV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeFillsHistoryV5RespDataInner struct {
	value *GetTradeFillsHistoryV5RespDataInner
	isSet bool
}

func (v NullableGetTradeFillsHistoryV5RespDataInner) Get() *GetTradeFillsHistoryV5RespDataInner {
	return v.value
}

func (v *NullableGetTradeFillsHistoryV5RespDataInner) Set(val *GetTradeFillsHistoryV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeFillsHistoryV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeFillsHistoryV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeFillsHistoryV5RespDataInner(val *GetTradeFillsHistoryV5RespDataInner) *NullableGetTradeFillsHistoryV5RespDataInner {
	return &NullableGetTradeFillsHistoryV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradeFillsHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeFillsHistoryV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
