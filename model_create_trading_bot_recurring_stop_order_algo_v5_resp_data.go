...
// checks if the CreateTradingBotRecurringStopOrderAlgoV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotRecurringStopOrderAlgoV5RespData{}

// CreateTradingBotRecurringStopOrderAlgoV5RespData struct for CreateTradingBotRecurringStopOrderAlgoV5RespData
type CreateTradingBotRecurringStopOrderAlgoV5RespData struct {
...
func NewCreateTradingBotRecurringStopOrderAlgoV5RespData() *CreateTradingBotRecurringStopOrderAlgoV5RespData {
	this := CreateTradingBotRecurringStopOrderAlgoV5RespData{}
...
func (o CreateTradingBotRecurringStopOrderAlgoV5RespData) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotRecurringStopOrderAlgoV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotRecurringStopOrderAlgoV5RespData struct {
	value *CreateTradingBotRecurringStopOrderAlgoV5RespData
	isSet bool
}

func (v NullableCreateTradingBotRecurringStopOrderAlgoV5RespData) Get() *CreateTradingBotRecurringStopOrderAlgoV5RespData {
	return v.value
}

func (v *NullableCreateTradingBotRecurringStopOrderAlgoV5RespData) Set(val *CreateTradingBotRecurringStopOrderAlgoV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotRecurringStopOrderAlgoV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotRecurringStopOrderAlgoV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotRecurringStopOrderAlgoV5RespData(val *CreateTradingBotRecurringStopOrderAlgoV5RespData) *NullableCreateTradingBotRecurringStopOrderAlgoV5RespData {
	return &NullableCreateTradingBotRecurringStopOrderAlgoV5RespData{value: val, isSet: true}
}

func (v NullableCreateTradingBotRecurringStopOrderAlgoV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotRecurringStopOrderAlgoV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
