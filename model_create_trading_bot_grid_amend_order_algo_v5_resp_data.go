...
// checks if the CreateTradingBotGridAmendOrderAlgoV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotGridAmendOrderAlgoV5RespData{}

// CreateTradingBotGridAmendOrderAlgoV5RespData struct for CreateTradingBotGridAmendOrderAlgoV5RespData
type CreateTradingBotGridAmendOrderAlgoV5RespData struct {
...
func NewCreateTradingBotGridAmendOrderAlgoV5RespData() *CreateTradingBotGridAmendOrderAlgoV5RespData {
	this := CreateTradingBotGridAmendOrderAlgoV5RespData{}
...
func (o CreateTradingBotGridAmendOrderAlgoV5RespData) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotGridAmendOrderAlgoV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotGridAmendOrderAlgoV5RespData struct {
	value *CreateTradingBotGridAmendOrderAlgoV5RespData
	isSet bool
}

func (v NullableCreateTradingBotGridAmendOrderAlgoV5RespData) Get() *CreateTradingBotGridAmendOrderAlgoV5RespData {
	return v.value
}

func (v *NullableCreateTradingBotGridAmendOrderAlgoV5RespData) Set(val *CreateTradingBotGridAmendOrderAlgoV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotGridAmendOrderAlgoV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotGridAmendOrderAlgoV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotGridAmendOrderAlgoV5RespData(val *CreateTradingBotGridAmendOrderAlgoV5RespData) *NullableCreateTradingBotGridAmendOrderAlgoV5RespData {
	return &NullableCreateTradingBotGridAmendOrderAlgoV5RespData{value: val, isSet: true}
}

func (v NullableCreateTradingBotGridAmendOrderAlgoV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotGridAmendOrderAlgoV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
