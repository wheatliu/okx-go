...
// checks if the GetPublicEconomicCalendarV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicEconomicCalendarV5Resp{}
...
func NewGetPublicEconomicCalendarV5Resp() *GetPublicEconomicCalendarV5Resp {
	this := GetPublicEconomicCalendarV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetPublicEconomicCalendarV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetPublicEconomicCalendarV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicEconomicCalendarV5Resp struct {
	value *GetPublicEconomicCalendarV5Resp
	isSet bool
}

func (v NullableGetPublicEconomicCalendarV5Resp) Get() *GetPublicEconomicCalendarV5Resp {
	return v.value
}

func (v *NullableGetPublicEconomicCalendarV5Resp) Set(val *GetPublicEconomicCalendarV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicEconomicCalendarV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicEconomicCalendarV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicEconomicCalendarV5Resp(val *GetPublicEconomicCalendarV5Resp) *NullableGetPublicEconomicCalendarV5Resp {
	return &NullableGetPublicEconomicCalendarV5Resp{value: val, isSet: true}
}

func (v NullableGetPublicEconomicCalendarV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicEconomicCalendarV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
