...
// checks if the GetTradingBotGridOrdersAlgoHistoryV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotGridOrdersAlgoHistoryV5RespDataInner{}

// GetTradingBotGridOrdersAlgoHistoryV5RespDataInner struct for GetTradingBotGridOrdersAlgoHistoryV5RespDataInner
type GetTradingBotGridOrdersAlgoHistoryV5RespDataInner struct {
...
func NewGetTradingBotGridOrdersAlgoHistoryV5RespDataInner() *GetTradingBotGridOrdersAlgoHistoryV5RespDataInner {
	this := GetTradingBotGridOrdersAlgoHistoryV5RespDataInner{}
...
func (o GetTradingBotGridOrdersAlgoHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotGridOrdersAlgoHistoryV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner struct {
	value *GetTradingBotGridOrdersAlgoHistoryV5RespDataInner
	isSet bool
}

func (v NullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner) Get() *GetTradingBotGridOrdersAlgoHistoryV5RespDataInner {
	return v.value
}

func (v *NullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner) Set(val *GetTradingBotGridOrdersAlgoHistoryV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner(val *GetTradingBotGridOrdersAlgoHistoryV5RespDataInner) *NullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner {
	return &NullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotGridOrdersAlgoHistoryV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
