...
// checks if the CreateTradeAmendAlgosV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradeAmendAlgosV5RespData{}

// CreateTradeAmendAlgosV5RespData struct for CreateTradeAmendAlgosV5RespData
type CreateTradeAmendAlgosV5RespData struct {
...
func NewCreateTradeAmendAlgosV5RespData() *CreateTradeAmendAlgosV5RespData {
	this := CreateTradeAmendAlgosV5RespData{}
...
func (o CreateTradeAmendAlgosV5RespData) MarshalJSON() ([]byte, error) {
...
func (o CreateTradeAmendAlgosV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradeAmendAlgosV5RespData struct {
	value *CreateTradeAmendAlgosV5RespData
	isSet bool
}

func (v NullableCreateTradeAmendAlgosV5RespData) Get() *CreateTradeAmendAlgosV5RespData {
	return v.value
}

func (v *NullableCreateTradeAmendAlgosV5RespData) Set(val *CreateTradeAmendAlgosV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradeAmendAlgosV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradeAmendAlgosV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradeAmendAlgosV5RespData(val *CreateTradeAmendAlgosV5RespData) *NullableCreateTradeAmendAlgosV5RespData {
	return &NullableCreateTradeAmendAlgosV5RespData{value: val, isSet: true}
}

func (v NullableCreateTradeAmendAlgosV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradeAmendAlgosV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
