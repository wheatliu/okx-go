...
// checks if the GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner{}

// GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner struct for GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner
type GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner struct {
...
func NewGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner() *GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner {
	this := GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner{}
...
func (o GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner struct {
	value *GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner
	isSet bool
}

func (v NullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) Get() *GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner {
	return v.value
}

func (v *NullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) Set(val *GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner(val *GetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) *NullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner {
	return &NullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner{value: val, isSet: true}
}

func (v NullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRfqMakerInstrumentSettingsV5RespDataInnerDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
