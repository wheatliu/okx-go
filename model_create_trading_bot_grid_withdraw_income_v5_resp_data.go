...
// checks if the CreateTradingBotGridWithdrawIncomeV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotGridWithdrawIncomeV5RespData{}

// CreateTradingBotGridWithdrawIncomeV5RespData struct for CreateTradingBotGridWithdrawIncomeV5RespData
type CreateTradingBotGridWithdrawIncomeV5RespData struct {
...
func NewCreateTradingBotGridWithdrawIncomeV5RespData() *CreateTradingBotGridWithdrawIncomeV5RespData {
	this := CreateTradingBotGridWithdrawIncomeV5RespData{}
...
func (o CreateTradingBotGridWithdrawIncomeV5RespData) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotGridWithdrawIncomeV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotGridWithdrawIncomeV5RespData struct {
	value *CreateTradingBotGridWithdrawIncomeV5RespData
	isSet bool
}

func (v NullableCreateTradingBotGridWithdrawIncomeV5RespData) Get() *CreateTradingBotGridWithdrawIncomeV5RespData {
	return v.value
}

func (v *NullableCreateTradingBotGridWithdrawIncomeV5RespData) Set(val *CreateTradingBotGridWithdrawIncomeV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotGridWithdrawIncomeV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotGridWithdrawIncomeV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotGridWithdrawIncomeV5RespData(val *CreateTradingBotGridWithdrawIncomeV5RespData) *NullableCreateTradingBotGridWithdrawIncomeV5RespData {
	return &NullableCreateTradingBotGridWithdrawIncomeV5RespData{value: val, isSet: true}
}

func (v NullableCreateTradingBotGridWithdrawIncomeV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotGridWithdrawIncomeV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
