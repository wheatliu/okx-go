...
// checks if the GetTradingBotRecurringOrdersAlgoPendingV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotRecurringOrdersAlgoPendingV5RespData{}

// GetTradingBotRecurringOrdersAlgoPendingV5RespData struct for GetTradingBotRecurringOrdersAlgoPendingV5RespData
type GetTradingBotRecurringOrdersAlgoPendingV5RespData struct {
...
func NewGetTradingBotRecurringOrdersAlgoPendingV5RespData() *GetTradingBotRecurringOrdersAlgoPendingV5RespData {
	this := GetTradingBotRecurringOrdersAlgoPendingV5RespData{}
...
func (o GetTradingBotRecurringOrdersAlgoPendingV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotRecurringOrdersAlgoPendingV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotRecurringOrdersAlgoPendingV5RespData struct {
	value *GetTradingBotRecurringOrdersAlgoPendingV5RespData
	isSet bool
}

func (v NullableGetTradingBotRecurringOrdersAlgoPendingV5RespData) Get() *GetTradingBotRecurringOrdersAlgoPendingV5RespData {
	return v.value
}

func (v *NullableGetTradingBotRecurringOrdersAlgoPendingV5RespData) Set(val *GetTradingBotRecurringOrdersAlgoPendingV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotRecurringOrdersAlgoPendingV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotRecurringOrdersAlgoPendingV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotRecurringOrdersAlgoPendingV5RespData(val *GetTradingBotRecurringOrdersAlgoPendingV5RespData) *NullableGetTradingBotRecurringOrdersAlgoPendingV5RespData {
	return &NullableGetTradingBotRecurringOrdersAlgoPendingV5RespData{value: val, isSet: true}
}

func (v NullableGetTradingBotRecurringOrdersAlgoPendingV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotRecurringOrdersAlgoPendingV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
