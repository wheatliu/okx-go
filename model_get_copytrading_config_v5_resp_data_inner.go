...
// checks if the GetCopytradingConfigV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCopytradingConfigV5RespDataInner{}

// GetCopytradingConfigV5RespDataInner struct for GetCopytradingConfigV5RespDataInner
type GetCopytradingConfigV5RespDataInner struct {
	// Details
	Details []GetCopytradingConfigV5RespDataInnerDetailsInner `json:"details,omitempty"`
	// Nickname
...
func NewGetCopytradingConfigV5RespDataInner() *GetCopytradingConfigV5RespDataInner {
	this := GetCopytradingConfigV5RespDataInner{}
	var nickName string = ""
...
func (o *GetCopytradingConfigV5RespDataInner) GetDetails() []GetCopytradingConfigV5RespDataInnerDetailsInner {
	if o == nil || IsNil(o.Details) {
		var ret []GetCopytradingConfigV5RespDataInnerDetailsInner
		return ret
	}
	return o.Details
}
...
// SetDetails gets a reference to the given []GetCopytradingConfigV5RespDataInnerDetailsInner and assigns it to the Details field.
...
func (o GetCopytradingConfigV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetCopytradingConfigV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetCopytradingConfigV5RespDataInner struct {
	value *GetCopytradingConfigV5RespDataInner
	isSet bool
}

func (v NullableGetCopytradingConfigV5RespDataInner) Get() *GetCopytradingConfigV5RespDataInner {
	return v.value
}

func (v *NullableGetCopytradingConfigV5RespDataInner) Set(val *GetCopytradingConfigV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCopytradingConfigV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCopytradingConfigV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCopytradingConfigV5RespDataInner(val *GetCopytradingConfigV5RespDataInner) *NullableGetCopytradingConfigV5RespDataInner {
	return &NullableGetCopytradingConfigV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetCopytradingConfigV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCopytradingConfigV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
