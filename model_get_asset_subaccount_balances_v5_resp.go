...
// checks if the GetAssetSubaccountBalancesV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAssetSubaccountBalancesV5Resp{}

// GetAssetSubaccountBalancesV5Resp struct for GetAssetSubaccountBalancesV5Resp
type GetAssetSubaccountBalancesV5Resp struct {
...
func NewGetAssetSubaccountBalancesV5Resp() *GetAssetSubaccountBalancesV5Resp {
	this := GetAssetSubaccountBalancesV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetAssetSubaccountBalancesV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetAssetSubaccountBalancesV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetAssetSubaccountBalancesV5Resp struct {
	value *GetAssetSubaccountBalancesV5Resp
	isSet bool
}

func (v NullableGetAssetSubaccountBalancesV5Resp) Get() *GetAssetSubaccountBalancesV5Resp {
	return v.value
}

func (v *NullableGetAssetSubaccountBalancesV5Resp) Set(val *GetAssetSubaccountBalancesV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetSubaccountBalancesV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetSubaccountBalancesV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetSubaccountBalancesV5Resp(val *GetAssetSubaccountBalancesV5Resp) *NullableGetAssetSubaccountBalancesV5Resp {
	return &NullableGetAssetSubaccountBalancesV5Resp{value: val, isSet: true}
}

func (v NullableGetAssetSubaccountBalancesV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetSubaccountBalancesV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
