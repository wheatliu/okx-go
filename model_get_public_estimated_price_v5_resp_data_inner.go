...
// checks if the GetPublicEstimatedPriceV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicEstimatedPriceV5RespDataInner{}

// GetPublicEstimatedPriceV5RespDataInner struct for GetPublicEstimatedPriceV5RespDataInner
type GetPublicEstimatedPriceV5RespDataInner struct {
...
func NewGetPublicEstimatedPriceV5RespDataInner() *GetPublicEstimatedPriceV5RespDataInner {
	this := GetPublicEstimatedPriceV5RespDataInner{}
	var instId string = ""
	this.InstId = &instId
	var instType string = ""
...
func (o GetPublicEstimatedPriceV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetPublicEstimatedPriceV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicEstimatedPriceV5RespDataInner struct {
	value *GetPublicEstimatedPriceV5RespDataInner
	isSet bool
}

func (v NullableGetPublicEstimatedPriceV5RespDataInner) Get() *GetPublicEstimatedPriceV5RespDataInner {
	return v.value
}

func (v *NullableGetPublicEstimatedPriceV5RespDataInner) Set(val *GetPublicEstimatedPriceV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicEstimatedPriceV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicEstimatedPriceV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicEstimatedPriceV5RespDataInner(val *GetPublicEstimatedPriceV5RespDataInner) *NullableGetPublicEstimatedPriceV5RespDataInner {
	return &NullableGetPublicEstimatedPriceV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetPublicEstimatedPriceV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicEstimatedPriceV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
