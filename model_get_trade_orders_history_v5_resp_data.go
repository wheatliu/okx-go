...
// checks if the GetTradeOrdersHistoryV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrdersHistoryV5RespData{}

// GetTradeOrdersHistoryV5RespData struct for GetTradeOrdersHistoryV5RespData
type GetTradeOrdersHistoryV5RespData struct {
...
func NewGetTradeOrdersHistoryV5RespData() *GetTradeOrdersHistoryV5RespData {
	this := GetTradeOrdersHistoryV5RespData{}
...
func (o GetTradeOrdersHistoryV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrdersHistoryV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrdersHistoryV5RespData struct {
	value *GetTradeOrdersHistoryV5RespData
	isSet bool
}

func (v NullableGetTradeOrdersHistoryV5RespData) Get() *GetTradeOrdersHistoryV5RespData {
	return v.value
}

func (v *NullableGetTradeOrdersHistoryV5RespData) Set(val *GetTradeOrdersHistoryV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrdersHistoryV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrdersHistoryV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrdersHistoryV5RespData(val *GetTradeOrdersHistoryV5RespData) *NullableGetTradeOrdersHistoryV5RespData {
	return &NullableGetTradeOrdersHistoryV5RespData{value: val, isSet: true}
}

func (v NullableGetTradeOrdersHistoryV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrdersHistoryV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
