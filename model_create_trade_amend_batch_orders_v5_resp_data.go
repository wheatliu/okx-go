...
// checks if the CreateTradeAmendBatchOrdersV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradeAmendBatchOrdersV5RespData{}

// CreateTradeAmendBatchOrdersV5RespData struct for CreateTradeAmendBatchOrdersV5RespData
type CreateTradeAmendBatchOrdersV5RespData struct {
	// The result code, `0` means success
	Code *string `json:"code,omitempty"`
	// Array of objects contains the response results
	Data []CreateTradeAmendBatchOrdersV5RespDataDataInner `json:"data,omitempty"`
...
func NewCreateTradeAmendBatchOrdersV5RespData() *CreateTradeAmendBatchOrdersV5RespData {
	this := CreateTradeAmendBatchOrdersV5RespData{}
	var code string = ""
	this.Code = &code
	var inTime string = ""
	this.InTime = &inTime
...
func (o *CreateTradeAmendBatchOrdersV5RespData) GetData() []CreateTradeAmendBatchOrdersV5RespDataDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []CreateTradeAmendBatchOrdersV5RespDataDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []CreateTradeAmendBatchOrdersV5RespDataDataInner and assigns it to the Data field.
...
func (o CreateTradeAmendBatchOrdersV5RespData) MarshalJSON() ([]byte, error) {
...
func (o CreateTradeAmendBatchOrdersV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradeAmendBatchOrdersV5RespData struct {
	value *CreateTradeAmendBatchOrdersV5RespData
	isSet bool
}

func (v NullableCreateTradeAmendBatchOrdersV5RespData) Get() *CreateTradeAmendBatchOrdersV5RespData {
	return v.value
}

func (v *NullableCreateTradeAmendBatchOrdersV5RespData) Set(val *CreateTradeAmendBatchOrdersV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradeAmendBatchOrdersV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradeAmendBatchOrdersV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradeAmendBatchOrdersV5RespData(val *CreateTradeAmendBatchOrdersV5RespData) *NullableCreateTradeAmendBatchOrdersV5RespData {
	return &NullableCreateTradeAmendBatchOrdersV5RespData{value: val, isSet: true}
}

func (v NullableCreateTradeAmendBatchOrdersV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradeAmendBatchOrdersV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
