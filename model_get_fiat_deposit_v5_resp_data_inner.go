...
// checks if the GetFiatDepositV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFiatDepositV5RespDataInner{}

// GetFiatDepositV5RespDataInner struct for GetFiatDepositV5RespDataInner
type GetFiatDepositV5RespDataInner struct {
...
func NewGetFiatDepositV5RespDataInner() *GetFiatDepositV5RespDataInner {
	this := GetFiatDepositV5RespDataInner{}
	var amt string = ""
	this.Amt = &amt
	var cTime string = ""
	this.CTime = &cTime
...
func (o GetFiatDepositV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetFiatDepositV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetFiatDepositV5RespDataInner struct {
	value *GetFiatDepositV5RespDataInner
	isSet bool
}

func (v NullableGetFiatDepositV5RespDataInner) Get() *GetFiatDepositV5RespDataInner {
	return v.value
}

func (v *NullableGetFiatDepositV5RespDataInner) Set(val *GetFiatDepositV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFiatDepositV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFiatDepositV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFiatDepositV5RespDataInner(val *GetFiatDepositV5RespDataInner) *NullableGetFiatDepositV5RespDataInner {
	return &NullableGetFiatDepositV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetFiatDepositV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFiatDepositV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
