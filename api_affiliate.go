...
/*
GetAffiliateInviteeDetailV5 Get the invitee's detail
...
type ApiGetSupportAnnouncementTypesV5Request struct {
	ctx context.Context
	ApiService *AffiliateAPIService
	apiKey *string
}
...
func (r ApiGetSupportAnnouncementTypesV5Request) ApiKey(apiKey string) ApiGetSupportAnnouncementTypesV5Request {
	r.apiKey = &apiKey
	return r
}

func (r ApiGetSupportAnnouncementTypesV5Request) Execute() (*GetSupportAnnouncementTypesV5Resp, *http.Response, error) {
	return r.ApiService.GetSupportAnnouncementTypesV5Execute(r)
}

/*
GetSupportAnnouncementTypesV5 Get the user's affiliate rebate information
...
#### Permission: Read 
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSupportAnnouncementTypesV5Request
*/
func (a *AffiliateAPIService) GetSupportAnnouncementTypesV5(ctx context.Context) ApiGetSupportAnnouncementTypesV5Request {
	return ApiGetSupportAnnouncementTypesV5Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetSupportAnnouncementTypesV5Resp
func (a *AffiliateAPIService) GetSupportAnnouncementTypesV5Execute(r ApiGetSupportAnnouncementTypesV5Request) (*GetSupportAnnouncementTypesV5Resp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSupportAnnouncementTypesV5Resp
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AffiliateAPIService.GetSupportAnnouncementTypesV5")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v5/support/announcement-types"
...
/*
GetUsersPartnerIfRebateV5 Get the user's affiliate rebate information
