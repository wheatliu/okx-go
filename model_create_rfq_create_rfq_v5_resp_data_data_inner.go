...
// checks if the CreateRfqCreateRfqV5RespDataDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqCreateRfqV5RespDataDataInner{}

// CreateRfqCreateRfqV5RespDataDataInner struct for CreateRfqCreateRfqV5RespDataDataInner
type CreateRfqCreateRfqV5RespDataDataInner struct {
	...
	Legs []CreateRfqCreateRfqV5RespDataDataInnerLegsInner `json:"legs,omitempty"`
...
func NewCreateRfqCreateRfqV5RespDataDataInner() *CreateRfqCreateRfqV5RespDataDataInner {
	this := CreateRfqCreateRfqV5RespDataDataInner{}
	var cTime string = ""
	this.CTime = &cTime
	var ccy string = ""
	this.Ccy = &ccy
...
func (o *CreateRfqCreateRfqV5RespDataDataInner) GetLegs() []CreateRfqCreateRfqV5RespDataDataInnerLegsInner {
	if o == nil || IsNil(o.Legs) {
		var ret []CreateRfqCreateRfqV5RespDataDataInnerLegsInner
		return ret
	}
	return o.Legs
}
...
// SetLegs gets a reference to the given []CreateRfqCreateRfqV5RespDataDataInnerLegsInner and assigns it to the Legs field.
...
func (o CreateRfqCreateRfqV5RespDataDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqCreateRfqV5RespDataDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqCreateRfqV5RespDataDataInner struct {
	value *CreateRfqCreateRfqV5RespDataDataInner
	isSet bool
}

func (v NullableCreateRfqCreateRfqV5RespDataDataInner) Get() *CreateRfqCreateRfqV5RespDataDataInner {
	return v.value
}

func (v *NullableCreateRfqCreateRfqV5RespDataDataInner) Set(val *CreateRfqCreateRfqV5RespDataDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqCreateRfqV5RespDataDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqCreateRfqV5RespDataDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqCreateRfqV5RespDataDataInner(val *CreateRfqCreateRfqV5RespDataDataInner) *NullableCreateRfqCreateRfqV5RespDataDataInner {
	return &NullableCreateRfqCreateRfqV5RespDataDataInner{value: val, isSet: true}
}

func (v NullableCreateRfqCreateRfqV5RespDataDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqCreateRfqV5RespDataDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
