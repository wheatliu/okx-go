...
// checks if the GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner{}

// GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner struct for GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner
type GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner struct {
...
func NewGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner() *GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner {
	this := GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner{}
...
func (o GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner struct {
	value *GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner
	isSet bool
}

func (v NullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) Get() *GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner {
	return v.value
}

func (v *NullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) Set(val *GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner(val *GetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) *NullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner {
	return &NullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotSignalOrdersAlgoHistoryV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
