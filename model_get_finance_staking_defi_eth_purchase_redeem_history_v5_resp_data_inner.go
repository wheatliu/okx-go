...
// checks if the GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner{}

// GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner struct for GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner
type GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner struct {
...
func NewGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner() *GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner {
	this := GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner{}
	var amt string = ""
	this.Amt = &amt
...
func (o GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner struct {
	value *GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner
	isSet bool
}

func (v NullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) Get() *GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner {
	return v.value
}

func (v *NullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) Set(val *GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner(val *GetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) *NullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner {
	return &NullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFinanceStakingDefiEthPurchaseRedeemHistoryV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
