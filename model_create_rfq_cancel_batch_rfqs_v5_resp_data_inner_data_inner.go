...
// checks if the CreateRfqCancelBatchRfqsV5RespDataInnerDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqCancelBatchRfqsV5RespDataInnerDataInner{}

// CreateRfqCancelBatchRfqsV5RespDataInnerDataInner struct for CreateRfqCancelBatchRfqsV5RespDataInnerDataInner
type CreateRfqCancelBatchRfqsV5RespDataInnerDataInner struct {
...
func NewCreateRfqCancelBatchRfqsV5RespDataInnerDataInner() *CreateRfqCancelBatchRfqsV5RespDataInnerDataInner {
	this := CreateRfqCancelBatchRfqsV5RespDataInnerDataInner{}
	var clRfqId string = ""
...
func (o CreateRfqCancelBatchRfqsV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqCancelBatchRfqsV5RespDataInnerDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner struct {
	value *CreateRfqCancelBatchRfqsV5RespDataInnerDataInner
	isSet bool
}

func (v NullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner) Get() *CreateRfqCancelBatchRfqsV5RespDataInnerDataInner {
	return v.value
}

func (v *NullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner) Set(val *CreateRfqCancelBatchRfqsV5RespDataInnerDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner(val *CreateRfqCancelBatchRfqsV5RespDataInnerDataInner) *NullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner {
	return &NullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner{value: val, isSet: true}
}

func (v NullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqCancelBatchRfqsV5RespDataInnerDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
