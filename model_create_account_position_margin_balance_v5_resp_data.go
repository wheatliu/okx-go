...
// checks if the CreateAccountPositionMarginBalanceV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAccountPositionMarginBalanceV5RespData{}

// CreateAccountPositionMarginBalanceV5RespData struct for CreateAccountPositionMarginBalanceV5RespData
type CreateAccountPositionMarginBalanceV5RespData struct {
...
func NewCreateAccountPositionMarginBalanceV5RespData() *CreateAccountPositionMarginBalanceV5RespData {
	this := CreateAccountPositionMarginBalanceV5RespData{}
	var amt string = ""
	this.Amt = &amt
	var ccy string = ""
	this.Ccy = &ccy
...
func (o CreateAccountPositionMarginBalanceV5RespData) MarshalJSON() ([]byte, error) {
...
func (o CreateAccountPositionMarginBalanceV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAccountPositionMarginBalanceV5RespData struct {
	value *CreateAccountPositionMarginBalanceV5RespData
	isSet bool
}

func (v NullableCreateAccountPositionMarginBalanceV5RespData) Get() *CreateAccountPositionMarginBalanceV5RespData {
	return v.value
}

func (v *NullableCreateAccountPositionMarginBalanceV5RespData) Set(val *CreateAccountPositionMarginBalanceV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAccountPositionMarginBalanceV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAccountPositionMarginBalanceV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAccountPositionMarginBalanceV5RespData(val *CreateAccountPositionMarginBalanceV5RespData) *NullableCreateAccountPositionMarginBalanceV5RespData {
	return &NullableCreateAccountPositionMarginBalanceV5RespData{value: val, isSet: true}
}

func (v NullableCreateAccountPositionMarginBalanceV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAccountPositionMarginBalanceV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
