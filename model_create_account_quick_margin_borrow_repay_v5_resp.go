...
// checks if the CreateAccountQuickMarginBorrowRepayV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAccountQuickMarginBorrowRepayV5Resp{}
...
func NewCreateAccountQuickMarginBorrowRepayV5Resp() *CreateAccountQuickMarginBorrowRepayV5Resp {
	this := CreateAccountQuickMarginBorrowRepayV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateAccountQuickMarginBorrowRepayV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateAccountQuickMarginBorrowRepayV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAccountQuickMarginBorrowRepayV5Resp struct {
	value *CreateAccountQuickMarginBorrowRepayV5Resp
	isSet bool
}

func (v NullableCreateAccountQuickMarginBorrowRepayV5Resp) Get() *CreateAccountQuickMarginBorrowRepayV5Resp {
	return v.value
}

func (v *NullableCreateAccountQuickMarginBorrowRepayV5Resp) Set(val *CreateAccountQuickMarginBorrowRepayV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAccountQuickMarginBorrowRepayV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAccountQuickMarginBorrowRepayV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAccountQuickMarginBorrowRepayV5Resp(val *CreateAccountQuickMarginBorrowRepayV5Resp) *NullableCreateAccountQuickMarginBorrowRepayV5Resp {
	return &NullableCreateAccountQuickMarginBorrowRepayV5Resp{value: val, isSet: true}
}

func (v NullableCreateAccountQuickMarginBorrowRepayV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAccountQuickMarginBorrowRepayV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
