...
// checks if the GetAccountSubaccountMaxWithdrawalV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountSubaccountMaxWithdrawalV5RespData{}

// GetAccountSubaccountMaxWithdrawalV5RespData struct for GetAccountSubaccountMaxWithdrawalV5RespData
type GetAccountSubaccountMaxWithdrawalV5RespData struct {
	// Currency
...
func NewGetAccountSubaccountMaxWithdrawalV5RespData() *GetAccountSubaccountMaxWithdrawalV5RespData {
	this := GetAccountSubaccountMaxWithdrawalV5RespData{}
	var ccy string = ""
	this.Ccy = &ccy
	var maxWd string = ""
	this.MaxWd = &maxWd
...
func (o GetAccountSubaccountMaxWithdrawalV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetAccountSubaccountMaxWithdrawalV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountSubaccountMaxWithdrawalV5RespData struct {
	value *GetAccountSubaccountMaxWithdrawalV5RespData
	isSet bool
}

func (v NullableGetAccountSubaccountMaxWithdrawalV5RespData) Get() *GetAccountSubaccountMaxWithdrawalV5RespData {
	return v.value
}

func (v *NullableGetAccountSubaccountMaxWithdrawalV5RespData) Set(val *GetAccountSubaccountMaxWithdrawalV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountSubaccountMaxWithdrawalV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountSubaccountMaxWithdrawalV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountSubaccountMaxWithdrawalV5RespData(val *GetAccountSubaccountMaxWithdrawalV5RespData) *NullableGetAccountSubaccountMaxWithdrawalV5RespData {
	return &NullableGetAccountSubaccountMaxWithdrawalV5RespData{value: val, isSet: true}
}

func (v NullableGetAccountSubaccountMaxWithdrawalV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountSubaccountMaxWithdrawalV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
