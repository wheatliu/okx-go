...
// checks if the GetAccountInstrumentsV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountInstrumentsV5RespDataInner{}

// GetAccountInstrumentsV5RespDataInner struct for GetAccountInstrumentsV5RespDataInner
type GetAccountInstrumentsV5RespDataInner struct {
...
func NewGetAccountInstrumentsV5RespDataInner() *GetAccountInstrumentsV5RespDataInner {
	this := GetAccountInstrumentsV5RespDataInner{}
...
func (o GetAccountInstrumentsV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetAccountInstrumentsV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountInstrumentsV5RespDataInner struct {
	value *GetAccountInstrumentsV5RespDataInner
	isSet bool
}

func (v NullableGetAccountInstrumentsV5RespDataInner) Get() *GetAccountInstrumentsV5RespDataInner {
	return v.value
}

func (v *NullableGetAccountInstrumentsV5RespDataInner) Set(val *GetAccountInstrumentsV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountInstrumentsV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountInstrumentsV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountInstrumentsV5RespDataInner(val *GetAccountInstrumentsV5RespDataInner) *NullableGetAccountInstrumentsV5RespDataInner {
	return &NullableGetAccountInstrumentsV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetAccountInstrumentsV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountInstrumentsV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
