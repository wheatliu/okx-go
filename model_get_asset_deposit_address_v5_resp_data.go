...
// checks if the GetAssetDepositAddressV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAssetDepositAddressV5RespData{}

// GetAssetDepositAddressV5RespData struct for GetAssetDepositAddressV5RespData
type GetAssetDepositAddressV5RespData struct {
	// Deposit address
...
func NewGetAssetDepositAddressV5RespData() *GetAssetDepositAddressV5RespData {
	this := GetAssetDepositAddressV5RespData{}
	var addr string = ""
	this.Addr = &addr
	var ccy string = ""
	this.Ccy = &ccy
...
func (o GetAssetDepositAddressV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetAssetDepositAddressV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetAssetDepositAddressV5RespData struct {
	value *GetAssetDepositAddressV5RespData
	isSet bool
}

func (v NullableGetAssetDepositAddressV5RespData) Get() *GetAssetDepositAddressV5RespData {
	return v.value
}

func (v *NullableGetAssetDepositAddressV5RespData) Set(val *GetAssetDepositAddressV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetDepositAddressV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetDepositAddressV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetDepositAddressV5RespData(val *GetAssetDepositAddressV5RespData) *NullableGetAssetDepositAddressV5RespData {
	return &NullableGetAssetDepositAddressV5RespData{value: val, isSet: true}
}

func (v NullableGetAssetDepositAddressV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetDepositAddressV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
