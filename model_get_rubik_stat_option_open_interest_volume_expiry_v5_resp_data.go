...
// checks if the GetRubikStatOptionOpenInterestVolumeExpiryV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRubikStatOptionOpenInterestVolumeExpiryV5RespData{}

// GetRubikStatOptionOpenInterestVolumeExpiryV5RespData struct for GetRubikStatOptionOpenInterestVolumeExpiryV5RespData
type GetRubikStatOptionOpenInterestVolumeExpiryV5RespData struct {
...
func NewGetRubikStatOptionOpenInterestVolumeExpiryV5RespData() *GetRubikStatOptionOpenInterestVolumeExpiryV5RespData {
	this := GetRubikStatOptionOpenInterestVolumeExpiryV5RespData{}
	var callOI string = ""
	this.CallOI = &callOI
	var callVol string = ""
...
func (o GetRubikStatOptionOpenInterestVolumeExpiryV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetRubikStatOptionOpenInterestVolumeExpiryV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData struct {
	value *GetRubikStatOptionOpenInterestVolumeExpiryV5RespData
	isSet bool
}

func (v NullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData) Get() *GetRubikStatOptionOpenInterestVolumeExpiryV5RespData {
	return v.value
}

func (v *NullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData) Set(val *GetRubikStatOptionOpenInterestVolumeExpiryV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData(val *GetRubikStatOptionOpenInterestVolumeExpiryV5RespData) *NullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData {
	return &NullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData{value: val, isSet: true}
}

func (v NullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRubikStatOptionOpenInterestVolumeExpiryV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
