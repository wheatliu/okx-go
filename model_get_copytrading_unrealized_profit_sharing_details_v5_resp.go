...
// checks if the GetCopytradingUnrealizedProfitSharingDetailsV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCopytradingUnrealizedProfitSharingDetailsV5Resp{}
...
func NewGetCopytradingUnrealizedProfitSharingDetailsV5Resp() *GetCopytradingUnrealizedProfitSharingDetailsV5Resp {
	this := GetCopytradingUnrealizedProfitSharingDetailsV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetCopytradingUnrealizedProfitSharingDetailsV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetCopytradingUnrealizedProfitSharingDetailsV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp struct {
	value *GetCopytradingUnrealizedProfitSharingDetailsV5Resp
	isSet bool
}

func (v NullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp) Get() *GetCopytradingUnrealizedProfitSharingDetailsV5Resp {
	return v.value
}

func (v *NullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp) Set(val *GetCopytradingUnrealizedProfitSharingDetailsV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp(val *GetCopytradingUnrealizedProfitSharingDetailsV5Resp) *NullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp {
	return &NullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp{value: val, isSet: true}
}

func (v NullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCopytradingUnrealizedProfitSharingDetailsV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
