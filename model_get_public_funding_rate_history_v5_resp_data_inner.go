...
// checks if the GetPublicFundingRateHistoryV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicFundingRateHistoryV5RespDataInner{}

// GetPublicFundingRateHistoryV5RespDataInner struct for GetPublicFundingRateHistoryV5RespDataInner
type GetPublicFundingRateHistoryV5RespDataInner struct {
...
func NewGetPublicFundingRateHistoryV5RespDataInner() *GetPublicFundingRateHistoryV5RespDataInner {
	this := GetPublicFundingRateHistoryV5RespDataInner{}
...
func (o GetPublicFundingRateHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetPublicFundingRateHistoryV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicFundingRateHistoryV5RespDataInner struct {
	value *GetPublicFundingRateHistoryV5RespDataInner
	isSet bool
}

func (v NullableGetPublicFundingRateHistoryV5RespDataInner) Get() *GetPublicFundingRateHistoryV5RespDataInner {
	return v.value
}

func (v *NullableGetPublicFundingRateHistoryV5RespDataInner) Set(val *GetPublicFundingRateHistoryV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicFundingRateHistoryV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicFundingRateHistoryV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicFundingRateHistoryV5RespDataInner(val *GetPublicFundingRateHistoryV5RespDataInner) *NullableGetPublicFundingRateHistoryV5RespDataInner {
	return &NullableGetPublicFundingRateHistoryV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetPublicFundingRateHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicFundingRateHistoryV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
