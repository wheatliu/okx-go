...
// checks if the CreateAccountPositionBuilderV5RespDataRiskUnitDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAccountPositionBuilderV5RespDataRiskUnitDataInner{}

// CreateAccountPositionBuilderV5RespDataRiskUnitDataInner struct for CreateAccountPositionBuilderV5RespDataRiskUnitDataInner
type CreateAccountPositionBuilderV5RespDataRiskUnitDataInner struct {
	...
	Mr1FinalResult *CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr1FinalResult `json:"mr1FinalResult,omitempty"`
	Mr1Scenarios *CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr1Scenarios `json:"mr1Scenarios,omitempty"`
	...
	Mr6FinalResult *CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr6FinalResult `json:"mr6FinalResult,omitempty"`
	...
	Portfolios []CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerPortfoliosInner `json:"portfolios,omitempty"`
...
func NewCreateAccountPositionBuilderV5RespDataRiskUnitDataInner() *CreateAccountPositionBuilderV5RespDataRiskUnitDataInner {
	this := CreateAccountPositionBuilderV5RespDataRiskUnitDataInner{}
	var amt string = ""
	this.Amt = &amt
	var avgPx string = ""
	this.AvgPx = &avgPx
...
func (o *CreateAccountPositionBuilderV5RespDataRiskUnitDataInner) GetMr1FinalResult() CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr1FinalResult {
	if o == nil || IsNil(o.Mr1FinalResult) {
		var ret CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr1FinalResult
		return ret
	}
...
// SetMr1FinalResult gets a reference to the given CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr1FinalResult and assigns it to the Mr1FinalResult field.
...
func (o *CreateAccountPositionBuilderV5RespDataRiskUnitDataInner) GetMr1Scenarios() CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr1Scenarios {
	if o == nil || IsNil(o.Mr1Scenarios) {
		var ret CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr1Scenarios
		return ret
	}
...
// SetMr1Scenarios gets a reference to the given CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr1Scenarios and assigns it to the Mr1Scenarios field.
...
func (o *CreateAccountPositionBuilderV5RespDataRiskUnitDataInner) GetMr6FinalResult() CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr6FinalResult {
	if o == nil || IsNil(o.Mr6FinalResult) {
		var ret CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr6FinalResult
		return ret
	}
...
// SetMr6FinalResult gets a reference to the given CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerMr6FinalResult and assigns it to the Mr6FinalResult field.
...
func (o *CreateAccountPositionBuilderV5RespDataRiskUnitDataInner) GetPortfolios() []CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerPortfoliosInner {
	if o == nil || IsNil(o.Portfolios) {
		var ret []CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerPortfoliosInner
		return ret
	}
	return o.Portfolios
}
...
// SetPortfolios gets a reference to the given []CreateAccountPositionBuilderV5RespDataRiskUnitDataInnerPortfoliosInner and assigns it to the Portfolios field.
...
func (o CreateAccountPositionBuilderV5RespDataRiskUnitDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateAccountPositionBuilderV5RespDataRiskUnitDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner struct {
	value *CreateAccountPositionBuilderV5RespDataRiskUnitDataInner
	isSet bool
}

func (v NullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner) Get() *CreateAccountPositionBuilderV5RespDataRiskUnitDataInner {
	return v.value
}

func (v *NullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner) Set(val *CreateAccountPositionBuilderV5RespDataRiskUnitDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner(val *CreateAccountPositionBuilderV5RespDataRiskUnitDataInner) *NullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner {
	return &NullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner{value: val, isSet: true}
}

func (v NullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAccountPositionBuilderV5RespDataRiskUnitDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
