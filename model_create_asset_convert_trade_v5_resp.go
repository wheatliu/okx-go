...
// checks if the CreateAssetConvertTradeV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAssetConvertTradeV5Resp{}
...
func NewCreateAssetConvertTradeV5Resp() *CreateAssetConvertTradeV5Resp {
	this := CreateAssetConvertTradeV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateAssetConvertTradeV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateAssetConvertTradeV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAssetConvertTradeV5Resp struct {
	value *CreateAssetConvertTradeV5Resp
	isSet bool
}

func (v NullableCreateAssetConvertTradeV5Resp) Get() *CreateAssetConvertTradeV5Resp {
	return v.value
}

func (v *NullableCreateAssetConvertTradeV5Resp) Set(val *CreateAssetConvertTradeV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAssetConvertTradeV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAssetConvertTradeV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAssetConvertTradeV5Resp(val *CreateAssetConvertTradeV5Resp) *NullableCreateAssetConvertTradeV5Resp {
	return &NullableCreateAssetConvertTradeV5Resp{value: val, isSet: true}
}

func (v NullableCreateAssetConvertTradeV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAssetConvertTradeV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
