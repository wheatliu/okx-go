...
// checks if the GetFiatWithdrawalV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFiatWithdrawalV5RespData{}

// GetFiatWithdrawalV5RespData struct for GetFiatWithdrawalV5RespData
type GetFiatWithdrawalV5RespData struct {
...
func NewGetFiatWithdrawalV5RespData() *GetFiatWithdrawalV5RespData {
	this := GetFiatWithdrawalV5RespData{}
	var amt string = ""
	this.Amt = &amt
	var cTime string = ""
	this.CTime = &cTime
...
func (o GetFiatWithdrawalV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetFiatWithdrawalV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetFiatWithdrawalV5RespData struct {
	value *GetFiatWithdrawalV5RespData
	isSet bool
}

func (v NullableGetFiatWithdrawalV5RespData) Get() *GetFiatWithdrawalV5RespData {
	return v.value
}

func (v *NullableGetFiatWithdrawalV5RespData) Set(val *GetFiatWithdrawalV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFiatWithdrawalV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFiatWithdrawalV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFiatWithdrawalV5RespData(val *GetFiatWithdrawalV5RespData) *NullableGetFiatWithdrawalV5RespData {
	return &NullableGetFiatWithdrawalV5RespData{value: val, isSet: true}
}

func (v NullableGetFiatWithdrawalV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFiatWithdrawalV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
