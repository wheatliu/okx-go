...
// checks if the GetFiatDepositOrderHistoryV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFiatDepositOrderHistoryV5RespData{}

// GetFiatDepositOrderHistoryV5RespData struct for GetFiatDepositOrderHistoryV5RespData
type GetFiatDepositOrderHistoryV5RespData struct {
...
func NewGetFiatDepositOrderHistoryV5RespData() *GetFiatDepositOrderHistoryV5RespData {
	this := GetFiatDepositOrderHistoryV5RespData{}
	var amt string = ""
	this.Amt = &amt
	var cTime string = ""
	this.CTime = &cTime
...
func (o GetFiatDepositOrderHistoryV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetFiatDepositOrderHistoryV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetFiatDepositOrderHistoryV5RespData struct {
	value *GetFiatDepositOrderHistoryV5RespData
	isSet bool
}

func (v NullableGetFiatDepositOrderHistoryV5RespData) Get() *GetFiatDepositOrderHistoryV5RespData {
	return v.value
}

func (v *NullableGetFiatDepositOrderHistoryV5RespData) Set(val *GetFiatDepositOrderHistoryV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFiatDepositOrderHistoryV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFiatDepositOrderHistoryV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFiatDepositOrderHistoryV5RespData(val *GetFiatDepositOrderHistoryV5RespData) *NullableGetFiatDepositOrderHistoryV5RespData {
	return &NullableGetFiatDepositOrderHistoryV5RespData{value: val, isSet: true}
}

func (v NullableGetFiatDepositOrderHistoryV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFiatDepositOrderHistoryV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
