...
// checks if the GetTradeAccountRateLimitV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeAccountRateLimitV5RespData{}

// GetTradeAccountRateLimitV5RespData struct for GetTradeAccountRateLimitV5RespData
type GetTradeAccountRateLimitV5RespData struct {
...
func NewGetTradeAccountRateLimitV5RespData() *GetTradeAccountRateLimitV5RespData {
	this := GetTradeAccountRateLimitV5RespData{}
...
func (o GetTradeAccountRateLimitV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradeAccountRateLimitV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeAccountRateLimitV5RespData struct {
	value *GetTradeAccountRateLimitV5RespData
	isSet bool
}

func (v NullableGetTradeAccountRateLimitV5RespData) Get() *GetTradeAccountRateLimitV5RespData {
	return v.value
}

func (v *NullableGetTradeAccountRateLimitV5RespData) Set(val *GetTradeAccountRateLimitV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeAccountRateLimitV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeAccountRateLimitV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeAccountRateLimitV5RespData(val *GetTradeAccountRateLimitV5RespData) *NullableGetTradeAccountRateLimitV5RespData {
	return &NullableGetTradeAccountRateLimitV5RespData{value: val, isSet: true}
}

func (v NullableGetTradeAccountRateLimitV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeAccountRateLimitV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
