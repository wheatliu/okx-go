...
// checks if the CreateAccountPositionBuilderV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAccountPositionBuilderV5Resp{}
...
func NewCreateAccountPositionBuilderV5Resp() *CreateAccountPositionBuilderV5Resp {
	this := CreateAccountPositionBuilderV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateAccountPositionBuilderV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateAccountPositionBuilderV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAccountPositionBuilderV5Resp struct {
	value *CreateAccountPositionBuilderV5Resp
	isSet bool
}

func (v NullableCreateAccountPositionBuilderV5Resp) Get() *CreateAccountPositionBuilderV5Resp {
	return v.value
}

func (v *NullableCreateAccountPositionBuilderV5Resp) Set(val *CreateAccountPositionBuilderV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAccountPositionBuilderV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAccountPositionBuilderV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAccountPositionBuilderV5Resp(val *CreateAccountPositionBuilderV5Resp) *NullableCreateAccountPositionBuilderV5Resp {
	return &NullableCreateAccountPositionBuilderV5Resp{value: val, isSet: true}
}

func (v NullableCreateAccountPositionBuilderV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAccountPositionBuilderV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
