...
// checks if the GetTradeFillsHistoryV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeFillsHistoryV5Resp{}
...
func NewGetTradeFillsHistoryV5Resp() *GetTradeFillsHistoryV5Resp {
	this := GetTradeFillsHistoryV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetTradeFillsHistoryV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetTradeFillsHistoryV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeFillsHistoryV5Resp struct {
	value *GetTradeFillsHistoryV5Resp
	isSet bool
}

func (v NullableGetTradeFillsHistoryV5Resp) Get() *GetTradeFillsHistoryV5Resp {
	return v.value
}

func (v *NullableGetTradeFillsHistoryV5Resp) Set(val *GetTradeFillsHistoryV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeFillsHistoryV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeFillsHistoryV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeFillsHistoryV5Resp(val *GetTradeFillsHistoryV5Resp) *NullableGetTradeFillsHistoryV5Resp {
	return &NullableGetTradeFillsHistoryV5Resp{value: val, isSet: true}
}

func (v NullableGetTradeFillsHistoryV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeFillsHistoryV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
