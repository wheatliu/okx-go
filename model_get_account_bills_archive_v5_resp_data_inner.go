...
// checks if the GetAccountBillsArchiveV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountBillsArchiveV5RespDataInner{}

// GetAccountBillsArchiveV5RespDataInner struct for GetAccountBillsArchiveV5RespDataInner
type GetAccountBillsArchiveV5RespDataInner struct {
...
func NewGetAccountBillsArchiveV5RespDataInner() *GetAccountBillsArchiveV5RespDataInner {
	this := GetAccountBillsArchiveV5RespDataInner{}
	var bal string = ""
	this.Bal = &bal
	var balChg string = ""
	this.BalChg = &balChg
...
func (o GetAccountBillsArchiveV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetAccountBillsArchiveV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountBillsArchiveV5RespDataInner struct {
	value *GetAccountBillsArchiveV5RespDataInner
	isSet bool
}

func (v NullableGetAccountBillsArchiveV5RespDataInner) Get() *GetAccountBillsArchiveV5RespDataInner {
	return v.value
}

func (v *NullableGetAccountBillsArchiveV5RespDataInner) Set(val *GetAccountBillsArchiveV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountBillsArchiveV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountBillsArchiveV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountBillsArchiveV5RespDataInner(val *GetAccountBillsArchiveV5RespDataInner) *NullableGetAccountBillsArchiveV5RespDataInner {
	return &NullableGetAccountBillsArchiveV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetAccountBillsArchiveV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountBillsArchiveV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
