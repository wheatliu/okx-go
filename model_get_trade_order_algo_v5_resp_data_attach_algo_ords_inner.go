...
// checks if the GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner{}

// GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner struct for GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner
type GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner struct {
...
func NewGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner() *GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner {
	this := GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner{}
...
func (o GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner struct {
	value *GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner
	isSet bool
}

func (v NullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) Get() *GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner {
	return v.value
}

func (v *NullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) Set(val *GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner(val *GetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) *NullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner {
	return &NullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner{value: val, isSet: true}
}

func (v NullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrderAlgoV5RespDataAttachAlgoOrdsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
