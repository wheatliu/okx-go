...
// checks if the CreateRfqExecuteQuoteV5RespDataInnerDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqExecuteQuoteV5RespDataInnerDataInner{}

// CreateRfqExecuteQuoteV5RespDataInnerDataInner struct for CreateRfqExecuteQuoteV5RespDataInnerDataInner
type CreateRfqExecuteQuoteV5RespDataInnerDataInner struct {
	// Block trade ID.
	...
	// Legs of trade
	Legs []CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner `json:"legs,omitempty"`
...
func NewCreateRfqExecuteQuoteV5RespDataInnerDataInner() *CreateRfqExecuteQuoteV5RespDataInnerDataInner {
	this := CreateRfqExecuteQuoteV5RespDataInnerDataInner{}
...
func (o *CreateRfqExecuteQuoteV5RespDataInnerDataInner) GetLegs() []CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner {
	if o == nil || IsNil(o.Legs) {
		var ret []CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner
		return ret
	}
	return o.Legs
}
...
// SetLegs gets a reference to the given []CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner and assigns it to the Legs field.
...
func (o CreateRfqExecuteQuoteV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqExecuteQuoteV5RespDataInnerDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqExecuteQuoteV5RespDataInnerDataInner struct {
	value *CreateRfqExecuteQuoteV5RespDataInnerDataInner
	isSet bool
}

func (v NullableCreateRfqExecuteQuoteV5RespDataInnerDataInner) Get() *CreateRfqExecuteQuoteV5RespDataInnerDataInner {
	return v.value
}

func (v *NullableCreateRfqExecuteQuoteV5RespDataInnerDataInner) Set(val *CreateRfqExecuteQuoteV5RespDataInnerDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqExecuteQuoteV5RespDataInnerDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqExecuteQuoteV5RespDataInnerDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqExecuteQuoteV5RespDataInnerDataInner(val *CreateRfqExecuteQuoteV5RespDataInnerDataInner) *NullableCreateRfqExecuteQuoteV5RespDataInnerDataInner {
	return &NullableCreateRfqExecuteQuoteV5RespDataInnerDataInner{value: val, isSet: true}
}

func (v NullableCreateRfqExecuteQuoteV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqExecuteQuoteV5RespDataInnerDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
