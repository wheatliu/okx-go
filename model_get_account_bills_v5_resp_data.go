...
// checks if the GetAccountBillsV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountBillsV5RespData{}

// GetAccountBillsV5RespData struct for GetAccountBillsV5RespData
type GetAccountBillsV5RespData struct {
...
func NewGetAccountBillsV5RespData() *GetAccountBillsV5RespData {
	this := GetAccountBillsV5RespData{}
	var bal string = ""
	this.Bal = &bal
	var balChg string = ""
	this.BalChg = &balChg
...
func (o *GetAccountBillsV5RespData) HasBal() bool {
	if o != nil && !IsNil(o.Bal) {
		return true
	}
...
func (o *GetAccountBillsV5RespData) HasFillFwdPx() bool {
	if o != nil && !IsNil(o.FillFwdPx) {
		return true
	}
...
func (o *GetAccountBillsV5RespData) HasFrom() bool {
	if o != nil && !IsNil(o.From) {
		return true
	}
...
func (o *GetAccountBillsV5RespData) HasPnl() bool {
	if o != nil && !IsNil(o.Pnl) {
		return true
	}
...
func (o *GetAccountBillsV5RespData) HasTo() bool {
	if o != nil && !IsNil(o.To) {
		return true
	}
...
func (o GetAccountBillsV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetAccountBillsV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountBillsV5RespData struct {
	value *GetAccountBillsV5RespData
	isSet bool
}

func (v NullableGetAccountBillsV5RespData) Get() *GetAccountBillsV5RespData {
	return v.value
}

func (v *NullableGetAccountBillsV5RespData) Set(val *GetAccountBillsV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountBillsV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountBillsV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountBillsV5RespData(val *GetAccountBillsV5RespData) *NullableGetAccountBillsV5RespData {
	return &NullableGetAccountBillsV5RespData{value: val, isSet: true}
}

func (v NullableGetAccountBillsV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountBillsV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
