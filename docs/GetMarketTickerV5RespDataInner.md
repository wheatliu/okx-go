# GetMarketTickerV5RespDataInner
...
### NewGetMarketTickerV5RespDataInner

`func NewGetMarketTickerV5RespDataInner() *GetMarketTickerV5RespDataInner`

NewGetMarketTickerV5RespDataInner instantiates a new GetMarketTickerV5RespDataInner object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewGetMarketTickerV5RespDataInnerWithDefaults

`func NewGetMarketTickerV5RespDataInnerWithDefaults() *GetMarketTickerV5RespDataInner`

NewGetMarketTickerV5RespDataInnerWithDefaults instantiates a new GetMarketTickerV5RespDataInner object
...
`func (o *GetMarketTickerV5RespDataInner) GetBidPxOk() (*string, bool)`
...
`func (o *GetMarketTickerV5RespDataInner) SetHigh24h(v string)`
...
`func (o *GetMarketTickerV5RespDataInner) HasTs() bool`
