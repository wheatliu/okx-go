...
// checks if the CreateTradeCancelAlgosV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradeCancelAlgosV5RespDataInner{}

// CreateTradeCancelAlgosV5RespDataInner struct for CreateTradeCancelAlgosV5RespDataInner
type CreateTradeCancelAlgosV5RespDataInner struct {
...
func NewCreateTradeCancelAlgosV5RespDataInner() *CreateTradeCancelAlgosV5RespDataInner {
	this := CreateTradeCancelAlgosV5RespDataInner{}
...
func (o CreateTradeCancelAlgosV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateTradeCancelAlgosV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradeCancelAlgosV5RespDataInner struct {
	value *CreateTradeCancelAlgosV5RespDataInner
	isSet bool
}

func (v NullableCreateTradeCancelAlgosV5RespDataInner) Get() *CreateTradeCancelAlgosV5RespDataInner {
	return v.value
}

func (v *NullableCreateTradeCancelAlgosV5RespDataInner) Set(val *CreateTradeCancelAlgosV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradeCancelAlgosV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradeCancelAlgosV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradeCancelAlgosV5RespDataInner(val *CreateTradeCancelAlgosV5RespDataInner) *NullableCreateTradeCancelAlgosV5RespDataInner {
	return &NullableCreateTradeCancelAlgosV5RespDataInner{value: val, isSet: true}
}

func (v NullableCreateTradeCancelAlgosV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradeCancelAlgosV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
