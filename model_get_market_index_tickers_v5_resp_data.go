...
// checks if the GetMarketIndexTickersV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarketIndexTickersV5RespData{}

// GetMarketIndexTickersV5RespData struct for GetMarketIndexTickersV5RespData
type GetMarketIndexTickersV5RespData struct {
...
func NewGetMarketIndexTickersV5RespData() *GetMarketIndexTickersV5RespData {
	this := GetMarketIndexTickersV5RespData{}
	var high24h string = ""
...
func (o GetMarketIndexTickersV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetMarketIndexTickersV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarketIndexTickersV5RespData struct {
	value *GetMarketIndexTickersV5RespData
	isSet bool
}

func (v NullableGetMarketIndexTickersV5RespData) Get() *GetMarketIndexTickersV5RespData {
	return v.value
}

func (v *NullableGetMarketIndexTickersV5RespData) Set(val *GetMarketIndexTickersV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarketIndexTickersV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarketIndexTickersV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarketIndexTickersV5RespData(val *GetMarketIndexTickersV5RespData) *NullableGetMarketIndexTickersV5RespData {
	return &NullableGetMarketIndexTickersV5RespData{value: val, isSet: true}
}

func (v NullableGetMarketIndexTickersV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarketIndexTickersV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
