...
// checks if the CreateCopytradingFirstCopySettingsV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCopytradingFirstCopySettingsV5Resp{}

// CreateCopytradingFirstCopySettingsV5Resp struct for CreateCopytradingFirstCopySettingsV5Resp
type CreateCopytradingFirstCopySettingsV5Resp struct {
...
func NewCreateCopytradingFirstCopySettingsV5Resp() *CreateCopytradingFirstCopySettingsV5Resp {
	this := CreateCopytradingFirstCopySettingsV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateCopytradingFirstCopySettingsV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateCopytradingFirstCopySettingsV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCopytradingFirstCopySettingsV5Resp struct {
	value *CreateCopytradingFirstCopySettingsV5Resp
	isSet bool
}

func (v NullableCreateCopytradingFirstCopySettingsV5Resp) Get() *CreateCopytradingFirstCopySettingsV5Resp {
	return v.value
}

func (v *NullableCreateCopytradingFirstCopySettingsV5Resp) Set(val *CreateCopytradingFirstCopySettingsV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCopytradingFirstCopySettingsV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCopytradingFirstCopySettingsV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCopytradingFirstCopySettingsV5Resp(val *CreateCopytradingFirstCopySettingsV5Resp) *NullableCreateCopytradingFirstCopySettingsV5Resp {
	return &NullableCreateCopytradingFirstCopySettingsV5Resp{value: val, isSet: true}
}

func (v NullableCreateCopytradingFirstCopySettingsV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCopytradingFirstCopySettingsV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
