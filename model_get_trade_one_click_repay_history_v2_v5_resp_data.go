...
// checks if the GetTradeOneClickRepayHistoryV2V5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOneClickRepayHistoryV2V5RespData{}

// GetTradeOneClickRepayHistoryV2V5RespData struct for GetTradeOneClickRepayHistoryV2V5RespData
type GetTradeOneClickRepayHistoryV2V5RespData struct {
	// Debt currency
	DebtCcy *string `json:"debtCcy,omitempty"`
	// Amount of debt currency transacted
	FillDebtSz *string `json:"fillDebtSz,omitempty"`
	// Order info
	OrdIdInfo []GetTradeOneClickRepayHistoryV2V5RespDataOrdIdInfoInner `json:"ordIdInfo,omitempty"`
...
func NewGetTradeOneClickRepayHistoryV2V5RespData() *GetTradeOneClickRepayHistoryV2V5RespData {
	this := GetTradeOneClickRepayHistoryV2V5RespData{}
	var debtCcy string = ""
...
func (o *GetTradeOneClickRepayHistoryV2V5RespData) GetOrdIdInfo() []GetTradeOneClickRepayHistoryV2V5RespDataOrdIdInfoInner {
	if o == nil || IsNil(o.OrdIdInfo) {
		var ret []GetTradeOneClickRepayHistoryV2V5RespDataOrdIdInfoInner
		return ret
	}
	return o.OrdIdInfo
}
...
// SetOrdIdInfo gets a reference to the given []GetTradeOneClickRepayHistoryV2V5RespDataOrdIdInfoInner and assigns it to the OrdIdInfo field.
...
func (o GetTradeOneClickRepayHistoryV2V5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOneClickRepayHistoryV2V5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOneClickRepayHistoryV2V5RespData struct {
	value *GetTradeOneClickRepayHistoryV2V5RespData
	isSet bool
}

func (v NullableGetTradeOneClickRepayHistoryV2V5RespData) Get() *GetTradeOneClickRepayHistoryV2V5RespData {
	return v.value
}

func (v *NullableGetTradeOneClickRepayHistoryV2V5RespData) Set(val *GetTradeOneClickRepayHistoryV2V5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOneClickRepayHistoryV2V5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOneClickRepayHistoryV2V5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOneClickRepayHistoryV2V5RespData(val *GetTradeOneClickRepayHistoryV2V5RespData) *NullableGetTradeOneClickRepayHistoryV2V5RespData {
	return &NullableGetTradeOneClickRepayHistoryV2V5RespData{value: val, isSet: true}
}

func (v NullableGetTradeOneClickRepayHistoryV2V5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOneClickRepayHistoryV2V5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
