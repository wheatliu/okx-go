...
// checks if the CreateCopytradingAmendProfitSharingRatioV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCopytradingAmendProfitSharingRatioV5Resp{}

// CreateCopytradingAmendProfitSharingRatioV5Resp struct for CreateCopytradingAmendProfitSharingRatioV5Resp
type CreateCopytradingAmendProfitSharingRatioV5Resp struct {
...
func NewCreateCopytradingAmendProfitSharingRatioV5Resp() *CreateCopytradingAmendProfitSharingRatioV5Resp {
	this := CreateCopytradingAmendProfitSharingRatioV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateCopytradingAmendProfitSharingRatioV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateCopytradingAmendProfitSharingRatioV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCopytradingAmendProfitSharingRatioV5Resp struct {
	value *CreateCopytradingAmendProfitSharingRatioV5Resp
	isSet bool
}

func (v NullableCreateCopytradingAmendProfitSharingRatioV5Resp) Get() *CreateCopytradingAmendProfitSharingRatioV5Resp {
	return v.value
}

func (v *NullableCreateCopytradingAmendProfitSharingRatioV5Resp) Set(val *CreateCopytradingAmendProfitSharingRatioV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCopytradingAmendProfitSharingRatioV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCopytradingAmendProfitSharingRatioV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCopytradingAmendProfitSharingRatioV5Resp(val *CreateCopytradingAmendProfitSharingRatioV5Resp) *NullableCreateCopytradingAmendProfitSharingRatioV5Resp {
	return &NullableCreateCopytradingAmendProfitSharingRatioV5Resp{value: val, isSet: true}
}

func (v NullableCreateCopytradingAmendProfitSharingRatioV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCopytradingAmendProfitSharingRatioV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
