...
// checks if the GetAssetSubaccountBillsV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAssetSubaccountBillsV5RespData{}

// GetAssetSubaccountBillsV5RespData struct for GetAssetSubaccountBillsV5RespData
type GetAssetSubaccountBillsV5RespData struct {
	// Transfer amount
...
func NewGetAssetSubaccountBillsV5RespData() *GetAssetSubaccountBillsV5RespData {
	this := GetAssetSubaccountBillsV5RespData{}
	var amt string = ""
	this.Amt = &amt
	var billId string = ""
	this.BillId = &billId
...
func (o GetAssetSubaccountBillsV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetAssetSubaccountBillsV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetAssetSubaccountBillsV5RespData struct {
	value *GetAssetSubaccountBillsV5RespData
	isSet bool
}

func (v NullableGetAssetSubaccountBillsV5RespData) Get() *GetAssetSubaccountBillsV5RespData {
	return v.value
}

func (v *NullableGetAssetSubaccountBillsV5RespData) Set(val *GetAssetSubaccountBillsV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetSubaccountBillsV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetSubaccountBillsV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetSubaccountBillsV5RespData(val *GetAssetSubaccountBillsV5RespData) *NullableGetAssetSubaccountBillsV5RespData {
	return &NullableGetAssetSubaccountBillsV5RespData{value: val, isSet: true}
}

func (v NullableGetAssetSubaccountBillsV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetSubaccountBillsV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
