...
// checks if the GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner{}

// GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner struct for GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner
type GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner struct {
...
func NewGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner() *GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner {
	this := GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner{}
	var beginTs string = ""
...
func (o GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) MarshalJSON() ([]byte, error) {
...
func (o GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner struct {
	value *GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner
	isSet bool
}

func (v NullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) Get() *GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner {
	return v.value
}

func (v *NullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) Set(val *GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner(val *GetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) *NullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner {
	return &NullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner{value: val, isSet: true}
}

func (v NullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCopytradingPublicLeadTradersV5RespDataInnerRanksInnerPnlRatiosInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
