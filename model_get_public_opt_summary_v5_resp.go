...
// checks if the GetPublicOptSummaryV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicOptSummaryV5Resp{}
...
func NewGetPublicOptSummaryV5Resp() *GetPublicOptSummaryV5Resp {
	this := GetPublicOptSummaryV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetPublicOptSummaryV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetPublicOptSummaryV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicOptSummaryV5Resp struct {
	value *GetPublicOptSummaryV5Resp
	isSet bool
}

func (v NullableGetPublicOptSummaryV5Resp) Get() *GetPublicOptSummaryV5Resp {
	return v.value
}

func (v *NullableGetPublicOptSummaryV5Resp) Set(val *GetPublicOptSummaryV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicOptSummaryV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicOptSummaryV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicOptSummaryV5Resp(val *GetPublicOptSummaryV5Resp) *NullableGetPublicOptSummaryV5Resp {
	return &NullableGetPublicOptSummaryV5Resp{value: val, isSet: true}
}

func (v NullableGetPublicOptSummaryV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicOptSummaryV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
