...
// checks if the GetFiatWithdrawalOrderHistoryV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFiatWithdrawalOrderHistoryV5RespDataInner{}

// GetFiatWithdrawalOrderHistoryV5RespDataInner struct for GetFiatWithdrawalOrderHistoryV5RespDataInner
type GetFiatWithdrawalOrderHistoryV5RespDataInner struct {
...
func NewGetFiatWithdrawalOrderHistoryV5RespDataInner() *GetFiatWithdrawalOrderHistoryV5RespDataInner {
	this := GetFiatWithdrawalOrderHistoryV5RespDataInner{}
	var amt string = ""
	this.Amt = &amt
	var cTime string = ""
	this.CTime = &cTime
...
func (o GetFiatWithdrawalOrderHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetFiatWithdrawalOrderHistoryV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetFiatWithdrawalOrderHistoryV5RespDataInner struct {
	value *GetFiatWithdrawalOrderHistoryV5RespDataInner
	isSet bool
}

func (v NullableGetFiatWithdrawalOrderHistoryV5RespDataInner) Get() *GetFiatWithdrawalOrderHistoryV5RespDataInner {
	return v.value
}

func (v *NullableGetFiatWithdrawalOrderHistoryV5RespDataInner) Set(val *GetFiatWithdrawalOrderHistoryV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFiatWithdrawalOrderHistoryV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFiatWithdrawalOrderHistoryV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFiatWithdrawalOrderHistoryV5RespDataInner(val *GetFiatWithdrawalOrderHistoryV5RespDataInner) *NullableGetFiatWithdrawalOrderHistoryV5RespDataInner {
	return &NullableGetFiatWithdrawalOrderHistoryV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetFiatWithdrawalOrderHistoryV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFiatWithdrawalOrderHistoryV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
