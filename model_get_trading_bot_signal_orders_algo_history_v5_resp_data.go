...
// checks if the GetTradingBotSignalOrdersAlgoHistoryV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotSignalOrdersAlgoHistoryV5RespData{}

// GetTradingBotSignalOrdersAlgoHistoryV5RespData struct for GetTradingBotSignalOrdersAlgoHistoryV5RespData
type GetTradingBotSignalOrdersAlgoHistoryV5RespData struct {
	...
	// Algo order stop reason  `1`: Manual stop
	CancelType *string `json:"cancelType,omitempty"`
	EntrySettingParam *GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam `json:"entrySettingParam,omitempty"`
	ExitSettingParam *GetTradingBotSignalOrdersAlgoDetailsV5RespDataExitSettingParam `json:"exitSettingParam,omitempty"`
	// Float P&L
...
func NewGetTradingBotSignalOrdersAlgoHistoryV5RespData() *GetTradingBotSignalOrdersAlgoHistoryV5RespData {
	this := GetTradingBotSignalOrdersAlgoHistoryV5RespData{}
...
func (o *GetTradingBotSignalOrdersAlgoHistoryV5RespData) GetEntrySettingParam() GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam {
	if o == nil || IsNil(o.EntrySettingParam) {
		var ret GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam
		return ret
	}
...
// SetEntrySettingParam gets a reference to the given GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam and assigns it to the EntrySettingParam field.
...
func (o *GetTradingBotSignalOrdersAlgoHistoryV5RespData) GetExitSettingParam() GetTradingBotSignalOrdersAlgoDetailsV5RespDataExitSettingParam {
	if o == nil || IsNil(o.ExitSettingParam) {
		var ret GetTradingBotSignalOrdersAlgoDetailsV5RespDataExitSettingParam
		return ret
	}
...
// SetExitSettingParam gets a reference to the given GetTradingBotSignalOrdersAlgoDetailsV5RespDataExitSettingParam and assigns it to the ExitSettingParam field.
...
func (o GetTradingBotSignalOrdersAlgoHistoryV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotSignalOrdersAlgoHistoryV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotSignalOrdersAlgoHistoryV5RespData struct {
	value *GetTradingBotSignalOrdersAlgoHistoryV5RespData
	isSet bool
}

func (v NullableGetTradingBotSignalOrdersAlgoHistoryV5RespData) Get() *GetTradingBotSignalOrdersAlgoHistoryV5RespData {
	return v.value
}

func (v *NullableGetTradingBotSignalOrdersAlgoHistoryV5RespData) Set(val *GetTradingBotSignalOrdersAlgoHistoryV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotSignalOrdersAlgoHistoryV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotSignalOrdersAlgoHistoryV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotSignalOrdersAlgoHistoryV5RespData(val *GetTradingBotSignalOrdersAlgoHistoryV5RespData) *NullableGetTradingBotSignalOrdersAlgoHistoryV5RespData {
	return &NullableGetTradingBotSignalOrdersAlgoHistoryV5RespData{value: val, isSet: true}
}

func (v NullableGetTradingBotSignalOrdersAlgoHistoryV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotSignalOrdersAlgoHistoryV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
