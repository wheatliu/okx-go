...
// checks if the GetTradingBotGridOrdersAlgoPendingV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotGridOrdersAlgoPendingV5RespData{}

// GetTradingBotGridOrdersAlgoPendingV5RespData struct for GetTradingBotGridOrdersAlgoPendingV5RespData
type GetTradingBotGridOrdersAlgoPendingV5RespData struct {
...
func NewGetTradingBotGridOrdersAlgoPendingV5RespData() *GetTradingBotGridOrdersAlgoPendingV5RespData {
	this := GetTradingBotGridOrdersAlgoPendingV5RespData{}
...
func (o GetTradingBotGridOrdersAlgoPendingV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotGridOrdersAlgoPendingV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotGridOrdersAlgoPendingV5RespData struct {
	value *GetTradingBotGridOrdersAlgoPendingV5RespData
	isSet bool
}

func (v NullableGetTradingBotGridOrdersAlgoPendingV5RespData) Get() *GetTradingBotGridOrdersAlgoPendingV5RespData {
	return v.value
}

func (v *NullableGetTradingBotGridOrdersAlgoPendingV5RespData) Set(val *GetTradingBotGridOrdersAlgoPendingV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotGridOrdersAlgoPendingV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotGridOrdersAlgoPendingV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotGridOrdersAlgoPendingV5RespData(val *GetTradingBotGridOrdersAlgoPendingV5RespData) *NullableGetTradingBotGridOrdersAlgoPendingV5RespData {
	return &NullableGetTradingBotGridOrdersAlgoPendingV5RespData{value: val, isSet: true}
}

func (v NullableGetTradingBotGridOrdersAlgoPendingV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotGridOrdersAlgoPendingV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
