...
// checks if the GetTradingBotSignalOrdersAlgoPendingV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotSignalOrdersAlgoPendingV5RespDataInner{}

// GetTradingBotSignalOrdersAlgoPendingV5RespDataInner struct for GetTradingBotSignalOrdersAlgoPendingV5RespDataInner
type GetTradingBotSignalOrdersAlgoPendingV5RespDataInner struct {
	...
	// Algo order state  `starting`  `running`  `stopping`
...
func NewGetTradingBotSignalOrdersAlgoPendingV5RespDataInner() *GetTradingBotSignalOrdersAlgoPendingV5RespDataInner {
	this := GetTradingBotSignalOrdersAlgoPendingV5RespDataInner{}
...
func (o GetTradingBotSignalOrdersAlgoPendingV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotSignalOrdersAlgoPendingV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner struct {
	value *GetTradingBotSignalOrdersAlgoPendingV5RespDataInner
	isSet bool
}

func (v NullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner) Get() *GetTradingBotSignalOrdersAlgoPendingV5RespDataInner {
	return v.value
}

func (v *NullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner) Set(val *GetTradingBotSignalOrdersAlgoPendingV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner(val *GetTradingBotSignalOrdersAlgoPendingV5RespDataInner) *NullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner {
	return &NullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotSignalOrdersAlgoPendingV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
