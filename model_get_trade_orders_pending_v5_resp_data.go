...
// checks if the GetTradeOrdersPendingV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrdersPendingV5RespData{}

// GetTradeOrdersPendingV5RespData struct for GetTradeOrdersPendingV5RespData
type GetTradeOrdersPendingV5RespData struct {
...
func NewGetTradeOrdersPendingV5RespData() *GetTradeOrdersPendingV5RespData {
	this := GetTradeOrdersPendingV5RespData{}
...
func (o GetTradeOrdersPendingV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrdersPendingV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrdersPendingV5RespData struct {
	value *GetTradeOrdersPendingV5RespData
	isSet bool
}

func (v NullableGetTradeOrdersPendingV5RespData) Get() *GetTradeOrdersPendingV5RespData {
	return v.value
}

func (v *NullableGetTradeOrdersPendingV5RespData) Set(val *GetTradeOrdersPendingV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrdersPendingV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrdersPendingV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrdersPendingV5RespData(val *GetTradeOrdersPendingV5RespData) *NullableGetTradeOrdersPendingV5RespData {
	return &NullableGetTradeOrdersPendingV5RespData{value: val, isSet: true}
}

func (v NullableGetTradeOrdersPendingV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrdersPendingV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
