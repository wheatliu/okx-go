...
// checks if the GetPublicInsuranceFundV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicInsuranceFundV5Resp{}
...
func NewGetPublicInsuranceFundV5Resp() *GetPublicInsuranceFundV5Resp {
	this := GetPublicInsuranceFundV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetPublicInsuranceFundV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetPublicInsuranceFundV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicInsuranceFundV5Resp struct {
	value *GetPublicInsuranceFundV5Resp
	isSet bool
}

func (v NullableGetPublicInsuranceFundV5Resp) Get() *GetPublicInsuranceFundV5Resp {
	return v.value
}

func (v *NullableGetPublicInsuranceFundV5Resp) Set(val *GetPublicInsuranceFundV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicInsuranceFundV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicInsuranceFundV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicInsuranceFundV5Resp(val *GetPublicInsuranceFundV5Resp) *NullableGetPublicInsuranceFundV5Resp {
	return &NullableGetPublicInsuranceFundV5Resp{value: val, isSet: true}
}

func (v NullableGetPublicInsuranceFundV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicInsuranceFundV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
