...
// checks if the CreateRfqCreateQuoteV5RespDataDataInnerLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqCreateQuoteV5RespDataDataInnerLegsInner{}

// CreateRfqCreateQuoteV5RespDataDataInnerLegsInner struct for CreateRfqCreateQuoteV5RespDataDataInnerLegsInner
type CreateRfqCreateQuoteV5RespDataDataInnerLegsInner struct {
...
func NewCreateRfqCreateQuoteV5RespDataDataInnerLegsInner() *CreateRfqCreateQuoteV5RespDataDataInnerLegsInner {
	this := CreateRfqCreateQuoteV5RespDataDataInnerLegsInner{}
	var ccy string = ""
	this.Ccy = &ccy
	var instId string = ""
	this.InstId = &instId
...
func (o CreateRfqCreateQuoteV5RespDataDataInnerLegsInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqCreateQuoteV5RespDataDataInnerLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner struct {
	value *CreateRfqCreateQuoteV5RespDataDataInnerLegsInner
	isSet bool
}

func (v NullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner) Get() *CreateRfqCreateQuoteV5RespDataDataInnerLegsInner {
	return v.value
}

func (v *NullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner) Set(val *CreateRfqCreateQuoteV5RespDataDataInnerLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner(val *CreateRfqCreateQuoteV5RespDataDataInnerLegsInner) *NullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner {
	return &NullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner{value: val, isSet: true}
}

func (v NullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqCreateQuoteV5RespDataDataInnerLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
