...
// checks if the GetTradeOrderV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradeOrderV5RespDataInner{}

// GetTradeOrderV5RespDataInner struct for GetTradeOrderV5RespDataInner
type GetTradeOrderV5RespDataInner struct {
	// Accumulated fill quantity  The unit is `base_ccy` for SPOT and MARGIN, e.g. BTC-USDT, the unit is BTC; For market orders, the unit both is `base_ccy` when the tgtCcy is `base_ccy` or `quote_ccy`;  The unit is contract for `FUTURES`/`SWAP`/`OPTION`
	...
	// Last filled quantity  The unit is `base_ccy` for SPOT and MARGIN, e.g. BTC-USDT, the unit is BTC; For market orders, the unit both is `base_ccy` when the tgtCcy is `base_ccy` or `quote_ccy`;  The unit is contract for `FUTURES`/`SWAP`/`OPTION`
...
func NewGetTradeOrderV5RespDataInner() *GetTradeOrderV5RespDataInner {
	this := GetTradeOrderV5RespDataInner{}
...
func (o GetTradeOrderV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradeOrderV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradeOrderV5RespDataInner struct {
	value *GetTradeOrderV5RespDataInner
	isSet bool
}

func (v NullableGetTradeOrderV5RespDataInner) Get() *GetTradeOrderV5RespDataInner {
	return v.value
}

func (v *NullableGetTradeOrderV5RespDataInner) Set(val *GetTradeOrderV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradeOrderV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradeOrderV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradeOrderV5RespDataInner(val *GetTradeOrderV5RespDataInner) *NullableGetTradeOrderV5RespDataInner {
	return &NullableGetTradeOrderV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradeOrderV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradeOrderV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
