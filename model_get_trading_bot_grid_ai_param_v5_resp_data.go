...
// checks if the GetTradingBotGridAiParamV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotGridAiParamV5RespData{}

// GetTradingBotGridAiParamV5RespData struct for GetTradingBotGridAiParamV5RespData
type GetTradingBotGridAiParamV5RespData struct {
...
func NewGetTradingBotGridAiParamV5RespData() *GetTradingBotGridAiParamV5RespData {
	this := GetTradingBotGridAiParamV5RespData{}
...
func (o GetTradingBotGridAiParamV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotGridAiParamV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotGridAiParamV5RespData struct {
	value *GetTradingBotGridAiParamV5RespData
	isSet bool
}

func (v NullableGetTradingBotGridAiParamV5RespData) Get() *GetTradingBotGridAiParamV5RespData {
	return v.value
}

func (v *NullableGetTradingBotGridAiParamV5RespData) Set(val *GetTradingBotGridAiParamV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotGridAiParamV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotGridAiParamV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotGridAiParamV5RespData(val *GetTradingBotGridAiParamV5RespData) *NullableGetTradingBotGridAiParamV5RespData {
	return &NullableGetTradingBotGridAiParamV5RespData{value: val, isSet: true}
}

func (v NullableGetTradingBotGridAiParamV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotGridAiParamV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
