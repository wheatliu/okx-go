...
// checks if the GetRfqQuotesV5RespDataDataInnerLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRfqQuotesV5RespDataDataInnerLegsInner{}

// GetRfqQuotesV5RespDataDataInnerLegsInner struct for GetRfqQuotesV5RespDataDataInnerLegsInner
type GetRfqQuotesV5RespDataDataInnerLegsInner struct {
...
func NewGetRfqQuotesV5RespDataDataInnerLegsInner() *GetRfqQuotesV5RespDataDataInnerLegsInner {
	this := GetRfqQuotesV5RespDataDataInnerLegsInner{}
	var ccy string = ""
	this.Ccy = &ccy
	var instId string = ""
	this.InstId = &instId
...
func (o GetRfqQuotesV5RespDataDataInnerLegsInner) MarshalJSON() ([]byte, error) {
...
func (o GetRfqQuotesV5RespDataDataInnerLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRfqQuotesV5RespDataDataInnerLegsInner struct {
	value *GetRfqQuotesV5RespDataDataInnerLegsInner
	isSet bool
}

func (v NullableGetRfqQuotesV5RespDataDataInnerLegsInner) Get() *GetRfqQuotesV5RespDataDataInnerLegsInner {
	return v.value
}

func (v *NullableGetRfqQuotesV5RespDataDataInnerLegsInner) Set(val *GetRfqQuotesV5RespDataDataInnerLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRfqQuotesV5RespDataDataInnerLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRfqQuotesV5RespDataDataInnerLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRfqQuotesV5RespDataDataInnerLegsInner(val *GetRfqQuotesV5RespDataDataInnerLegsInner) *NullableGetRfqQuotesV5RespDataDataInnerLegsInner {
	return &NullableGetRfqQuotesV5RespDataDataInnerLegsInner{value: val, isSet: true}
}

func (v NullableGetRfqQuotesV5RespDataDataInnerLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRfqQuotesV5RespDataDataInnerLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
