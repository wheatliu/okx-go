...
// checks if the CreateAccountSetCollateralAssetsV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAccountSetCollateralAssetsV5RespDataInner{}

// CreateAccountSetCollateralAssetsV5RespDataInner struct for CreateAccountSetCollateralAssetsV5RespDataInner
type CreateAccountSetCollateralAssetsV5RespDataInner struct {
...
func NewCreateAccountSetCollateralAssetsV5RespDataInner() *CreateAccountSetCollateralAssetsV5RespDataInner {
	this := CreateAccountSetCollateralAssetsV5RespDataInner{}
	var type_ string = ""
	this.Type = &type_
	return &this
}
...
func (o CreateAccountSetCollateralAssetsV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateAccountSetCollateralAssetsV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAccountSetCollateralAssetsV5RespDataInner struct {
	value *CreateAccountSetCollateralAssetsV5RespDataInner
	isSet bool
}

func (v NullableCreateAccountSetCollateralAssetsV5RespDataInner) Get() *CreateAccountSetCollateralAssetsV5RespDataInner {
	return v.value
}

func (v *NullableCreateAccountSetCollateralAssetsV5RespDataInner) Set(val *CreateAccountSetCollateralAssetsV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAccountSetCollateralAssetsV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAccountSetCollateralAssetsV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAccountSetCollateralAssetsV5RespDataInner(val *CreateAccountSetCollateralAssetsV5RespDataInner) *NullableCreateAccountSetCollateralAssetsV5RespDataInner {
	return &NullableCreateAccountSetCollateralAssetsV5RespDataInner{value: val, isSet: true}
}

func (v NullableCreateAccountSetCollateralAssetsV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAccountSetCollateralAssetsV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
