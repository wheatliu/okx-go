...
// checks if the GetPublicMarkPriceV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicMarkPriceV5RespDataInner{}

// GetPublicMarkPriceV5RespDataInner struct for GetPublicMarkPriceV5RespDataInner
type GetPublicMarkPriceV5RespDataInner struct {
...
func NewGetPublicMarkPriceV5RespDataInner() *GetPublicMarkPriceV5RespDataInner {
	this := GetPublicMarkPriceV5RespDataInner{}
	var instId string = ""
	this.InstId = &instId
	var instType string = ""
...
func (o GetPublicMarkPriceV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetPublicMarkPriceV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicMarkPriceV5RespDataInner struct {
	value *GetPublicMarkPriceV5RespDataInner
	isSet bool
}

func (v NullableGetPublicMarkPriceV5RespDataInner) Get() *GetPublicMarkPriceV5RespDataInner {
	return v.value
}

func (v *NullableGetPublicMarkPriceV5RespDataInner) Set(val *GetPublicMarkPriceV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicMarkPriceV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicMarkPriceV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicMarkPriceV5RespDataInner(val *GetPublicMarkPriceV5RespDataInner) *NullableGetPublicMarkPriceV5RespDataInner {
	return &NullableGetPublicMarkPriceV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetPublicMarkPriceV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicMarkPriceV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
