...
// checks if the CreateRfqCreateQuoteV5RespDataDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqCreateQuoteV5RespDataDataInner{}

// CreateRfqCreateQuoteV5RespDataDataInner struct for CreateRfqCreateQuoteV5RespDataDataInner
type CreateRfqCreateQuoteV5RespDataDataInner struct {
	...
	Legs []CreateRfqCreateQuoteV5RespDataDataInnerLegsInner `json:"legs,omitempty"`
...
func NewCreateRfqCreateQuoteV5RespDataDataInner() *CreateRfqCreateQuoteV5RespDataDataInner {
	this := CreateRfqCreateQuoteV5RespDataDataInner{}
	var cTime string = ""
	this.CTime = &cTime
	var ccy string = ""
	this.Ccy = &ccy
...
func (o *CreateRfqCreateQuoteV5RespDataDataInner) GetLegs() []CreateRfqCreateQuoteV5RespDataDataInnerLegsInner {
	if o == nil || IsNil(o.Legs) {
		var ret []CreateRfqCreateQuoteV5RespDataDataInnerLegsInner
		return ret
	}
	return o.Legs
}
...
// SetLegs gets a reference to the given []CreateRfqCreateQuoteV5RespDataDataInnerLegsInner and assigns it to the Legs field.
...
func (o CreateRfqCreateQuoteV5RespDataDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqCreateQuoteV5RespDataDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqCreateQuoteV5RespDataDataInner struct {
	value *CreateRfqCreateQuoteV5RespDataDataInner
	isSet bool
}

func (v NullableCreateRfqCreateQuoteV5RespDataDataInner) Get() *CreateRfqCreateQuoteV5RespDataDataInner {
	return v.value
}

func (v *NullableCreateRfqCreateQuoteV5RespDataDataInner) Set(val *CreateRfqCreateQuoteV5RespDataDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqCreateQuoteV5RespDataDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqCreateQuoteV5RespDataDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqCreateQuoteV5RespDataDataInner(val *CreateRfqCreateQuoteV5RespDataDataInner) *NullableCreateRfqCreateQuoteV5RespDataDataInner {
	return &NullableCreateRfqCreateQuoteV5RespDataDataInner{value: val, isSet: true}
}

func (v NullableCreateRfqCreateQuoteV5RespDataDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqCreateQuoteV5RespDataDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
