...
// checks if the CreateSprdCancelAllAfterV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSprdCancelAllAfterV5Resp{}

// CreateSprdCancelAllAfterV5Resp struct for CreateSprdCancelAllAfterV5Resp
type CreateSprdCancelAllAfterV5Resp struct {
...
func NewCreateSprdCancelAllAfterV5Resp() *CreateSprdCancelAllAfterV5Resp {
	this := CreateSprdCancelAllAfterV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateSprdCancelAllAfterV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateSprdCancelAllAfterV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSprdCancelAllAfterV5Resp struct {
	value *CreateSprdCancelAllAfterV5Resp
	isSet bool
}

func (v NullableCreateSprdCancelAllAfterV5Resp) Get() *CreateSprdCancelAllAfterV5Resp {
	return v.value
}

func (v *NullableCreateSprdCancelAllAfterV5Resp) Set(val *CreateSprdCancelAllAfterV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSprdCancelAllAfterV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSprdCancelAllAfterV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSprdCancelAllAfterV5Resp(val *CreateSprdCancelAllAfterV5Resp) *NullableCreateSprdCancelAllAfterV5Resp {
	return &NullableCreateSprdCancelAllAfterV5Resp{value: val, isSet: true}
}

func (v NullableCreateSprdCancelAllAfterV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSprdCancelAllAfterV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
