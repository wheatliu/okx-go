...
// checks if the GetPublicInstrumentsV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicInstrumentsV5RespDataInner{}

// GetPublicInstrumentsV5RespDataInner struct for GetPublicInstrumentsV5RespDataInner
type GetPublicInstrumentsV5RespDataInner struct {
	// Alias  `this_week`  `next_week`  `this_month`  `next_month`  `quarter`  `next_quarter`  `third_quarter`  Only applicable to `FUTURES`   
	...
	// Instrument status  `live`   `suspend`  `preopen`. e.g. There will be `preopen` before the Futures and Options new contracts state is live.  `test`: Test pairs, can't be traded
...
func NewGetPublicInstrumentsV5RespDataInner() *GetPublicInstrumentsV5RespDataInner {
	this := GetPublicInstrumentsV5RespDataInner{}
	var alias string = ""
	this.Alias = &alias
...
func (o GetPublicInstrumentsV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetPublicInstrumentsV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicInstrumentsV5RespDataInner struct {
	value *GetPublicInstrumentsV5RespDataInner
	isSet bool
}

func (v NullableGetPublicInstrumentsV5RespDataInner) Get() *GetPublicInstrumentsV5RespDataInner {
	return v.value
}

func (v *NullableGetPublicInstrumentsV5RespDataInner) Set(val *GetPublicInstrumentsV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicInstrumentsV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicInstrumentsV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicInstrumentsV5RespDataInner(val *GetPublicInstrumentsV5RespDataInner) *NullableGetPublicInstrumentsV5RespDataInner {
	return &NullableGetPublicInstrumentsV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetPublicInstrumentsV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicInstrumentsV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
