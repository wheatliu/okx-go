...
// checks if the GetAccountMaxWithdrawalV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountMaxWithdrawalV5Resp{}
...
func NewGetAccountMaxWithdrawalV5Resp() *GetAccountMaxWithdrawalV5Resp {
	this := GetAccountMaxWithdrawalV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetAccountMaxWithdrawalV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetAccountMaxWithdrawalV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountMaxWithdrawalV5Resp struct {
	value *GetAccountMaxWithdrawalV5Resp
	isSet bool
}

func (v NullableGetAccountMaxWithdrawalV5Resp) Get() *GetAccountMaxWithdrawalV5Resp {
	return v.value
}

func (v *NullableGetAccountMaxWithdrawalV5Resp) Set(val *GetAccountMaxWithdrawalV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountMaxWithdrawalV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountMaxWithdrawalV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountMaxWithdrawalV5Resp(val *GetAccountMaxWithdrawalV5Resp) *NullableGetAccountMaxWithdrawalV5Resp {
	return &NullableGetAccountMaxWithdrawalV5Resp{value: val, isSet: true}
}

func (v NullableGetAccountMaxWithdrawalV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountMaxWithdrawalV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
