...
// checks if the GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam{}

// GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam Entry setting
type GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam struct {
...
func NewGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam() *GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam {
	this := GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam{}
	var amt string = ""
	this.Amt = &amt
...
func (o GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam struct {
	value *GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam
	isSet bool
}

func (v NullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) Get() *GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam {
	return v.value
}

func (v *NullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) Set(val *GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam(val *GetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) *NullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam {
	return &NullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam{value: val, isSet: true}
}

func (v NullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotSignalOrdersAlgoDetailsV5RespDataEntrySettingParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
