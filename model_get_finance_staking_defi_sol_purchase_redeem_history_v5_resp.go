...
// checks if the GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp{}

// GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp struct for GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp
type GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp struct {
...
func NewGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp() *GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp {
	this := GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp struct {
	value *GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp
	isSet bool
}

func (v NullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) Get() *GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp {
	return v.value
}

func (v *NullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) Set(val *GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp(val *GetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) *NullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp {
	return &NullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp{value: val, isSet: true}
}

func (v NullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFinanceStakingDefiSolPurchaseRedeemHistoryV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
