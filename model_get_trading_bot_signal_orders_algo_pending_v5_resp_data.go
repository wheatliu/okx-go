...
// checks if the GetTradingBotSignalOrdersAlgoPendingV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotSignalOrdersAlgoPendingV5RespData{}

// GetTradingBotSignalOrdersAlgoPendingV5RespData struct for GetTradingBotSignalOrdersAlgoPendingV5RespData
type GetTradingBotSignalOrdersAlgoPendingV5RespData struct {
...
func NewGetTradingBotSignalOrdersAlgoPendingV5RespData() *GetTradingBotSignalOrdersAlgoPendingV5RespData {
	this := GetTradingBotSignalOrdersAlgoPendingV5RespData{}
...
func (o GetTradingBotSignalOrdersAlgoPendingV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotSignalOrdersAlgoPendingV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotSignalOrdersAlgoPendingV5RespData struct {
	value *GetTradingBotSignalOrdersAlgoPendingV5RespData
	isSet bool
}

func (v NullableGetTradingBotSignalOrdersAlgoPendingV5RespData) Get() *GetTradingBotSignalOrdersAlgoPendingV5RespData {
	return v.value
}

func (v *NullableGetTradingBotSignalOrdersAlgoPendingV5RespData) Set(val *GetTradingBotSignalOrdersAlgoPendingV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotSignalOrdersAlgoPendingV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotSignalOrdersAlgoPendingV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotSignalOrdersAlgoPendingV5RespData(val *GetTradingBotSignalOrdersAlgoPendingV5RespData) *NullableGetTradingBotSignalOrdersAlgoPendingV5RespData {
	return &NullableGetTradingBotSignalOrdersAlgoPendingV5RespData{value: val, isSet: true}
}

func (v NullableGetTradingBotSignalOrdersAlgoPendingV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotSignalOrdersAlgoPendingV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
