...
// checks if the GetAccountSubaccountBalancesV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountSubaccountBalancesV5RespDataInner{}

// GetAccountSubaccountBalancesV5RespDataInner struct for GetAccountSubaccountBalancesV5RespDataInner
type GetAccountSubaccountBalancesV5RespDataInner struct {
	...
	Details []GetAccountSubaccountBalancesV5RespDataInnerDetailsInner `json:"details,omitempty"`
...
func NewGetAccountSubaccountBalancesV5RespDataInner() *GetAccountSubaccountBalancesV5RespDataInner {
	this := GetAccountSubaccountBalancesV5RespDataInner{}
	var adjEq string = ""
	this.AdjEq = &adjEq
...
func (o *GetAccountSubaccountBalancesV5RespDataInner) GetDetails() []GetAccountSubaccountBalancesV5RespDataInnerDetailsInner {
	if o == nil || IsNil(o.Details) {
		var ret []GetAccountSubaccountBalancesV5RespDataInnerDetailsInner
		return ret
	}
	return o.Details
}
...
// SetDetails gets a reference to the given []GetAccountSubaccountBalancesV5RespDataInnerDetailsInner and assigns it to the Details field.
...
func (o GetAccountSubaccountBalancesV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetAccountSubaccountBalancesV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountSubaccountBalancesV5RespDataInner struct {
	value *GetAccountSubaccountBalancesV5RespDataInner
	isSet bool
}

func (v NullableGetAccountSubaccountBalancesV5RespDataInner) Get() *GetAccountSubaccountBalancesV5RespDataInner {
	return v.value
}

func (v *NullableGetAccountSubaccountBalancesV5RespDataInner) Set(val *GetAccountSubaccountBalancesV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountSubaccountBalancesV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountSubaccountBalancesV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountSubaccountBalancesV5RespDataInner(val *GetAccountSubaccountBalancesV5RespDataInner) *NullableGetAccountSubaccountBalancesV5RespDataInner {
	return &NullableGetAccountSubaccountBalancesV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetAccountSubaccountBalancesV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountSubaccountBalancesV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
