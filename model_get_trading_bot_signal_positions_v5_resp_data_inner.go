...
// checks if the GetTradingBotSignalPositionsV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTradingBotSignalPositionsV5RespDataInner{}

// GetTradingBotSignalPositionsV5RespDataInner struct for GetTradingBotSignalPositionsV5RespDataInner
type GetTradingBotSignalPositionsV5RespDataInner struct {
...
func NewGetTradingBotSignalPositionsV5RespDataInner() *GetTradingBotSignalPositionsV5RespDataInner {
	this := GetTradingBotSignalPositionsV5RespDataInner{}
	var adl string = ""
	this.Adl = &adl
...
func (o GetTradingBotSignalPositionsV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTradingBotSignalPositionsV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTradingBotSignalPositionsV5RespDataInner struct {
	value *GetTradingBotSignalPositionsV5RespDataInner
	isSet bool
}

func (v NullableGetTradingBotSignalPositionsV5RespDataInner) Get() *GetTradingBotSignalPositionsV5RespDataInner {
	return v.value
}

func (v *NullableGetTradingBotSignalPositionsV5RespDataInner) Set(val *GetTradingBotSignalPositionsV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTradingBotSignalPositionsV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTradingBotSignalPositionsV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTradingBotSignalPositionsV5RespDataInner(val *GetTradingBotSignalPositionsV5RespDataInner) *NullableGetTradingBotSignalPositionsV5RespDataInner {
	return &NullableGetTradingBotSignalPositionsV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetTradingBotSignalPositionsV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTradingBotSignalPositionsV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
