...
// checks if the CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner{}

// CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner struct for CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner
type CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner struct {
...
func NewCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner() *CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner {
	this := CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner{}
...
func (o CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner struct {
	value *CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner
	isSet bool
}

func (v NullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) Get() *CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner {
	return v.value
}

func (v *NullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) Set(val *CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner(val *CreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) *NullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner {
	return &NullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner{value: val, isSet: true}
}

func (v NullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotRecurringAmendOrderAlgoV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
