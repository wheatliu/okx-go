...
// checks if the GetSprdTradesV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSprdTradesV5RespData{}

// GetSprdTradesV5RespData struct for GetSprdTradesV5RespData
type GetSprdTradesV5RespData struct {
	...
	// Legs of trade
	Legs []GetSprdTradesV5RespDataLegsInner `json:"legs,omitempty"`
...
func (o *GetSprdTradesV5RespData) GetLegs() []GetSprdTradesV5RespDataLegsInner {
	if o == nil || IsNil(o.Legs) {
		var ret []GetSprdTradesV5RespDataLegsInner
		return ret
	}
	return o.Legs
}
...
// SetLegs gets a reference to the given []GetSprdTradesV5RespDataLegsInner and assigns it to the Legs field.
...
func (o GetSprdTradesV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetSprdTradesV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetSprdTradesV5RespData struct {
	value *GetSprdTradesV5RespData
	isSet bool
}

func (v NullableGetSprdTradesV5RespData) Get() *GetSprdTradesV5RespData {
	return v.value
}

func (v *NullableGetSprdTradesV5RespData) Set(val *GetSprdTradesV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSprdTradesV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSprdTradesV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSprdTradesV5RespData(val *GetSprdTradesV5RespData) *NullableGetSprdTradesV5RespData {
	return &NullableGetSprdTradesV5RespData{value: val, isSet: true}
}

func (v NullableGetSprdTradesV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSprdTradesV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
