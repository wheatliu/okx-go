...
type CreateRfqExecuteQuoteV5RespDataInner struct {
	...
	// Legs of trade
	Legs []CreateRfqExecuteQuoteV5RespDataInnerLegsInner `json:"legs,omitempty"`
...
func (o *CreateRfqExecuteQuoteV5RespDataInner) GetLegs() []CreateRfqExecuteQuoteV5RespDataInnerLegsInner {
	if o == nil || IsNil(o.Legs) {
		var ret []CreateRfqExecuteQuoteV5RespDataInnerLegsInner
		return ret
	}
	return o.Legs
}
...
// SetLegs gets a reference to the given []CreateRfqExecuteQuoteV5RespDataInnerLegsInner and assigns it to the Legs field.
