...
// checks if the CreateTradingBotGridMarginBalanceV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotGridMarginBalanceV5Resp{}

// CreateTradingBotGridMarginBalanceV5Resp struct for CreateTradingBotGridMarginBalanceV5Resp
type CreateTradingBotGridMarginBalanceV5Resp struct {
...
func NewCreateTradingBotGridMarginBalanceV5Resp() *CreateTradingBotGridMarginBalanceV5Resp {
	this := CreateTradingBotGridMarginBalanceV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o CreateTradingBotGridMarginBalanceV5Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotGridMarginBalanceV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotGridMarginBalanceV5Resp struct {
	value *CreateTradingBotGridMarginBalanceV5Resp
	isSet bool
}

func (v NullableCreateTradingBotGridMarginBalanceV5Resp) Get() *CreateTradingBotGridMarginBalanceV5Resp {
	return v.value
}

func (v *NullableCreateTradingBotGridMarginBalanceV5Resp) Set(val *CreateTradingBotGridMarginBalanceV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotGridMarginBalanceV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotGridMarginBalanceV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotGridMarginBalanceV5Resp(val *CreateTradingBotGridMarginBalanceV5Resp) *NullableCreateTradingBotGridMarginBalanceV5Resp {
	return &NullableCreateTradingBotGridMarginBalanceV5Resp{value: val, isSet: true}
}

func (v NullableCreateTradingBotGridMarginBalanceV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotGridMarginBalanceV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
