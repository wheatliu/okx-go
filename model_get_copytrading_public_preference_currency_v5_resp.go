...
// checks if the GetCopytradingPublicPreferenceCurrencyV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCopytradingPublicPreferenceCurrencyV5Resp{}
...
func NewGetCopytradingPublicPreferenceCurrencyV5Resp() *GetCopytradingPublicPreferenceCurrencyV5Resp {
	this := GetCopytradingPublicPreferenceCurrencyV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetCopytradingPublicPreferenceCurrencyV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetCopytradingPublicPreferenceCurrencyV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetCopytradingPublicPreferenceCurrencyV5Resp struct {
	value *GetCopytradingPublicPreferenceCurrencyV5Resp
	isSet bool
}

func (v NullableGetCopytradingPublicPreferenceCurrencyV5Resp) Get() *GetCopytradingPublicPreferenceCurrencyV5Resp {
	return v.value
}

func (v *NullableGetCopytradingPublicPreferenceCurrencyV5Resp) Set(val *GetCopytradingPublicPreferenceCurrencyV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCopytradingPublicPreferenceCurrencyV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCopytradingPublicPreferenceCurrencyV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCopytradingPublicPreferenceCurrencyV5Resp(val *GetCopytradingPublicPreferenceCurrencyV5Resp) *NullableGetCopytradingPublicPreferenceCurrencyV5Resp {
	return &NullableGetCopytradingPublicPreferenceCurrencyV5Resp{value: val, isSet: true}
}

func (v NullableGetCopytradingPublicPreferenceCurrencyV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCopytradingPublicPreferenceCurrencyV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
