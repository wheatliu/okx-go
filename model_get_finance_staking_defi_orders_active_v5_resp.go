...
// checks if the GetFinanceStakingDefiOrdersActiveV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFinanceStakingDefiOrdersActiveV5Resp{}
...
func NewGetFinanceStakingDefiOrdersActiveV5Resp() *GetFinanceStakingDefiOrdersActiveV5Resp {
	this := GetFinanceStakingDefiOrdersActiveV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetFinanceStakingDefiOrdersActiveV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetFinanceStakingDefiOrdersActiveV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetFinanceStakingDefiOrdersActiveV5Resp struct {
	value *GetFinanceStakingDefiOrdersActiveV5Resp
	isSet bool
}

func (v NullableGetFinanceStakingDefiOrdersActiveV5Resp) Get() *GetFinanceStakingDefiOrdersActiveV5Resp {
	return v.value
}

func (v *NullableGetFinanceStakingDefiOrdersActiveV5Resp) Set(val *GetFinanceStakingDefiOrdersActiveV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFinanceStakingDefiOrdersActiveV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFinanceStakingDefiOrdersActiveV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFinanceStakingDefiOrdersActiveV5Resp(val *GetFinanceStakingDefiOrdersActiveV5Resp) *NullableGetFinanceStakingDefiOrdersActiveV5Resp {
	return &NullableGetFinanceStakingDefiOrdersActiveV5Resp{value: val, isSet: true}
}

func (v NullableGetFinanceStakingDefiOrdersActiveV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFinanceStakingDefiOrdersActiveV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
