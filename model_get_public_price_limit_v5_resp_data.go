...
// checks if the GetPublicPriceLimitV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicPriceLimitV5RespData{}

// GetPublicPriceLimitV5RespData struct for GetPublicPriceLimitV5RespData
type GetPublicPriceLimitV5RespData struct {
...
func NewGetPublicPriceLimitV5RespData() *GetPublicPriceLimitV5RespData {
	this := GetPublicPriceLimitV5RespData{}
	var buyLmt string = ""
	this.BuyLmt = &buyLmt
	var instId string = ""
	this.InstId = &instId
...
func (o GetPublicPriceLimitV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetPublicPriceLimitV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicPriceLimitV5RespData struct {
	value *GetPublicPriceLimitV5RespData
	isSet bool
}

func (v NullableGetPublicPriceLimitV5RespData) Get() *GetPublicPriceLimitV5RespData {
	return v.value
}

func (v *NullableGetPublicPriceLimitV5RespData) Set(val *GetPublicPriceLimitV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicPriceLimitV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicPriceLimitV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicPriceLimitV5RespData(val *GetPublicPriceLimitV5RespData) *NullableGetPublicPriceLimitV5RespData {
	return &NullableGetPublicPriceLimitV5RespData{value: val, isSet: true}
}

func (v NullableGetPublicPriceLimitV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicPriceLimitV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
