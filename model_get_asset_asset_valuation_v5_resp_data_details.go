...
// checks if the GetAssetAssetValuationV5RespDataDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAssetAssetValuationV5RespDataDetails{}

// GetAssetAssetValuationV5RespDataDetails Asset valuation details for each account
type GetAssetAssetValuationV5RespDataDetails struct {
...
func NewGetAssetAssetValuationV5RespDataDetails() *GetAssetAssetValuationV5RespDataDetails {
	this := GetAssetAssetValuationV5RespDataDetails{}
	var classic string = ""
...
func (o GetAssetAssetValuationV5RespDataDetails) MarshalJSON() ([]byte, error) {
...
func (o GetAssetAssetValuationV5RespDataDetails) ToMap() (map[string]interface{}, error) {
...
type NullableGetAssetAssetValuationV5RespDataDetails struct {
	value *GetAssetAssetValuationV5RespDataDetails
	isSet bool
}

func (v NullableGetAssetAssetValuationV5RespDataDetails) Get() *GetAssetAssetValuationV5RespDataDetails {
	return v.value
}

func (v *NullableGetAssetAssetValuationV5RespDataDetails) Set(val *GetAssetAssetValuationV5RespDataDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetAssetValuationV5RespDataDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetAssetValuationV5RespDataDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetAssetValuationV5RespDataDetails(val *GetAssetAssetValuationV5RespDataDetails) *NullableGetAssetAssetValuationV5RespDataDetails {
	return &NullableGetAssetAssetValuationV5RespDataDetails{value: val, isSet: true}
}

func (v NullableGetAssetAssetValuationV5RespDataDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetAssetValuationV5RespDataDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
