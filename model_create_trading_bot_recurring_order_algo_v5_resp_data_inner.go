...
// checks if the CreateTradingBotRecurringOrderAlgoV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingBotRecurringOrderAlgoV5RespDataInner{}

// CreateTradingBotRecurringOrderAlgoV5RespDataInner struct for CreateTradingBotRecurringOrderAlgoV5RespDataInner
type CreateTradingBotRecurringOrderAlgoV5RespDataInner struct {
...
func NewCreateTradingBotRecurringOrderAlgoV5RespDataInner() *CreateTradingBotRecurringOrderAlgoV5RespDataInner {
	this := CreateTradingBotRecurringOrderAlgoV5RespDataInner{}
...
func (o CreateTradingBotRecurringOrderAlgoV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingBotRecurringOrderAlgoV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTradingBotRecurringOrderAlgoV5RespDataInner struct {
	value *CreateTradingBotRecurringOrderAlgoV5RespDataInner
	isSet bool
}

func (v NullableCreateTradingBotRecurringOrderAlgoV5RespDataInner) Get() *CreateTradingBotRecurringOrderAlgoV5RespDataInner {
	return v.value
}

func (v *NullableCreateTradingBotRecurringOrderAlgoV5RespDataInner) Set(val *CreateTradingBotRecurringOrderAlgoV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingBotRecurringOrderAlgoV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingBotRecurringOrderAlgoV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingBotRecurringOrderAlgoV5RespDataInner(val *CreateTradingBotRecurringOrderAlgoV5RespDataInner) *NullableCreateTradingBotRecurringOrderAlgoV5RespDataInner {
	return &NullableCreateTradingBotRecurringOrderAlgoV5RespDataInner{value: val, isSet: true}
}

func (v NullableCreateTradingBotRecurringOrderAlgoV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingBotRecurringOrderAlgoV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
