...
// checks if the GetPublicBlockTradesV5RespDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPublicBlockTradesV5RespDataInner{}

// GetPublicBlockTradesV5RespDataInner struct for GetPublicBlockTradesV5RespDataInner
type GetPublicBlockTradesV5RespDataInner struct {
...
func NewGetPublicBlockTradesV5RespDataInner() *GetPublicBlockTradesV5RespDataInner {
	this := GetPublicBlockTradesV5RespDataInner{}
	var fillVol string = ""
...
func (o GetPublicBlockTradesV5RespDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetPublicBlockTradesV5RespDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetPublicBlockTradesV5RespDataInner struct {
	value *GetPublicBlockTradesV5RespDataInner
	isSet bool
}

func (v NullableGetPublicBlockTradesV5RespDataInner) Get() *GetPublicBlockTradesV5RespDataInner {
	return v.value
}

func (v *NullableGetPublicBlockTradesV5RespDataInner) Set(val *GetPublicBlockTradesV5RespDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicBlockTradesV5RespDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicBlockTradesV5RespDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicBlockTradesV5RespDataInner(val *GetPublicBlockTradesV5RespDataInner) *NullableGetPublicBlockTradesV5RespDataInner {
	return &NullableGetPublicBlockTradesV5RespDataInner{value: val, isSet: true}
}

func (v NullableGetPublicBlockTradesV5RespDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicBlockTradesV5RespDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
