...
// checks if the CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner{}

// CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner struct for CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner
type CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner struct {
...
func NewCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner() *CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner {
	this := CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner{}
	var fee string = ""
	this.Fee = &fee
	var feeCcy string = ""
	this.FeeCcy = &feeCcy
...
func (o CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner struct {
	value *CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner
	isSet bool
}

func (v NullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) Get() *CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner {
	return v.value
}

func (v *NullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) Set(val *CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner(val *CreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) *NullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner {
	return &NullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner{value: val, isSet: true}
}

func (v NullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqExecuteQuoteV5RespDataInnerDataInnerLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
