...
// checks if the GetRfqMakerInstrumentSettingsV5Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRfqMakerInstrumentSettingsV5Resp{}
...
func NewGetRfqMakerInstrumentSettingsV5Resp() *GetRfqMakerInstrumentSettingsV5Resp {
	this := GetRfqMakerInstrumentSettingsV5Resp{}
	var code string = ""
	this.Code = &code
	var msg string = ""
	this.Msg = &msg
...
func (o GetRfqMakerInstrumentSettingsV5Resp) MarshalJSON() ([]byte, error) {
...
func (o GetRfqMakerInstrumentSettingsV5Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetRfqMakerInstrumentSettingsV5Resp struct {
	value *GetRfqMakerInstrumentSettingsV5Resp
	isSet bool
}

func (v NullableGetRfqMakerInstrumentSettingsV5Resp) Get() *GetRfqMakerInstrumentSettingsV5Resp {
	return v.value
}

func (v *NullableGetRfqMakerInstrumentSettingsV5Resp) Set(val *GetRfqMakerInstrumentSettingsV5Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRfqMakerInstrumentSettingsV5Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRfqMakerInstrumentSettingsV5Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRfqMakerInstrumentSettingsV5Resp(val *GetRfqMakerInstrumentSettingsV5Resp) *NullableGetRfqMakerInstrumentSettingsV5Resp {
	return &NullableGetRfqMakerInstrumentSettingsV5Resp{value: val, isSet: true}
}

func (v NullableGetRfqMakerInstrumentSettingsV5Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRfqMakerInstrumentSettingsV5Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
