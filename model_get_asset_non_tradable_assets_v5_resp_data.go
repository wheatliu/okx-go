...
// checks if the GetAssetNonTradableAssetsV5RespData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAssetNonTradableAssetsV5RespData{}

// GetAssetNonTradableAssetsV5RespData struct for GetAssetNonTradableAssetsV5RespData
type GetAssetNonTradableAssetsV5RespData struct {
...
func NewGetAssetNonTradableAssetsV5RespData() *GetAssetNonTradableAssetsV5RespData {
	this := GetAssetNonTradableAssetsV5RespData{}
	var bal string = ""
	this.Bal = &bal
...
func (o GetAssetNonTradableAssetsV5RespData) MarshalJSON() ([]byte, error) {
...
func (o GetAssetNonTradableAssetsV5RespData) ToMap() (map[string]interface{}, error) {
...
type NullableGetAssetNonTradableAssetsV5RespData struct {
	value *GetAssetNonTradableAssetsV5RespData
	isSet bool
}

func (v NullableGetAssetNonTradableAssetsV5RespData) Get() *GetAssetNonTradableAssetsV5RespData {
	return v.value
}

func (v *NullableGetAssetNonTradableAssetsV5RespData) Set(val *GetAssetNonTradableAssetsV5RespData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetNonTradableAssetsV5RespData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetNonTradableAssetsV5RespData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetNonTradableAssetsV5RespData(val *GetAssetNonTradableAssetsV5RespData) *NullableGetAssetNonTradableAssetsV5RespData {
	return &NullableGetAssetNonTradableAssetsV5RespData{value: val, isSet: true}
}

func (v NullableGetAssetNonTradableAssetsV5RespData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetNonTradableAssetsV5RespData) UnmarshalJSON(src []byte) error {
	v.isSet = true
