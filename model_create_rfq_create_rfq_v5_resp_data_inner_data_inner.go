...
// checks if the CreateRfqCreateRfqV5RespDataInnerDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqCreateRfqV5RespDataInnerDataInner{}

// CreateRfqCreateRfqV5RespDataInnerDataInner struct for CreateRfqCreateRfqV5RespDataInnerDataInner
type CreateRfqCreateRfqV5RespDataInnerDataInner struct {
	...
	Legs []CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner `json:"legs,omitempty"`
...
func NewCreateRfqCreateRfqV5RespDataInnerDataInner() *CreateRfqCreateRfqV5RespDataInnerDataInner {
	this := CreateRfqCreateRfqV5RespDataInnerDataInner{}
	var cTime string = ""
	this.CTime = &cTime
	var ccy string = ""
	this.Ccy = &ccy
...
func (o *CreateRfqCreateRfqV5RespDataInnerDataInner) GetLegs() []CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner {
	if o == nil || IsNil(o.Legs) {
		var ret []CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner
		return ret
	}
	return o.Legs
}
...
// SetLegs gets a reference to the given []CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner and assigns it to the Legs field.
...
func (o CreateRfqCreateRfqV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqCreateRfqV5RespDataInnerDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqCreateRfqV5RespDataInnerDataInner struct {
	value *CreateRfqCreateRfqV5RespDataInnerDataInner
	isSet bool
}

func (v NullableCreateRfqCreateRfqV5RespDataInnerDataInner) Get() *CreateRfqCreateRfqV5RespDataInnerDataInner {
	return v.value
}

func (v *NullableCreateRfqCreateRfqV5RespDataInnerDataInner) Set(val *CreateRfqCreateRfqV5RespDataInnerDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqCreateRfqV5RespDataInnerDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqCreateRfqV5RespDataInnerDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqCreateRfqV5RespDataInnerDataInner(val *CreateRfqCreateRfqV5RespDataInnerDataInner) *NullableCreateRfqCreateRfqV5RespDataInnerDataInner {
	return &NullableCreateRfqCreateRfqV5RespDataInnerDataInner{value: val, isSet: true}
}

func (v NullableCreateRfqCreateRfqV5RespDataInnerDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqCreateRfqV5RespDataInnerDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
