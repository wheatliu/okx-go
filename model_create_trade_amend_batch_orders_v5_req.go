...
// checks if the CreateTradeAmendBatchOrdersV5Req type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradeAmendBatchOrdersV5Req{}

// CreateTradeAmendBatchOrdersV5Req struct for CreateTradeAmendBatchOrdersV5Req
type CreateTradeAmendBatchOrdersV5Req struct {
...
type _CreateTradeAmendBatchOrdersV5Req CreateTradeAmendBatchOrdersV5Req
...
func NewCreateTradeAmendBatchOrdersV5Req(instId string) *CreateTradeAmendBatchOrdersV5Req {
	this := CreateTradeAmendBatchOrdersV5Req{}
	var clOrdId string = ""
...
func (o CreateTradeAmendBatchOrdersV5Req) MarshalJSON() ([]byte, error) {
...
func (o CreateTradeAmendBatchOrdersV5Req) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTradeAmendBatchOrdersV5Req) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTradeAmendBatchOrdersV5Req := _CreateTradeAmendBatchOrdersV5Req{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTradeAmendBatchOrdersV5Req)

	if err != nil {
		return err
	}

	*o = CreateTradeAmendBatchOrdersV5Req(varCreateTradeAmendBatchOrdersV5Req)

	return err
}

type NullableCreateTradeAmendBatchOrdersV5Req struct {
	value *CreateTradeAmendBatchOrdersV5Req
	isSet bool
}

func (v NullableCreateTradeAmendBatchOrdersV5Req) Get() *CreateTradeAmendBatchOrdersV5Req {
	return v.value
}

func (v *NullableCreateTradeAmendBatchOrdersV5Req) Set(val *CreateTradeAmendBatchOrdersV5Req) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradeAmendBatchOrdersV5Req) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradeAmendBatchOrdersV5Req) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradeAmendBatchOrdersV5Req(val *CreateTradeAmendBatchOrdersV5Req) *NullableCreateTradeAmendBatchOrdersV5Req {
	return &NullableCreateTradeAmendBatchOrdersV5Req{value: val, isSet: true}
}

func (v NullableCreateTradeAmendBatchOrdersV5Req) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradeAmendBatchOrdersV5Req) UnmarshalJSON(src []byte) error {
	v.isSet = true
