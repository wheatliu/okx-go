...
// checks if the CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner{}

// CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner struct for CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner
type CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner struct {
...
func NewCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner() *CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner {
	this := CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner{}
	var ccy string = ""
	this.Ccy = &ccy
	var instId string = ""
	this.InstId = &instId
...
func (o CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
...
func (o CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner struct {
	value *CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner
	isSet bool
}

func (v NullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) Get() *CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner {
	return v.value
}

func (v *NullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) Set(val *CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner(val *CreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) *NullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner {
	return &NullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner{value: val, isSet: true}
}

func (v NullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRfqCreateRfqV5RespDataInnerDataInnerLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
